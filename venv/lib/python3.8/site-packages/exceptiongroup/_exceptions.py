...
_BaseExceptionGroupSelf = TypeVar("_BaseExceptionGroupSelf",
    bound="BaseExceptionGroup")
...
class BaseExceptionGroup(BaseException, Generic[_BaseExceptionT_co]):
    ...
    def subgroup(
        self,
        __condition: Callable[[_BaseExceptionT_co | _BaseExceptionGroupSelf],
    bool],
    ...
    def split(
        ...
        if matching_exceptions:
            matching_group = _derive_and_copy_attributes(self,
    matching_exceptions)
    ...
    @overload
    def derive(self, __excs: Sequence[_ExceptionT]) ->
    ...
    def __str__(self) -> str:
        ...
        return f"{self.message} ({len(self._exceptions)}
    sub-exception{suffix})"
...
class ExceptionGroup(BaseExceptionGroup[_ExceptionT_co], Exception):
    ...
    ...]
        ...
        @overload
        def subgroup(
            self, __condition: Callable[[_ExceptionT_co |
    _ExceptionGroupSelf], bool]
    ...
    ...]
            ...
            ExceptionGroup[_ExceptionT] | None, ExceptionGroup[_ExceptionT_co]
    | None
        ]: ...
