...
#
# _ExceptionPrintContext and traceback_exception_format() copied from the
    standard
# library
...
class PatchedTracebackException(traceback.TracebackException):
    ...
    last):\n")
                ...
                yield from _ctx.emit(f"... (max_group_depth is
    {max_group_depth})\n")
            else:
                ...
                for i in range(n):
                    ...
                    _ctx.exception_group_depth += 1
                    if not truncated:
                        yield from exc.exceptions[i].format(chain=chain,
    _ctx=_ctx)
                    else:
...
if sys.excepthook is sys.__excepthook__:
    ...
    traceback.TracebackException.format_exception_only = (  # type:
    ignore[assignment]
