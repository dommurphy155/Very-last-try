...
class BaseRequest(MutableMapping[str, Any], HeadersMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self._post: Optional[MultiDictProxy[Union[str, bytes, FileField]]] =
    None
    ...
    def clone(
        ...
        *,
        ...
        """
        if self._read_bytes:
            raise RuntimeError("Cannot clone request " "after reading its
    content")
    ...
    def loop(self) -> asyncio.AbstractEventLoop:
        warnings.warn(
            "request.loop property is deprecated", DeprecationWarning,
    stacklevel=2
        )
        return self._loop
    ...
    def if_none_match(self) -> Optional[Tuple[ETag, ...]]:
        ...
        """
        return
    self._if_match_or_none_impl(self.headers.get(hdrs.IF_NONE_MATCH))
    ...
    def cookies(self) -> Mapping[str, str]:
        ...
        return MappingProxyType({key: val.value for key, val in
    parsed.items()})
    ...
    def has_body(self) -> bool:
        ...
        warnings.warn(
            "Deprecated, use .can_read_body #2005", DeprecationWarning,
    stacklevel=2
        )
        ...
        if content_type == "multipart/form-data":
            ...
            while field is not None:
                ...
                if isinstance(field, BodyPartReader):
                    ...
                    raise ValueError(
                        "To decode nested multipart you need " "to use custom
    reader",
                    )
    ...
    def __repr__(self) -> str:
        ascii_encodable_path = self.path.encode("ascii",
