...
class RawTestServer(BaseTestServer):
    ...
    async def _make_runner(self, debug: bool = True, **kwargs: Any) ->
    ServerRunner:
...
class TestClient:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not isinstance(server, BaseTestServer):
            raise TypeError(
                "server must be TestServer " "instance, found type: %r" %
    type(server)
            )
        self._server = server
        self._loop = loop
        ...
        self._session = ClientSession(loop=loop, cookie_jar=cookie_jar,
    **kwargs)
        self._closed = False
    ...
    **kwargs))
    ...
    def post(self, path: str, **kwargs: Any) -> _RequestContextManager:
        ...
        return _RequestContextManager(self._request(hdrs.METH_POST, path,
    **kwargs))

    def options(self, path: str, **kwargs: Any) -> _RequestContextManager:
        """Perform an HTTP OPTIONS request."""
        return _RequestContextManager(self._request(hdrs.METH_OPTIONS, path,
    **kwargs))

    def head(self, path: str, **kwargs: Any) -> _RequestContextManager:
        """Perform an HTTP HEAD request."""
        return _RequestContextManager(self._request(hdrs.METH_HEAD, path,
    **kwargs))
    ...
    **kwargs))
    ...
    def patch(self, path: str, **kwargs: Any) -> _RequestContextManager:
        ...
        return _RequestContextManager(self._request(hdrs.METH_PATCH, path,
    **kwargs))

    def delete(self, path: str, **kwargs: Any) -> _RequestContextManager:
        """Perform an HTTP PATCH request."""
        return _RequestContextManager(self._request(hdrs.METH_DELETE, path,
    **kwargs))
    ...
    async def _ws_connect(self, path: str, **kwargs: Any) ->
...
def unittest_run_loop(func: Any, *args: Any, **kwargs: Any) -> Any:
    """
    A decorator dedicated to use with asynchronous AioHTTPTestCase test
    methods.
...
def make_mocked_request(
    ...
    *,
    ...
    req = Request(
        message, payload, protocol, writer, task, loop,
