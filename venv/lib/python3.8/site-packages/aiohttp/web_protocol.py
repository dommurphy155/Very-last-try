...
class RequestHandler(BaseProtocol):
    ...
    def __init__(
        ...
        *,
        ...
        self._request_handler: Optional[_RequestHandler] =
    manager.request_handler
        self._request_factory: Optional[_RequestFactory] =
    manager.request_factory
        ...
        if access_log:
            self.access_logger: Optional[AbstractAccessLogger] =
    access_log_class(
    ...
    async def shutdown(self, timeout: Optional[float] = 15.0) -> None:
        ...
        with suppress(asyncio.CancelledError, asyncio.TimeoutError):
            async with ceil_timeout(timeout):
                ...
                if self._task_handler is not None and not
    self._task_handler.done():
    ...
    async def finish_response(
        ...
        try:
            ...
            if resp is None:
                raise RuntimeError("Missing return " "statement on request
    handler")
            else:
                raise RuntimeError(
    ...
    def handle_error(
        ...
        if status == HTTPStatus.INTERNAL_SERVER_ERROR:
            title = "{0.value}
    {0.phrase}".format(HTTPStatus.INTERNAL_SERVER_ERROR)
