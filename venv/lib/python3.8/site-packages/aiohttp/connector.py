...
class Connection:
    ...
    **kwargs)
    ...
    should_close=True)
            ...
            context = {"client_connection": self, "message": "Unclosed
    connection"}
    ...
    def loop(self) -> asyncio.AbstractEventLoop:
        warnings.warn(
            "connector.loop property is deprecated", DeprecationWarning,
    stacklevel=2
        )
        return self._loop
...
class BaseConnector:
    ...
    **kwargs)
                ...
                for proto, use_time in conns:
                    if proto.is_connected():
                        if use_time - deadline < 0:
                            ...
                            proto.close()
                            if key.is_ssl and not
    self._cleanup_closed_disabled:
    ...
    def _available_connections(self, key: "ConnectionKey") -> int:
        ...
        The limit, limit_per_host and the connection key are taken into
    account.
    ...
    def _release_acquired(self, key: "ConnectionKey", proto: ResponseHandler)
    -> None:
        if self._closed:
...
class _DNSCacheTable:
    def __init__(self, ttl: Optional[float] = None) -> None:
        self._addrs_rr: Dict[Tuple[str, int], Tuple[Iterator[Dict[str, Any]],
    int]] = {}
...
class TCPConnector(BaseConnector):
    ...
    def clear_dns_cache(
        ...
        if host is not None and port is not None:
            ...
            raise ValueError("either both host and port " "or none of them are
    allowed")
        else:
    ...
    async def _resolve_host(
        ...
        if (key in self._cached_hosts) and (not
    ...
    def _get_fingerprint(self, req: "ClientRequest") ->
    ...
    from exc
            ...
            if tls_transport is None:
                msg = "Failed to start TLS (possibly caused by closing
    transport)"
    ...
    async def _create_direct_connection(
        ...
        *,
        ...
        try:
            ...
            def drop_exception(fut: "asyncio.Future[List[Dict[str, Any]]]") ->
    None:
    ...
    "ClientTimeout"
        ...
        if req.is_ssl():
            ...
            key = attr.evolve(
                req.connection_key, proxy=None, proxy_auth=None,
...
class NamedPipeConnector(BaseConnector):
    ...
    "ClientTimeout"
        ...
        try:
            async with ceil_timeout(timeout.sock_connect):
                _, proto = await self._loop.create_pipe_connection(  # type:
