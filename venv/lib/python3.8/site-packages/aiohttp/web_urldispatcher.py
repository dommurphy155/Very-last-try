...
class UrlMappingMatchInfo(BaseDict, AbstractMatchInfo):
    ...
    @contextmanager
    def set_current_app(self, app: "Application") -> Generator[None, None,
    None]:
...
class DynamicResource(Resource):
    ...
    def _match(self, path: str) -> Optional[Dict[str, str]]:
        ...
        if match is None:
            ...
            return {
                key: _unquote_path(value) for key, value in
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ValueError(f"No directory exists at '{directory}'") from
    error
...
class PrefixedSubAppResource(PrefixResource):
    ...
    def url_for(self, *args: str, **kwargs: str) -> URL:
        raise RuntimeError(".url_for() is not supported " "by sub-application
    root")
...
class View(AbstractView):
    ...
    def _raise_allowed_methods(self) -> None:
        allowed_methods = {m for m in hdrs.METH_ALL if hasattr(self,
    m.lower())}
...
class UrlDispatcher(AbstractRouter, Mapping[str, AbstractResource]):
    ...
    def register_resource(self, resource: AbstractResource) -> None:
        ...
        if self.frozen:
            raise RuntimeError("Cannot register a resource into frozen
    router.")
        ...
        if name is not None:
            ...
            if name in self._named_resources:
                raise ValueError(
                    "Duplicate {!r}, "
                    "already handled by {!r}".format(name,
    self._named_resources[name])
                )
            self._named_resources[name] = resource
        self._resources.append(resource)

    def add_resource(self, path: str, *, name: Optional[str] = None) ->
    Resource:
    ...
    def add_head(self, path: str, handler: Handler, **kwargs: Any) ->
    AbstractRoute:
        """Shortcut for add_route with method HEAD."""
        return self.add_route(hdrs.METH_HEAD, path, handler, **kwargs)

    def add_options(self, path: str, handler: Handler, **kwargs: Any) ->
    AbstractRoute:
    ...
    def add_post(self, path: str, handler: Handler, **kwargs: Any) ->
    AbstractRoute:
        """Shortcut for add_route with method POST."""
        return self.add_route(hdrs.METH_POST, path, handler, **kwargs)

    def add_put(self, path: str, handler: Handler, **kwargs: Any) ->
    AbstractRoute:
        """Shortcut for add_route with method PUT."""
        return self.add_route(hdrs.METH_PUT, path, handler, **kwargs)

    def add_patch(self, path: str, handler: Handler, **kwargs: Any) ->
    AbstractRoute:
        """Shortcut for add_route with method PATCH."""
        return self.add_route(hdrs.METH_PATCH, path, handler, **kwargs)

    def add_delete(self, path: str, handler: Handler, **kwargs: Any) ->
    AbstractRoute:
