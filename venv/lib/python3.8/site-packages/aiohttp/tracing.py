...
class TraceConfig:
    ...
    def __init__(
        ...
        self._on_request_end: Signal[_SignalCallback[TraceRequestEndParams]] =
    Signal(
            self
        )
    ...
    def trace_config_ctx(
        ...
        return
    self._trace_config_ctx_factory(trace_request_ctx=trace_request_ctx)
...
class Trace:
    ...
    async def send_connection_queued_start(self) -> None:
        return await self._trace_config.on_connection_queued_start.send(
            self._session, self._trace_config_ctx,
    TraceConnectionQueuedStartParams()
        )
