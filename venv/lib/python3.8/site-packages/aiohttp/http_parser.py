...
class HttpParser(abc.ABC, Generic[_MsgT]):
    ...
    def __init__(
        ...
        self._limit = limit
        self._headers_parser = HeadersParser(max_line_size, max_headers,
    max_field_size)
    ...
    https://www.rfc-editor.org/rfc/rfc9110#section-8.6-2
            ...
            # feed payload
                ...
                try:
                    eof, data =
    self._payload_parser.feed_data(data[start_pos:], SEP)
    ...
    def parse_headers(
        ...
        "CIMultiDictProxy[str]", RawHeaders, Optional[bool], Optional[str],
    bool, bool
    ]:
...
class HttpRequestParser(HttpParser[RawRequestMessage]):
    ...
    def parse_message(self, lines: List[bytes]) -> RawRequestMessage:
        ...
        if len(path) > self.max_line_size:
            raise LineTooLong(
                "Status line is too long", str(self.max_line_size),
    str(len(path))
            )
        ...
        if method == "CONNECT":
            ...
            path_part, _question_mark_separator, qs_part =
    path_part.partition("?")
