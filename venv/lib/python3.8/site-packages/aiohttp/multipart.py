...
def parse_content_disposition(
    ...
    def unescape(text: str, *, chars: str = "".join(map(re.escape, CHAR))) ->
    str:
...
def content_disposition_filename(
    ...
    if not params:
        ...
        parts = []
        fnparams = sorted(
            (key, value) for key, value in params.items() if
...
class BodyPartReader:
    ...
    def __init__(
        self, boundary: bytes, headers: "CIMultiDictProxy[str]", content:
    StreamReader
    ) -> None:
    ...
    async def _read_chunk_from_length(self, size: int) -> bytes:
        ...
        assert self._length is not None, "Content-Length required for chunked
    read"
    ...
    async def text(self, *, encoding: Optional[str] = None) -> str:
        ...
        # see
    https://www.w3.org/TR/html5/forms.html#multipart/form-data-encoding-algorithm # NOQA
        # and
    https://dvcs.w3.org/hg/xhr/raw-file/tip/Overview.html#dom-xmlhttprequest-send # NOQA
    ...
    str]]:
        """Like read(), but assumes that body parts contain form urlencoded
    data."""
        data = await self.read(decode=True)
        if not data:
            return []
    ...
    def name(self) -> Optional[str]:
        ...
        """
        _, params =
    parse_content_disposition(self.headers.get(CONTENT_DISPOSITION))
...
class MultipartReader:
    ...
    def __init__(self, headers: Mapping[str, str], content: StreamReader) ->
    None:
        self.headers = headers
    ...
    def _get_part_reader(
        ...
        Returns a suitable reader instance.:param dict headers: Response headers
        """
    ...
    def _get_boundary(self) -> str:
        ...
        assert mimetype.type == "multipart", "multipart/* content type
    expected"
    ...
    async def _read_boundary(self) -> None:
        ...
        if chunk == self._boundary:
            ...
            raise ValueError(f"Invalid boundary {chunk!r}, expected
    {self._boundary!r}")
...
class MultipartWriter(Payload):
    ...
    -> None:
        ...
        try:
            ...
            raise ValueError("boundary should contain ASCII only chars") from
    None
    ...
    def append(self, obj: Any, headers: Optional[MultiMapping[str]] = None) ->
    Payload:
        if headers is None:
            headers = CIMultiDict()
    ...
    def append_payload(self, payload: Payload) -> Payload:
        ...
        self._parts.append((payload, encoding, te_encoding))  # type:
    ignore[arg-type]
        return payload
    ...
    async def write_eof(self) -> None:
        ...
        if self._encoding == "base64":
            if self._encoding_buffer:
                await
    self._writer.write(base64.b64encode(self._encoding_buffer))
    ...
    async def write(self, chunk: bytes) -> None:
        ...
        if self._encoding == "base64":
            ...
            if buf:
                ...
                enc_chunk, self._encoding_buffer = (buf[: div * 3], buf[div *
    3:])
                if enc_chunk:
