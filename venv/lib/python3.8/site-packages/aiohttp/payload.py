...
class BytesPayload(Payload):
    def __init__(self, value: ByteString, *args: Any, **kwargs: Any) -> None:
        if not isinstance(value, (bytes, bytearray, memoryview)):
            raise TypeError(f"value argument must be byte-ish, not
    {type(value)!r}")
...
class IOBasePayload(Payload):
    ...
    def __init__(
        self, value: IO[Any], disposition: str = "attachment", *args: Any,
    **kwargs: Any
    ) -> None:
...
class AsyncIterablePayload(Payload):
    ...
    def __init__(self, value: _AsyncIterable, *args: Any, **kwargs: Any) ->
    None:
...
PAYLOAD_REGISTRY.register(BufferedReaderPayload, (io.BufferedReader,
    io.BufferedRandom))
