...
class BadMetadata(ValueError):
    def __init__(self, dist: importlib.metadata.Distribution, *, reason: str)
    -> None:
        self.dist = dist
        self.reason = reason
...
def get_info_location(d: importlib.metadata.Distribution) ->
    ...
    expose the attribute as public. But pip's code base is old and not as
    clean,
...
def get_dist_canonical_name(dist: importlib.metadata.Distribution) ->
    NormalizedName:
