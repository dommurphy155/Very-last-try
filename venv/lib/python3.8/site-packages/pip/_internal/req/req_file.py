...
# order of BOMS is important: codecs.BOM_UTF16_LE is a prefix of
    codecs.BOM_UTF32_LE
...
def parse_requirements(
    ...
    """Parse a requirements file and yield ParsedRequirement instances.:param filename:    Path or url of requirements file.:param session:     PipSession instance.:param finder:      Instance of pip.index.PackageFinder.:param options:     cli options.:param constraint:  If true, parsing a constraint file rather than
        requirements file.
    """
    ...
    if options:
        ...
        if opts.features_enabled:
            options.features_enabled.extend(
                f for f in opts.features_enabled if f not in
...
def handle_line(
    ...
    creating/yielding requirements, or updating the finder.:param line:        The parsed line to be processed.:param options:     CLI options.:param finder:      The finder - updated by non-requirement lines.:param session:     The session - updated by non-requirement lines.
    ...
    references
                ...
                if req_path in parsed_files:
                    ...
                    raise RequirementsFileParseError(
                        f"{req_path} recursively references itself in
    {filename}{tail}"
                    )
...
def get_line_parser(finder: Optional["PackageFinder"]) -> LineParser:
    def parse_line(line: str) -> Tuple[str, Values]:
        ...
        try:
            ...
            raise OptionParsingError(f"Could not split options:
    {options_str}") from e
...
def get_file_content(url: str, session: "PipSession") -> Tuple[str, str]:
    ...
    Respects # -*- coding: declarations on the retrieved files.:param url:         File path or url.:param session:     PipSession instance.
    """
...
def _decode_req_file(data: bytes, url: str) -> str:
    ...
    try:
        ...
        locale_encoding = locale.getpreferredencoding(False) or
