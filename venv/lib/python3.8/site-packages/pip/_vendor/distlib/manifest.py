...
class Manifest(object):
    ...
    def process_directive(self, directive):
        ...
        ``files``, or removes some files from ``files``.:param directive: The directive to process. This should be in a format
    ...
    def _translate_pattern(self, pattern, anchor=True, prefix=None,
        ...
        if pattern:
            ...
            if _PYTHON_VERSION > (3, 2):
                assert pattern_re.startswith(start) and
    pattern_re.endswith(end)
        else:
            pattern_re = ''
