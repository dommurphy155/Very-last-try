...
# Keep the old name around (for now), as there is at least one project using
    it!
...
class ScriptMaker(object):
    ...
    os._name == 'posix')
        ...
        self._is_nt = os.name == 'nt' or (os.name == 'java' and os._name ==
    'nt')
    ...
    def _get_script_text(self, entry):
        return self.script_template % dict(
            module=entry.prefix, import_name=entry.suffix.split('.')[0],
    func=entry.suffix)
    ...
    def make(self, specification, options=None):
        """
        Make a script.:param specification: The specification, which is either a valid export
                              entry specification (to make a script from a
                              callable) or a filename (to make a script by
                              copying from a source location).:param options: A dictionary of options controlling script generation.:return: A list of all absolute pathnames written to.
        """
        filenames = []
