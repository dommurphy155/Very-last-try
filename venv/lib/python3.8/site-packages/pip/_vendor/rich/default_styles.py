...
DEFAULT_STYLES: Dict[str, Style] = {
    ...
    "repr.url": Style(underline=True, color="bright_blue", italic=False,
    bold=False),
    ...
    "markdown.emph": Style(italic=True),  # For commonmark backwards
    compatibility
...
if __name__ == "__main__":  # pragma: no cover
    ...
    html: bool = args.html
    console = Console(record=True, width=70, file=io.StringIO()) if html else
    Console()
