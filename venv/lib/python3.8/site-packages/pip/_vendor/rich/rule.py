...
class Rule(JupyterMixin):
    ...
    Args:
        title (Union[str, Text], optional): Text to render in the rule.
    Defaults to "".
        characters (str, optional): Character(s) used to draw the line.
    Defaults to "─".
    ...
    def __init__(
        ...
        *,
        ...
        if align not in ("left", "center", "right"):
            raise ValueError(
                f'invalid value for align, expected "left", "center", "right"
    (not {align!r})'
            )
        self.title = title
    ...
    def __rich_console__(
        ...
        if self.align == "center":
            ...
            right_length = width - cell_len(left.plain) -
