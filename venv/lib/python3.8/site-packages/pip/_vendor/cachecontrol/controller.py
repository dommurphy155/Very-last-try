...
class CacheController:
    ...
    def parse_cache_control(self, headers: Mapping[str, str]) -> dict[str, int
    | None]:
        known_directives = {
    ...
    def _load_from_cache(self, request: PreparedRequest) -> HTTPResponse |
    None:
        """
    ...
    CaseInsensitiveDict(resp.headers)
        ...
        # the cache.
            ...
            # in the meantime.
                ...
                if response_headers["expires"]:
                    ...
                    logger.debug(
                        "Caching b/c of expires header. expires in {}
    seconds".format(
                            expires_time
                        )
                    )
