...
def _verify_peercerts_impl(
    ...
    if not cert_chain:
        raise ssl.SSLCertVerificationError("Peer sent no certificates to
    verify")

    pCertContext = None
    hIntermediateCertStore = CertOpenStore(CERT_STORE_PROV_MEMORY, 0, None, 0,
    None)
    try:
        ...
        cert_enhkey_usage.rgpszUsageIdentifier = (c_char_p *
    1)(OID_PKIX_KP_SERVER_AUTH)
        ...
        try:
            # First attempt to verify using the default Windows system trust
    roots
