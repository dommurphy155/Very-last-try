...
# Detect Python runtimes which don't implement
    SSLObject.get_unverified_chain() API
# This API only became public in Python 3.13 but was available in CPython and
    PyPy since 3.10.
if _sys.version_info < (3, 13):
    try:
        ...
        try:
            ...
            raise ImportError(
                "truststore requires peer certificate chain APIs to be
    available"
            ) from None
