"""
    ...
    Formatter for LaTeX fancyvrb output.:copyright: Copyright 2006-2024 by the Pygments team, see AUTHORS.:license: BSD, see LICENSE for details.
"""
...
class LatexFormatter(Formatter):
    ...
    `verboptions`
        Additional options given to the Verbatim environment (see the
    *fancyvrb*
    ...
    `envname`
        ...
        The alternate environment still has to support Verbatim's option
    syntax.
        (default: ``'Verbatim'``).
    ...
    def _create_stylesheet(self):
        ...
        def rgbcolor(col):
            if col:
                return ','.join(['%.2f' % (int(col[i] + col[i + 1], 16) /
    255.0)
                                 for i in (0, 2, 4)])
            else:
                return '1,1,1'
        ...
        for ttype, ndef in self.style:
            ...
            if ndef['color']:
                cmndef +=
    (r'\def\$$@tc##1{{\textcolor[rgb]{{{}}}{{##1}}}}'.format(rgbcolor(ndef['color'])))
            if ndef['border']:
                cmndef += (r'\def\$$@bc##1{{{{\setlength{{\fboxsep}}{{\string
    -\fboxrule}}'
                           r'\fcolorbox[rgb]{{{}}}{{{}}}{{\strut
    ##1}}}}}}'.format(rgbcolor(ndef['border']),
                            rgbcolor(ndef['bgcolor'])))
            elif ndef['bgcolor']:
                cmndef += (r'\def\$$@bc##1{{{{\setlength{{\fboxsep}}{{0pt}}'
                           r'\colorbox[rgb]{{{}}}{{\strut
    ##1}}}}}}'.format(rgbcolor(ndef['bgcolor'])))
            if cmndef == '':
                continue
