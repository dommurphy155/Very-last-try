"""
    ...
    A formatter that generates RTF files.:copyright: Copyright 2006-2024 by the Pygments team, see AUTHORS.:license: BSD, see LICENSE for details.
"""
...
class RtfFormatter(Formatter):
    ...
    documents with color information and other useful stuff. Perfect for Copy
    and
