"""
    ...
    Contains built-in styles.:copyright: Copyright 2006-2024 by the Pygments team, see AUTHORS.:license: BSD, see LICENSE for details.
"""
...
def get_style_by_name(name):
    ...
    try:
        ...
        raise ClassNotFound(f"Could not find style class {cls!r} in style
    module.")
