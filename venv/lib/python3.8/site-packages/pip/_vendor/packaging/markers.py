...
class Environment(TypedDict):
    ...
    os_name: str
    """
    The value of:py:data:`os.name`. The name of the operating system
    dependent module
    imported, e.g. ``'posix'``.
    """
    ...
    Note that unlike the Python:py:data:`sys.version`, this value will always
    include
...
class Marker:
    ...
    recursive type:
            ...
            # python_version > "3.6" or (python_version == "3.6" and os_name
    == "unix")
            #
            # is parsed into:
            # [
