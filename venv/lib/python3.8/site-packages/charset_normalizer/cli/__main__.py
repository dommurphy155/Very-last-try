...
def cli_detect(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        default=False,
        dest="alternatives",
        help="Output complementary possibilities if any. Top-level JSON WILL
    be a list.",
    )
    parser.add_argument(
        "-n",
        ...
        default=False,
        dest="normalize",
        help="Permit to normalize input file. If not set, program does not
    write anything.",
    )
    parser.add_argument(
        "-m",
        ...
        default=False,
        dest="minimal",
        help="Only output the charset detected to STDOUT. Disabling JSON
    output.",
    )
    parser.add_argument(
        "-r",
        ...
        default=False,
        dest="replace",
        help="Replace file when trying to normalize it instead of creating a
    new one.",
    )
    parser.add_argument(
        "-f",
        ...
        default=False,
        dest="force",
        help="Replace file without asking if you are sure, use this flag with
    caution.",
    )
    parser.add_argument(
        "-i",
    ...
    parser.add_argument(
        ...
        type=float,
        dest="threshold",
        help="Define a custom maximum amount of noise allowed in decoded
    content. 0. <= noise <= 1.",
    )
    parser.add_argument(
        "--version",
