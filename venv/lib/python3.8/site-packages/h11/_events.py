...
class Request(Event):
    ...
    .. attribute:: headers
       ...
       Request headers, represented as a list of (name, value) pairs. See:ref:`the header normalization rules <headers-format>` for details.
    ...
    def __init__(
        ...
        *,
        ...
        headers: Union[Headers, List[Tuple[bytes, bytes]], List[Tuple[str,
    str]]],
...
class InformationalResponse(_ResponseBase):
    ...
    .. attribute:: status_code
       ...
       The status code of this response, as an integer. For an:class:`InformationalResponse`, this is always in the range [100,
       200).

    .. attribute:: headers

       Request headers, represented as a list of (name, value) pairs. See:ref:`the header normalization rules <headers-format>` for
       details.
...
class Response(_ResponseBase):
    ...
    .. attribute:: status_code
       ...
       The status code of this response, as an integer. For an:class:`Response`, this is always in the range [200,
       1000).
...
class Data(Event):
    ...
    .. attribute:: chunk_start
       ...
       shouldn't use this attribute at all; see:ref:`chunk-delimiters-are-bad` for details.
