...
EventTransitionType = Dict[
    ...
    Dict[
        Type[Sentinel],
        Dict[Union[Type[Event], Tuple[Type[Event], Type[Sentinel]]],
    Type[Sentinel]],
    ],
]
...
class ConnectionState:
    def __init__(self) -> None:
        ...
        self.states: Dict[Type[Sentinel], Type[Sentinel]] = {CLIENT: IDLE,
    SERVER: IDLE}
    ...
    def process_client_switch_proposal(self, switch_event: Type[Sentinel]) ->
    None:
        ...
        if server_switch_event is not None:
            ...
            if server_switch_event not in self.pending_switch_proposals:
                raise LocalProtocolError(
                    "Received server {} event without a pending
    proposal".format(
                        server_switch_event
                    )
                )
