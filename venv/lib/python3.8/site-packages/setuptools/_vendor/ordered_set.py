...
class OrderedSet(MutableSet, Sequence):
    ...
    state
            # in a tuple, but this way is backwards- and forwards- compatible
    with
    ...
    def union(self, *sets):
        ...
        Example:
            >>> oset = OrderedSet.union(OrderedSet([3, 1, 4, 1, 5]), [1, 3],
    [2, 0])
            >>> print(oset)
    ...
    def intersection(self, *sets):
        ...
        Example:
            >>> oset = OrderedSet.intersection(OrderedSet([0, 1, 2, 3]), [1,
    2, 3])
            >>> print(oset)
            OrderedSet([1, 2, 3])
    ...
    def difference_update(self, *sets):
        ...
        Example:
            ...
            >>> this.difference_update(OrderedSet([2, 4]), OrderedSet([1, 4,
    6]))
            >>> print(this)
            OrderedSet([3, 5])
        """
