...
class easy_install(Command):
    ...
    user_options = [
        ...
        ('install-layout=', None, "installation layout to choose (known
    values: deb)"),
        ('force-installation-into-system-dir', '0', "force installation into
    /usr"),
        ('no-find-links', None,
    ...
    def finalize_options(self):
        ...
        if self.install_layout:
            if not self.install_layout.lower() in ['deb']:
                raise DistutilsOptionError("unknown value for
    --install-layout")
        ...
        if self.prefix == '/usr' and not
    self.force_installation_into_system_dir:
...
""")
    ...
    if sys.version[:3] in ('2.3', '2.4', '2.5') or 'real_prefix' in
    sys.__dict__:
...
class ScriptWriter:
    ...
    def get_script_header(cls, script_text, executable=None, wininst=False):
        # for backward compatibility
        warnings.warn("Use get_header", EasyInstallDeprecationWarning,
    stacklevel=2)
        if wininst:
...
class EasyInstallDeprecationWarning(SetuptoolsDeprecationWarning):
    """Class for warning about deprecations in EasyInstall in SetupTools. Not
    ignored by default, unlike DeprecationWarning."""
