    ...
    def _load_client_certs(self, ssl_context: ssl.SSLContext) -> None:
        ...
        if self.cert is not None:
            if isinstance(self.cert, str):
                ...
                ssl_context.load_cert_chain(certfile=self.cert[0],
    keyfile=self.cert[1])
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(timeout, Timeout):
            ...
            self.connect = timeout if isinstance(connect, UnsetType) else
    connect
...
class Limits:
    ...
    * **max_keepalive_connections** - Allow the connection pool to maintain
            keep-alive connections below this point. Should be less than or
    equal
            to `max_connections`.
    * **keepalive_expiry** - Time limit on idle keep-alive connections in
    seconds.
    """
