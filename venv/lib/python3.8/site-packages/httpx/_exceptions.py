...
class StreamConsumed(StreamError):
    ...
    "
            ...
            "response or a secondary request as part of an authentication
    flow."
            "For responses, this could be due to attempting to stream the
    response "
...
class ResponseNotRead(StreamError):
    ...
    def __init__(self) -> None:
        message = "Attempted to access streaming response content, without
    having called `read()`."
        super().__init__(message)
...
class RequestNotRead(StreamError):
    ...
    def __init__(self) -> None:
        message = "Attempted to access streaming request content, without
    having called `read()`."
        super().__init__(message)
