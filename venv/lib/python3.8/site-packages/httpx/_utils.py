...
def parse_header_links(value: str) -> typing.List[typing.Dict[str, str]]:
    ...
    would return
        [
            ...
            {"url": "http://.../back.jpeg"},
        ]:param value: HTTP Link entity-header field:return: list of parsed link headers
    """
...
def get_environment_proxies() -> typing.Dict[str, typing.Optional[str]]:
    ...
    no_proxy_hosts = [host.strip() for host in proxy_info.get("no",
    "").split(",")]
...
def to_bytes(value: typing.Union[str, bytes], encoding: str = "utf-8") ->
    bytes:
...
class URLPattern:
    ...
    def __init__(self, pattern: str) -> None:
        ...
        if not url.host or url.host == "*":
            ...
            # *.example.com should match "www.example.com", but not
    "example.com"
