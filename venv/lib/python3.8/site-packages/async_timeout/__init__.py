...
class Timeout:
    ...
    def shift(self, delay: float) -> None:
        ...
        if deadline is None:
            raise RuntimeError("cannot shift timeout if deadline is not
    scheduled")
    ...
    def update(self, deadline: float) -> None:
        ...
        if self._state == _State.EXIT:
            raise RuntimeError("cannot reschedule after exit from context
    manager")
    ...
    def _reschedule(self) -> None:
        ...
        if deadline <= now:
            ...
            self._timeout_handler = self._loop.call_at(deadline,
    self._on_timeout)
