...
class TestAtleast2d:
    ...
    def test_r2array(self):
        ...
        assert_(atleast_2d([[[3, 1], [4, 5]], [[3, 5], [1, 2]]]).shape == (2,
    2, 2))
...
class TestConcatenate:
    ...
    @pytest.mark.skipif(IS_PYPY, reason="PYPY handles sq_concat, nb_add
...
class TestBlock:
    ...
    def block(self, request):
        ...
        if request.param == 'force_concatenate':
            ...
            raise ValueError('Unknown blocking request. There is a typo in the
    tests.')
