...
class TestUfuncGenericLoops:
    ...
    def test_unary_PyUFunc(self, input_dtype, output_dtype, f=np.exp, x=0,
    y=1):
...
class TestUfunc:
    ...
    def test_reduceat_shifting_sum(self):
        L = 6
        x = np.arange(L)
        idx = np.array(list(zip(np.arange(L - 2), np.arange(L - 2) +
    2))).ravel()
            ...
            for x, y in itertools.product([aa, -aa], [bb, -bb]):
                ...
                for tcout in 'efdg':
                    ...
                    if tc in 'FDG':
                        ...
                        assert_raises(TypeError, np.true_divide, x, y,
    dtype=dtout)
                    else:
                        tgt = float(x)/float(y)
    ...
    def test_broadcast(self):
        ...
        assert_array_equal(umt.inner1d(a, b), np.sum(a*b, axis=-1),
    err_msg=msg)
    ...
    def test_axes_argument(self):
        ...
        assert_raises(ValueError, mm, a, b, axes=[(-2, -1), (-2, -1), (-2,
    -2)])
    ...
    def test_object_comparison(self):
        ...
        assert_equal(np.equal(arr1d, arr1d), np.array([True]))  # normal
    behavior is a cast
    ...
    def test_reduce_arguments(self):
        ...
        # assert_raises(TypeError, f, d, keepdims="invalid", axis=0,
    dtype=None)
        # invalid mix
    ...
    def test_reduce_wrong_dimension_output(self, f_reduce, keepdims,
    out_shape):
    ...
    @pytest.mark.parametrize('nat', [np.datetime64('nat'),
    np.timedelta64('nat')])
