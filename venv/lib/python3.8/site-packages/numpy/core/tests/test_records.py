...
class TestFromrecords:
    ...
    def test_method_array(self):
        r = np.rec.array(b'abcdefg' * 100, formats='i2,a3,i4', shape=3,
    byteorder='big')
        assert_equal(r[1].item(), (25444, b'efg', 1633837924))

    def test_method_array2(self):
        r = np.rec.array([(1, 11, 'a'), (2, 22, 'b'), (3, 33, 'c'), (4, 44,
    'd'), (5, 55, 'ex'),
    ...
    def test_recarray_fromfile(self):
        ...
        bytes_array.seek(0)
        r3 = np.rec.fromfile(bytes_array, formats='f8,i4,a5', shape=3,
    byteorder='big')
        fd.close()
        assert_equal(r1, r2)
        assert_equal(r2, r3)
...
class TestRecord:
    ...
    def test_assign_dtype_attribute(self, nfields):
        dt = np.dtype([('a', np.uint8), ('b', np.uint8), ('c',
    np.uint8)][:nfields])
