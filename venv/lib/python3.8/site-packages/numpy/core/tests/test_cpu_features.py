...
def assert_features_equal(actual, desired, fname):
    ...
    try:
        import subprocess
        auxv = subprocess.check_output(['/bin/true'],
...
class AbstractTest:
    ...
    def test_features(self):
        ...
        for gname, features in self.features_groups.items():
            ...
            assert_features_equal(__cpu_features__.get(gname),
...
class Test_X86_Features(AbstractTest):
    features = [
        ...
        "AVX512ER", "AVX512PF", "AVX5124FMAPS", "AVX5124VNNIW",
    "AVX512VPOPCNTDQ",
    ...
    features_groups = dict(
        ...
        AVX512_KNM = ["AVX512F", "AVX512CD", "AVX512ER", "AVX512PF",
    "AVX5124FMAPS",
                      "AVX5124VNNIW", "AVX512VPOPCNTDQ"],
        AVX512_SKX = ["AVX512F", "AVX512CD", "AVX512BW", "AVX512DQ",
    "AVX512VL"],
        AVX512_CLX = ["AVX512F", "AVX512CD", "AVX512BW", "AVX512DQ",
    "AVX512VL", "AVX512VNNI"],
        AVX512_CNL = ["AVX512F", "AVX512CD", "AVX512BW", "AVX512DQ",
    "AVX512VL", "AVX512IFMA",
                      "AVX512VBMI"],
        AVX512_ICL = ["AVX512F", "AVX512CD", "AVX512BW", "AVX512DQ",
    "AVX512VL", "AVX512IFMA",
                      "AVX512VBMI", "AVX512VNNI", "AVX512VBMI2",
...
@pytest.mark.skipif(not is_linux or not is_power, reason="Only for Linux and
    Power")
...
@pytest.mark.skipif(not is_linux or not is_arm, reason="Only for Linux and
    ARM")
class Test_ARM_Features(AbstractTest):
    ...
    def load_flags(self):
        ...
        if  re.match("^(aarch64|AARCH64)", machine) or is_rootfs_v8:
            ...
            self.features_map = dict(
                # ELF auxiliary vector and /proc/cpuinfo on Linux kernel(armv8
    aarch32)
                # doesn't provide information about ASIMD, so we assume that
    ASIMD is supported
