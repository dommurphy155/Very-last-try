...
class TestRegression:
    ...
    def test_object_array_shape(self):
        ...
        assert_equal(np.array([[3, 4], [5, 6], None], dtype=object).shape,
    (3,))
    ...
    def test_ndmin_order(self):
        ...
        assert_(np.array(np.ones((2, 2), order='F'),
    ndmin=3).flags.f_contiguous)
        assert_(np.array(np.ones((2, 2), order='C'),
    ndmin=3).flags.c_contiguous)
    ...
    def test_misaligned_objects_segfault(self):
        ...
        a2 = np.array(['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j'],
    'S10')
        a1['f0'] = a2
        repr(a1)
        np.argmax(a1['f0'])
    ...
    def test_byteswap_complex_scalar(self):
        ...
        for dtype in [np.dtype('<'+t) for t in np.typecodes['Complex']]:
            ...
            if x.dtype.byteorder == z.dtype.byteorder:
                ...
                assert_equal(x, np.frombuffer(y.tobytes(),
    ...
    (b"cnumpy.core.multiarray\nscalar\np0\n(cnumpy\ndtype\np1\n(S'f8'\n"
            ...
            (np.bytes_(b'\x9c'),  # different 8-bit code point in KOI8-R vs
    latin1
    ...
    b"I0\nI1\ntp3\nRp4\n(I3\nS'|'\np5\nNNNI1\nI1\nI0\ntp6\nbS'\\x9c'\np7\n"
        ...
        for original, data, koi8r_validity in datas:
            ...
            if koi8r_validity == 'different':
                ...
                assert_raises(ValueError, pickle.loads, data,
    encoding='koi8-r')
            else:
    ...
    @pytest.mark.skipif(sys.maxsize < 2 ** 31 + 1, reason='overflows 32-bit
    python')
