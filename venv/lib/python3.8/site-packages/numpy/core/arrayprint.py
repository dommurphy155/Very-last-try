...
def set_printoptions(precision=None, threshold=None, edgeitems=None,
    ...
    Also to temporarily override options, use `printoptions` as a context
    manager:
    ...
    def recurser(index, hanging_indent, curr_width):
        ...
        if axes_left == 1:
            ...
            if legacy <= 113:
                ...
                elem_width = curr_width - max(len(separator.rstrip()),
    len(']'))
...
class FloatingFormat:
    ...
    def fillFormat(self, data):
        ...
        if data.size != finite_vals.size:
            ...
            self.pad_left = max(self.pad_left, nanlen - offset, inflen -
    offset)
    ...
    def __call__(self, x):
        if not np.isfinite(x):
            with errstate(invalid='ignore'):
                ...
                return ' '*(self.pad_left + self.pad_right + 1 - len(ret)) +
    ret
...
def format_float_scientific(x, precision=None, unique=True, trim='k',
    ...
    exp_digits: non-negative integer, optional
        Pad the exponent with zeros until it contains at least this many
    digits.
...
class StructuredVoidFormat:
    ...
    This does not work on structured alias types like np.dtype(('i4',
    'i2,i2')),
    ...
    def from_data(cls, data, **options):
        """
        This is a second way to initialize StructuredVoidFormat, using the raw
    data
...
def dtype_is_implied(dtype):
    """
    Determine if the given dtype is implied by the representation of its
    values.
