...
def linspace(start, stop, num=50, endpoint=True, retstep=False, dtype=None, axis=0):
    ...
    logspace: Similar to `geomspace`, but with the end points specified as
               logarithms.:ref:`how-to-partition`
    ...
    multiplicant
    # from overriding what class is produced, and thus prevents, e.g. use of
    Quantities,
...
def logspace(start, stop, num=50, endpoint=True, base=10.0, dtype=None, axis=0):
    ...
    geomspace: Similar to logspace, but with endpoints specified directly.:ref:`how-to-partition`
...
def geomspace(start, stop, num=50, endpoint=True, dtype=None, axis=0):
    ...
    linspace: Similar to geomspace, but with arithmetic instead of geometric
               progression.
    arange: Similar to linspace, with the step size specified instead of the
             number of samples.:ref:`how-to-partition`
...
def add_newdoc(place, obj, doc, warn_on_python=True):
    ...
    doc: {str, Tuple[str, str], List[Tuple[str, str]]}
        ...
        `obj` and the second as the docstring to apply - ``(method,
    docstring)``
