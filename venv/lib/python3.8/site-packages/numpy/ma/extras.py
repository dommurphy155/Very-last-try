...
A collection of utilities for `numpy.ma`.:author: Pierre Gerard-Marchant:contact: pierregm_at_uga_dot_edu:version: $Id: extras.py 3473 2007-10-29 15:18:13Z jarrod.millman $
...
def compress_nd(x, axis=None):
    ...
    axis: tuple of ints or int, optional
        ...
        parameter.
        - If axis is a tuple of ints, those are the axes to suppress slices
    from.
...
def ediff1d(arr, to_end=None, to_begin=None):
    ...
    #
    if len(arrays) != 1:
        # We'll save ourselves a copy of a potentially large array in the
    common
...
def notmasked_contiguous(a, axis=None):
    ...
    axis: int, optional
        Axis along which to perform the operation.
        If None (default), applies to a flattened version of the array, and
    this
    ...
    endpoints: list
        ...
        If the input is 2d and axis is specified, the result is a list of
    lists.
    ...
    [slice(0, 1, None), slice(2, 4, None), slice(7, 9, None), slice(11, 12,
    None)]

    >>> np.ma.notmasked_contiguous(ma, axis=0)
    [[slice(0, 1, None), slice(2, 3, None)], [], [slice(0, 1, None)],
    [slice(0, 3, None)]]

    >>> np.ma.notmasked_contiguous(ma, axis=1)
    [[slice(0, 1, None), slice(2, 4, None)], [slice(3, 4, None)], [slice(0, 1,
    None), slice(3, 4, None)]]
