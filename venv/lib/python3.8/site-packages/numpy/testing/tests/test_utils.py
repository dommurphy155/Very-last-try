...
class TestAlmostEqual(_GenericTest):
    ...
    def test_error_message_2(self):
        """Check the message is formatted correctly when either x or y is a
    scalar."""
        x = 2
        y = np.ones(20)
        with pytest.raises(AssertionError) as exc_info:
        ...
        class ReferenceCycleInDel:
            ...
            def __del__(self):
                ...
                if ReferenceCycleInDel.make_cycle:
                    # but create a new one so that the garbage collector has
    more
                    # work to do.
                    ReferenceCycleInDel()
        ...
        try:
            ...
            try:
                ...
                # the above test is only necessary if the GC actually tried to
    free
