...
def run_module_suite(file_to_run=None, argv=None):
    ...
    >>> run_module_suite(file_to_run="numpy/tests/test_matlib.py")  # doctest:
    +SKIP
...
class NoseTester:
    ...
    def test(
        ...
        label: {'fast', 'full', '', attribute identifier}, optional
            ...
            * attribute_identifier - string passed directly to nosetests as
    '-A'.
    ...
    '-A'.
        ...
        verbose: int, optional
            Verbosity value for benchmark outputs, in the range 1-10. Default
    is 1.
        extra_argv: list, optional
            List with any extra arguments to pass to nosetests.
        ...
        Each NumPy module exposes `bench` in its namespace to run all
    benchmarks
        for it.
