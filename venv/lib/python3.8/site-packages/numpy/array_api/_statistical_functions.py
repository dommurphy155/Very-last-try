...
def prod(
    ...
    *,
    ...
    if dtype is None and x.dtype == float32:
        dtype = float64
    return Array._new(np.prod(x._array, dtype=dtype, axis=axis,
    keepdims=keepdims))
...
def std(
    ...
    *,
    ...
    return Array._new(np.std(x._array, axis=axis, ddof=correction,
    keepdims=keepdims))
...
def sum(
    ...
    *,
    ...
    if dtype is None and x.dtype == float32:
        dtype = float64
    return Array._new(np.sum(x._array, axis=axis, dtype=dtype,
    keepdims=keepdims))
...
def var(
    ...
    *,
    ...
    return Array._new(np.var(x._array, axis=axis, ddof=correction,
    keepdims=keepdims))
