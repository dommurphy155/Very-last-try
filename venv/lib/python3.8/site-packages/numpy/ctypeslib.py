...
if ctypes is None:
    ...
    def load_library(libname, loader_path):
        ...
        But there are cross-platform considerations, such as library file
    extensions,
        plus the fact Windows will just load the first library it finds with
    that name.
        NumPy supplies the load_library function as a convenience.

        .. versionchanged:: 1.20.0
            Allow libname and loader_path to take any:term:`python:path-like object`.
...
if ctypes is not None:
    ...
    def _ctype_from_dtype_structured(dtype):
        ...
        if len(field_data) > 1 and all(offset == 0 for offset, name, ctype in
    field_data):
    ...
    def as_ctypes(obj):
        ...
        # can't use `_dtype((ai["typestr"], ai["shape"]))` here, as it
    overflows
