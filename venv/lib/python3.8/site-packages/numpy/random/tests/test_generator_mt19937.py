...
JUMP_TEST_DATA = [
    ...
    "16b791a1e04886ccbbb4d448d6ff791267dc458ae599475d08d5cced29d11614", "pos": 311},
        "jumped": {"key_sha256":
    "a0110a2cf23b56be0feaed8f787a7fc84bef0cb5623003d75b26bdfa1c18002c", "pos": 276},
    },
    {
...
class TestIntegers:
    ...
    '14e224389ac4580bfbdccb5697d6190b496f91227cf67df60989de3d546389b1',
               'int8':  
    '0e203226ff3fbbd1580f15da4621e5f7164d0d8d6b51696dd42d004ece2cbec1',
               'uint16':
    '54de9072b6ee9ff7f20b58329556a46a447a8a29d67db51201bf88baa6e4e5d4',
               'uint32':
    'd3a0d5efb04542b25ac712e50d21f39ac30f312a5052e9bbb1ad3baa791ac84b',
    ...
    '0e203226ff3fbbd1580f15da4621e5f7164d0d8d6b51696dd42d004ece2cbec1'}
        ...
        for dt in self.itype[1:]:
            ...
            if sys.byteorder == 'little':
                val = random.integers(0, 6 - endpoint, size=1000,
    endpoint=endpoint,
                                 dtype=dt)
            else:
                val = random.integers(0, 6 - endpoint, size=1000,
...
class TestBroadcast:
    ...
    def test_uniform(self):
        ...
        desired = np.array([0.16693771389729, 0.19635129550675,
    0.75563050964095])
    ...
    def test_normal(self):
        ...
        bad_scale = [-1]
        random = Generator(MT19937(self.seed))
        desired = np.array([-0.38736406738527,  0.79594375042255, 
    0.0197076236097])
    ...
    def test_beta(self):
        ...
        bad_a = [-1]
        bad_b = [-2]
        desired = np.array([0.18719338682602, 0.73234824491364,
    0.17928615186455])
    ...
    def test_exponential(self):
        scale = [1]
        bad_scale = [-1]
        desired = np.array([0.67245993212806, 0.21380495318094,
    0.7177848928629])
    ...
    def test_gamma(self):
        ...
        bad_shape = [-1]
        bad_scale = [-2]
        desired = np.array([1.34491986425611, 0.42760990636187,
    1.4355697857258])
    ...
    def test_f(self):
        ...
        bad_dfnum = [-1]
        bad_dfden = [-2]
        desired = np.array([0.07765056244107, 7.72951397913186,
    0.05786093891763])
    ...
    def test_noncentral_f(self):
        ...
        bad_dfden = [-1]
        bad_nonc = [-2]
        desired = np.array([2.02434240411421, 12.91838601070124,
    1.24395160354629])
    ...
    def test_chisquare(self):
        df = [1]
        bad_df = [-1]
        desired = np.array([0.05573640064251, 1.47220224353539,
    2.9469379318589])
    ...
    def test_noncentral_chisquare(self):
        ...
        bad_df = [-1]
        bad_nonc = [-2]
        desired = np.array([0.07710766249436, 5.27829115110304,
    0.630732147399])
    ...
    def test_standard_t(self):
        df = [1]
        bad_df = [-1]
        desired = np.array([-1.39498829447098, -1.23058658835223,
    0.17207021065983])
    ...
    def test_vonmises(self):
        ...
        kappa = [1]
        bad_kappa = [-1]
        desired = np.array([2.25935584988528, 2.23326261461399,
    -2.84152146503326])
    ...
    def test_pareto(self):
        a = [1]
        bad_a = [-1]
        desired = np.array([0.95905052946317, 0.2383810889437 ,
    1.04988745750013])
    ...
    def test_power(self):
        a = [1]
        bad_a = [-1]
        desired = np.array([0.48954864361052, 0.19249412888486,
    0.51216834058807])
    ...
    def test_laplace(self):
        ...
        scale = [1]
        bad_scale = [-1]
        desired = np.array([-1.09698732625119, -0.93470271947368,
    0.71592671378202])
    ...
    def test_gumbel(self):
        ...
        scale = [1]
        bad_scale = [-1]
        desired = np.array([1.70020068231762, 1.52054354273631,
    -0.34293267607081])
    ...
    def test_logistic(self):
        ...
        scale = [1]
        bad_scale = [-1]
        desired = np.array([-1.607487640433, -1.40925686003678,
    1.12887112820397])
    ...
    def test_lognormal(self):
        ...
        sigma = [1]
        bad_sigma = [-1]
        desired = np.array([0.67884390500697, 2.21653186290321,
    1.01990310084276])
    ...
    def test_wald(self):
        ...
        bad_mean = [0]
        bad_scale = [-2]
        desired = np.array([0.38052407392905, 0.50701641508592,
    0.484935249864])
    ...
    def test_triangular(self):
        ...
        desired = np.array([1.57781954604754, 1.62665986867957,
    2.30090130831326])
