...
SEED_ARR: np.ndarray[Any, np.dtype[np.int64]] = np.array([1, 2, 3, 4],
    dtype=np.int64)
...
I_int64_100: np.ndarray[Any, np.dtype[np.int64]] = np.array([100],
    dtype=np.int64)
...
I_u2_high_open: np.ndarray[Any, np.dtype[np.uint16]] = np.array([65535],
    dtype=np.uint16)
I_u2_high_closed: np.ndarray[Any, np.dtype[np.uint16]] = np.array([65535],
    dtype=np.uint16)
...
I_u4_high_open: np.ndarray[Any, np.dtype[np.uint32]] = np.array([4294967295],
    dtype=np.uint32)
...
def_gen.integers(I_u8_low_like, 18446744073709551615, dtype="u8",
    endpoint=True)
...
def_gen.integers(I_u8_low_like, 18446744073709551615, dtype="uint64",
    endpoint=True)
...
def_gen.integers(I_u8_low_like, 18446744073709551615, dtype=np.uint64,
    endpoint=True)
...
I_i1_high_open: np.ndarray[Any, np.dtype[np.int8]] = np.array([127],
    dtype=np.int8)
I_i1_high_closed: np.ndarray[Any, np.dtype[np.int8]] = np.array([127],
    dtype=np.int8)
...
I_i2_low: np.ndarray[Any, np.dtype[np.int16]] = np.array([-32768],
    dtype=np.int16)
I_i2_low_like: list[int] = [-32768]
I_i2_high_open: np.ndarray[Any, np.dtype[np.int16]] = np.array([32767],
    dtype=np.int16)
I_i2_high_closed: np.ndarray[Any, np.dtype[np.int16]] = np.array([32767],
    dtype=np.int16)
...
I_i4_low: np.ndarray[Any, np.dtype[np.int32]] = np.array([-2147483648],
    dtype=np.int32)
I_i4_low_like: list[int] = [-2147483648]
I_i4_high_open: np.ndarray[Any, np.dtype[np.int32]] = np.array([2147483647],
    dtype=np.int32)
I_i4_high_closed: np.ndarray[Any, np.dtype[np.int32]] = np.array([2147483647],
    dtype=np.int32)
...
def_gen.integers(-9223372036854775808, 9223372036854775807, dtype="i8",
    endpoint=True)
...
def_gen.integers(-9223372036854775808, I_i8_high_closed, dtype="i8",
    endpoint=True)
...
def_gen.integers(-9223372036854775808, 9223372036854775807, dtype="int64",
    endpoint=True)
def_gen.integers(I_i8_low_like, 9223372036854775807, dtype="int64",
    endpoint=True)
...
def_gen.integers(-9223372036854775808, I_i8_high_closed, dtype="int64",
    endpoint=True)
...
def_gen.integers(-9223372036854775808, 9223372036854775807, dtype=np.int64,
    endpoint=True)
def_gen.integers(I_i8_low_like, 9223372036854775807, dtype=np.int64,
    endpoint=True)
...
def_gen.integers(-9223372036854775808, I_i8_high_closed, dtype=np.int64,
    endpoint=True)
