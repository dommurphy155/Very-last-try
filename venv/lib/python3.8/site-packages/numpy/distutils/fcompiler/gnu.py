    ...
    def gnu_version_match(self, version_string):
        ...
        if len(version_string) <= 20:
            ...
            if m:
                ...
                # gfortran only outputs a version string such as #.#.#, so
    check
    ...
    def get_flags_linker_so(self):
        ...
        if sys.platform == 'darwin':
            ...
            if not target:
                ...
                if not target:
                    target = '10.9'
                    s = f'Env. variable MACOSX_DEPLOYMENT_TARGET set to
    {target}'
...
class Gnu95FCompiler(GnuFCompiler):
    ...
    if sys.platform.startswith(('aix', 'os400')):
        ...
        if platform.architecture()[0][:2] == '64':
            for key in ['compiler_f77',
    'compiler_f90','compiler_fix','linker_so', 'linker_exe']:
