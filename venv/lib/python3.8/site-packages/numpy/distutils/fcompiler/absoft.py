...
class AbsoftFCompiler(FCompiler):
    ...
    #version_pattern = r'FORTRAN 77 Compiler (?P<version>[^\s*,]*).*?Absoft
    Corp'
    version_pattern = r'(f90:.*?(Absoft Pro FORTRAN Version|FORTRAN 77
    Compiler|Absoft Fortran Compiler Version|Copyright Absoft Corporation.*?Version))'+\
    ...
    # f90: Copyright Absoft Corporation 1994-2002; Absoft Pro FORTRAN Version
    8.0
