...
class NVHPCFCompiler(FCompiler):
    ...
    Since august 2020 the NVIDIA HPC SDK includes the compilers formerly known
    as The Portland Group compilers,
    ...
    version_pattern = r'\s*(nvfortran|(pg(f77|f90|fortran)) \(aka nvfortran\))
    (?P<version>[\d.-]+).*'
