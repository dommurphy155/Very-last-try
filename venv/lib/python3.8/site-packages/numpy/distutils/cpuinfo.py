...
class SunOSCPUInfo(CPUInfoBase):
    ...
    def _is_ultraenterprice(self):
        return re.match(r'.*Ultra-Enterprise', self.info['uname_i']) is not
    None
    def _is_ultraenterprice10k(self):
        return re.match(r'.*Ultra-Enterprise-10000', self.info['uname_i']) is
    not None
...
if sys.platform.startswith('linux'): # variations: linux2,linux-i386 (any
    others?)
