...
alternatives, is described in the:doc:`"npy-format" NEP <neps:nep-0001-npy-format>`, however details have
...
def _read_array_header(fp, version, max_header_size=_MAX_HEADER_SIZE):
    ...
    hlength_str = _read_bytes(fp, struct.calcsize(hlength_type), "array header
    length")
