...
def savez_compressed(file, *args, **kwds):
    ...
    in ``.npy`` format. For a description of the ``.npy`` format, see:py:mod:`numpy.lib.format`.
...
def _genfromtxt_dispatcher(fname, dtype=None, comments=None, delimiter=None,
    ...
    usecols=None,
                           ...
                           replace_space=None, autostrip=None,
    case_sensitive=None,
                           defaultfmt=None, unpack=None, usemask=None,
    loose=None,
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    * Individual values are not stripped of spaces by default.
    ...
    defined
        ...
        if dtype is None:
            # Note: we can't use a [...]*nbcols, as we would have 3 times the
    same
