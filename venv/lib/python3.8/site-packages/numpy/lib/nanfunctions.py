...
def nanmin(
    ...
    out: ndarray, optional
        Alternate output array in which to place the result.  The default
        is ``None``; if provided, it must have the same shape as the
        expected output, but the type will be cast if necessary. See:ref:`ufuncs-output-type` for more details.
...
def nansum(
    ...
    out: ndarray, optional
        Alternate output array in which to place the result.  The default
        is ``None``. If provided, it must have the same shape as the
        expected output, but the type will be cast if necessary.  See:ref:`ufuncs-output-type` for more details. The casting of NaN to
    integer
...
def nancumprod(a, axis=None, dtype=None, out=None):
    ...
    Not a
    Numbers (NaNs) as one.  The cumulative product does not change when NaNs
    are
...
def nanvar(
    ...
    *,
    ...
    nanstd, nanmean:ref:`ufuncs-output-type`
...
def nanstd(
    ...
    *,
    ...
    --------
    var, mean, std
    nanvar, nanmean:ref:`ufuncs-output-type`
