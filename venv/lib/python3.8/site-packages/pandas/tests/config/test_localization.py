...
_current_locale = locale.setlocale(locale.LC_ALL)  # getlocale() is wrong, see
    GH#46595
...
@pytest.mark.parametrize("lc_var", (locale.LC_ALL, locale.LC_CTYPE,
    locale.LC_TIME))
...
def test_encoding_detected():
    ...
    system_encoding = system_locale.split(".")[-1] if system_locale else
    "utf-8"
