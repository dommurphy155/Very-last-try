...
class TestConcatAppendCommon:
    ...
    def test_concatlike_same_dtypes(self, item):
        ...
        # 3 elements
        res = Series(vals1)._append([Series(vals2), Series(vals3)],
    ignore_index=True)
    ...
    categorical
        ...
        # index.append
        with tm.assert_produces_warning(warn, match="concatenating
    bool-dtype"):
            # GH#39817
            res = Index(vals1).append(Index(vals2))
    ...
    def test_concatlike_datetimetz_short(self, tz):
        # GH#7795
        ix1 = pd.date_range(start="2014-07-15", end="2014-07-17", freq="D",
    tz=tz)
        ...
        exp_idx = pd.DatetimeIndex(
            ["2014-07-15", "2014-07-16", "2014-07-17", "2014-07-11",
    "2014-07-21"],
            tz=tz,
        )
    ...
    def test_concatlike_common_period(self):
        ...
        exp = pd.PeriodIndex(["2011-01", "2011-02", "2012-01", "2012-02"],
    freq="M")
    ...
    def test_union_categorical_same_categories_different_order(self):
        ...
        expected = Series(
            Categorical(["a", "b", "c", "a", "b", "c"], categories=["a", "b",
    "c"])
        )
    ...
    def test_concat_categorical_ordered(self):
        ...
        exp = Series(Categorical([1, 2, np.nan, 2, 1, 2, 1, 2, np.nan],
    ordered=True))
    ...
    def test_categorical_concat_append(self):
        ...
        vals2 = [1, 2, 1, 2]
        exp = DataFrame({"cats": cat2, "vals": vals2}, index=Index([0, 1, 0,
    1]))
