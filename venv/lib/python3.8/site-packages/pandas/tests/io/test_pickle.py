...
def current_pickle_data():
    ...
    with catch_warnings():
        filterwarnings(
            "ignore", "The 'freq' argument in Timestamp",
...
legacy_dirname = os.path.join(os.path.dirname(__file__), "data",
    "legacy_pickle")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(functools.partial(pd.to_pickle, protocol=4),
    id="pandas_proto_4"),
        pytest.param(
...
@pytest.mark.filterwarnings("ignore:The 'freq' argument in
...
class TestCompression:
    ...
    compression=zipfile.ZIP_DEFLATED) as f:
            ...
            with open(src_path, "rb") as fh:
                with tarfile.open(dest_path, mode="w") as tar:
                    tarinfo = tar.gettarinfo(src_path,
    ...
    def test_write_infer(self, compression_ext, get_random_path):
        ...
        path2 = base + ".raw"
        compression =
    self._extension_to_compression.get(compression_ext.lower())
...
@pytest.mark.parametrize("protocol", [pickle.DEFAULT_PROTOCOL,
