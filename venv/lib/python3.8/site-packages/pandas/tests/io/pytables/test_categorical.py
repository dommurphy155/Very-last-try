...
def test_categorical(setup_path):
    ...
    with ensure_clean_store(setup_path) as store:
        ...
        msg = "cannot append a categorical with different categories to the
    existing"
...
@pytest.mark.parametrize(
    ...
    []})),
        ('col=="a"', DataFrame({"col": ["a", "b", "s"]}), DataFrame({"col":
    ["a"]})),
    ],
)
def test_convert_value(setup_path, where: str, df: DataFrame, expected:
    DataFrame):
    # GH39420
