...
def deep_nested():
    ...
    return [
        ...
        },
        {
            "country": "Germany",
            "states": [
                {"name": "Bayern", "cities": [{"name": "Munich", "pop":
    12347}]},
                {
    ...
    return [
        {
            ...
            "previous_residences": {"cities": [{"city_name": "Foo York
    City"}]},
        },
        {
            "addresses": [
...
class TestJSONNormalize:
    ...
    def test_simple_normalize_with_separator(self, deep_nested):
        ...
        expected = Index(["name", "pop", "country",
    "states_name"]).sort_values()
    ...
    def test_normalize_with_multichar_separator(self):
        ...
        expected = DataFrame([[[1, 2], 2, (3, 4)]], columns=["a", "b__b_1",
    "b__b_2"])
        tm.assert_frame_equal(result, expected)
    ...
    def test_more_deeply_nested(self, deep_nested):
        ...
        result = json_normalize(
            deep_nested, ["states", "cities"], meta=["country", ["states",
    "name"]]
        )
        ex_data = {
    ...
    def test_meta_name_conflict(self):
        ...
        msg = r"Conflicting metadata name (foo|bar), need distinguishing
    prefix"
    ...
    def test_non_list_record_path_errors(self, value):
        ...
        test_path = "info"
        msg = (
            f"{test_input} has non list value {parsed_value} for path
    {test_path}. "
    ...
    def test_meta_non_iterable(self):
        ...
        result = json_normalize(json.loads(data), record_path=["data"],
    meta=["id"])
        expected = DataFrame(
...
class TestNestedToRecord:
    ...
    def test_missing_meta(self, missing_metadata):
        ...
        result = json_normalize(
            data=missing_metadata, record_path="addresses", meta="name",
    errors="ignore"
        )
        ex_data = [
    ...
    def test_missing_nested_meta(self):
        ...
        data = {"meta": "foo", "nested_meta": None, "value": [{"rec": 1},
    {"rec": 2}]}
        result = json_normalize(
            data,
            record_path="value",
        ...
        # If errors="raise" and nested metadata is null, we should raise with
    the
    ...
    def test_missing_meta_multilevel_record_path_errors_raise(self,
    missing_metadata):
        # GH41876
        # Ensure errors='raise' works as intended even when a record_path of
    length
    ...
    def test_missing_meta_multilevel_record_path_errors_ignore(self,
    missing_metadata):
        # GH41876
        # Ensure errors='ignore' works as intended even when a record_path of
    length
        # greater than one is passed in
        result = json_normalize(
            data=missing_metadata,
    ...
    def test_donot_drop_nonevalues(self):
        # GH21356
        data = [
            {"info": None, "author_name": {"first": "Smith", "last_name":
    "Appleseed"}},
            {
                "info": {"created_at": "11/08/1993", "last_updated":
    "26/05/2012"},
                "author_name": {"first": "Jane", "last_name": "Doe"},
            },
        ]
