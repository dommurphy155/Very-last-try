...
class TestTextReader:
    ...
    def test_euro_decimal(self):
        ...
        reader = TextReader(StringIO(data), delimiter=":", decimal=",",
    header=None)
        result = reader.read()
    ...
    def test_integer_thousands(self):
        ...
        reader = TextReader(StringIO(data), delimiter=":", thousands=",",
    header=None)
        result = reader.read()
    ...
    def test_skip_bad_lines(self, capsys):
        ...
        msg = r"Error tokenizing data\. C error: Expected 3 fields in line 4,
    saw 4"
...
10,11,12"""
    ...
    def test_empty_field_eof(self):
        ...
        b = DataFrame([[1, 1, 1, 0], [1, 1, 1, 0]], columns=list("abcd"),
    index=[1, 1])
        c = DataFrame(
            [
                [1, 2, 3, 4],
