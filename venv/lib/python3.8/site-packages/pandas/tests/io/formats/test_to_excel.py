...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("font-family: Serif", {"font": {"name": "serif", "family": 1}}),
        ("font-family: roman, serif", {"font": {"name": "roman", "family":
    1}}),
        ("font-family: roman, sans-serif", {"font": {"name": "roman",
    "family": 2}}),
        ("font-family: roman, sans serif", {"font": {"name": "roman"}}),
        ("font-family: roman, sansserif", {"font": {"name": "roman"}}),
        ("font-family: roman, cursive", {"font": {"name": "roman", "family":
    4}}),
        ("font-family: roman, fantasy", {"font": {"name": "roman", "family":
    5}}),
        # - size
        ...
        ("border-top-style: dashed", {"border": {"top": {"style":
    "mediumDashed"}}}),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("font-style: normal", "font-style: italic", {"font": {"italic":
    False}}),
        ("font-style: inherit", "", {}),
        (
...
@pytest.mark.parametrize(
    ...
    (
        ...
        + [("#" + rgb, rgb) for rgb in
    CSSToExcelConverter.NAMED_COLORS.values()]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([("font-weight", "bold"), ("font-weight", "normal")], "font-weight:
    normal;"),
        ([("text-align", "center"), ("TEXT-ALIGN", "right")], "text-align:
    right;"),
    ],
)
