...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"axis": 0, "subset": ["A"], "color": "red"},  # test subset and
    ignores NaN
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"left": 0, "right": 1, "props": "background-color: yellow"},  # test
    props
        {"left": -100, "right": 100, "subset": IndexSlice[[0, 1],:]},  # test
    subset
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"q_left": 0.5, "axis": 0, "props": "background-color: yellow"},  #
    tst prop
    ],
)
