...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("empty-decl", "hello: world; foo: bar", "; hello: world;; foo:
    bar;\n; ;"),
        ("empty-list", "", ";"),
    ],
)
...
def test_css_side_shorthands(shorthand, expansions):
    ...
    assert_resolves(
        f"{shorthand}: 1pt", {top: "1pt", right: "1pt", bottom: "1pt", left:
    "1pt"}
    )

    assert_resolves(
        f"{shorthand}: 1pt 4pt", {top: "1pt", right: "4pt", bottom: "1pt",
    left: "4pt"}
    )
...
def test_css_border_shorthand_sides(shorthand, sides):
    ...
    assert_resolves(
        f"{shorthand}: 1pt red solid", create_border_dict(sides, "red",
    "solid", "1pt")
    )
...
@pytest.mark.parametrize("relative_to", [None, "16pt"])  # invariant to
    inherited size
def test_css_absolute_font_size(size, relative_to, resolved):
    ...
    assert_resolves(f"font-size: {size}", {"font-size": resolved},
    inherited=inherited)
