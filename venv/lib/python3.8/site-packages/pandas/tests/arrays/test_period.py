...
def test_take_raises():
    ...
    with pytest.raises(IncompatibleFrequency, match="freq"):
        arr.take([0, -1], allow_fill=True, fill_value=pd.Period("2000",
    freq="W"))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [0, 1, 2],
            [pd.Period("2000", "D"), pd.Period("2001", "D"), pd.Period("2002",
    "D")],
            [10957, 11323, 11688],
        ),
    ],
...
@pytest.mark.parametrize(
    "other",
    [pd.Period("2000", freq="H"), period_array(["2000", "2001", "2000"],
    freq="H")],
)
