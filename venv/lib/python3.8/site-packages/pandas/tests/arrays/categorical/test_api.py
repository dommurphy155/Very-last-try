...
class TestCategoricalAPI:
    ...
    def test_set_ordered(self):
        msg = (
            ...
            "ordered-ness on categories will always return a new Categorical
    object"
        )
    ...
    inplace=True)
        ...
        cat = Categorical(["a", "b", "c", "d"])
        res = cat.rename_categories({"a": 1, "b": 2, "c": 3, "d": 4, "e": 5,
    "f": 6})
    ...
    def test_add_categories(self):
        ...
        expected = Categorical(list("abc"), categories=list("abcde"),
    ordered=True)
    ...
    def test_add_categories_existing_raises(self):
        ...
        msg = re.escape("new categories must not include old categories:
    {'d'}")
        with pytest.raises(ValueError, match=msg):
    ...
    @pytest.mark.parametrize("removals", [["c"], ["c", np.nan], "c", ["c",
    "c"]])
    ...
    def test_remove_unused_categories(self):
        c = Categorical(["a", "b", "c", "d", "a"], categories=["a", "b", "c",
    "d", "e"])
        ...
        c = Categorical(["a", "b", "c", np.nan], categories=["a", "b", "c",
    "d", "e"])
        res = c.remove_unused_categories()
...
class TestPrivateCategoricalAPI:
    def test_codes_immutable(self):
        ...
        with pytest.raises(ValueError, match="assignment destination is
    read-only"):
            codes[4] = 1
