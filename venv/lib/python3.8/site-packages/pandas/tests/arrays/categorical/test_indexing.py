...
class TestCategoricalIndexingWithFactor:
    def test_getitem(self, factor):
        ...
        subf = factor[[0, 1, 2]]
        tm.assert_numpy_array_equal(subf._codes, np.array([0, 1, 1],
    dtype=np.int8))

        subf = factor[np.asarray(factor) == "c"]
        tm.assert_numpy_array_equal(subf._codes, np.array([2, 2, 2],
    dtype=np.int8))
    ...
    @pytest.mark.parametrize(
        "other",
        [Categorical(["b", "a"]), Categorical(["b", "a"], categories=["b",
    "a"])],
    )
    ...
    def test_setitem_different_unordered_raises(self, other):
        ...
        target = Categorical(["a", "b"], categories=["a", "b"])
        mask = np.array([True, False])
        msg = "Cannot set a Categorical with another, without identical
    categories"
...
class TestCategoricalIndexing:
    ...
    def test_periodindex(self):
        idx1 = PeriodIndex(
            ["2014-01", "2014-01", "2014-02", "2014-02", "2014-03",
    "2014-03"], freq="M"
        )
        ...
        idx2 = PeriodIndex(
            ["2014-03", "2014-03", "2014-02", "2014-01", "2014-03",
    "2014-01"], freq="M"
        )
    ...
    def test_where_unobserved_categories(self):
        ser = Series(Categorical(["a", "b", "c"], categories=["d", "c", "b",
    "a"]))
