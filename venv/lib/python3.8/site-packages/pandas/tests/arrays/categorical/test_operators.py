...
class TestCategoricalOpsWithFactor:
    ...
    def test_comparisons(self, factor):
        ...
        cat_rev = Categorical(["a", "b", "c"], categories=["c", "b", "a"],
    ordered=True)
        cat_rev_base = Categorical(
            ["b", "b", "b"], categories=["c", "b", "a"], ordered=True
        )
        cat = Categorical(["a", "b", "c"], ordered=True)
        cat_base = Categorical(["b", "b", "b"], categories=cat.categories,
    ordered=True)
        ...
        cat_rev_base2 = Categorical(["b", "b", "b"], categories=["c", "b",
    "a", "d"])
        ...
        # account
        cat_rev = Categorical(list("abc"), categories=list("cba"),
    ordered=True)
...
class TestCategoricalOps:
    ...
    def test_datetime_categorical_comparison(self):
        ...
        tm.assert_numpy_array_equal(dt_cat > dt_cat[0], np.array([False, True,
    True]))
        tm.assert_numpy_array_equal(dt_cat[0] < dt_cat, np.array([False, True,
    True]))
    ...
    @pytest.mark.parametrize(
        "data,reverse,base",
        [(list("abc"), list("cba"), list("bbb")), ([1, 2, 3], [3, 2, 1], [2,
    2, 2])],
    )
    def test_comparisons(self, data, reverse, base):
        cat_rev = Series(Categorical(data, categories=reverse, ordered=True))
        cat_rev_base = Series(Categorical(base, categories=reverse,
    ordered=True))
    ...
    def test_unordered_different_categories_raises(self):
        ...
        with pytest.raises(TypeError, match=("Categoricals can only be
    compared")):
            c1 == c2
    ...
    def test_numeric_like_ops(self):
        ...
        for op, str_rep in [
            ...
            msg = f"Series cannot perform the operation {str_rep}|unsupported
    operand"
            with pytest.raises(TypeError, match=msg):
                getattr(df, op)(df)
