...
class TestCategoricalConstructors:
    ...
    def test_constructor_with_null(self):
        ...
        with pytest.raises(ValueError, match=msg):
            Categorical([np.nan, "a", "b", "c"], categories=[np.nan, "a", "b",
    "c"])

        with pytest.raises(ValueError, match=msg):
            Categorical([None, "a", "b", "c"], categories=[None, "a", "b",
    "c"])
    ...
    def test_constructor_with_categorical_categories(self):
        ...
        result = Categorical(["a", "b"], categories=Categorical(["a", "b",
    "c"]))
        tm.assert_categorical_equal(result, expected)

        result = Categorical(["a", "b"], categories=CategoricalIndex(["a",
    "b", "c"]))
        tm.assert_categorical_equal(result, expected)

    @pytest.mark.parametrize("klass", [lambda x: np.array(x, dtype=object),
    list])
    ...
    def test_from_codes_non_unique_categories(self):
        with pytest.raises(ValueError, match="Categorical categories must be
    unique"):
            Categorical.from_codes([0, 1, 2], categories=["a", "a", "b"])

    def test_from_codes_nan_cat_included(self):
        with pytest.raises(ValueError, match="Categorical categories cannot be
    null"):
    ...
    def test_from_codes_with_categorical_categories(self, klass):
        ...
        result = Categorical.from_codes([0, 1], categories=klass(["a", "b",
    "c"]))
        tm.assert_categorical_equal(result, expected)
    ...
    def test_from_codes_with_nan_code(self):
        ...
        codes = [1, 2, np.nan]
        dtype = CategoricalDtype(categories=["a", "b", "c"])
        with pytest.raises(ValueError, match="codes need to be array-like
    integers"):
    ...
    def test_from_codes_with_dtype_raises(self):
        ...
        with pytest.raises(ValueError, match=msg):
            Categorical.from_codes(
                [0, 1], categories=["a", "b"], dtype=CategoricalDtype(["a",
    "b"])
            )
    ...
    def test_constructor_string_and_tuples(self):
        # GH 21416
        c = Categorical(np.array(["c", ("a", "b"), ("b", "a"), "c"],
    dtype=object))
