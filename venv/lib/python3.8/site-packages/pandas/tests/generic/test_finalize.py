...
_all_methods = [
    ...
    (pd.DataFrame, frame_data, operator.methodcaller("__getitem__", ["A"])),
    (pd.DataFrame, frame_data, operator.methodcaller("__getitem__",
    np.array([True]))),
    (pd.DataFrame, ({("A", "a"): [1]},), operator.methodcaller("__getitem__",
    ["A"])),
    (pd.DataFrame, frame_data, operator.methodcaller("query", "A == 1")),
    (pd.DataFrame, frame_data, operator.methodcaller("eval", "A + 1",
    engine="python")),
    (pd.DataFrame, frame_data, operator.methodcaller("select_dtypes",
    include="int")),
    ...
    (pd.DataFrame, frame_data, operator.methodcaller("rename", columns={"A":
    "a"})),
    (pd.DataFrame, frame_data, operator.methodcaller("rename", index=lambda x:
    x)),
    (pd.DataFrame, frame_data, operator.methodcaller("fillna", "A")),
    (pd.DataFrame, frame_data, operator.methodcaller("fillna",
    method="ffill")),
    ...
    (
        pd.DataFrame,
        ({"A": [1], "B": [1]},),
        operator.methodcaller("pivot_table", columns="A", aggfunc=["mean",
    "sum"]),
    ),
    ...
    pytest.param(
        (pd.DataFrame, frame_data, operator.methodcaller("applymap", lambda x:
    x))
    ),
    pytest.param(
        (
    ...
    pytest.param(
        (pd.DataFrame, frame_mi_data, operator.methodcaller("count",
    level="A")),
        marks=[
            pytest.mark.filterwarnings("ignore:Using the level
    ...
    pytest.param(
        (pd.DataFrame, frame_mi_data, operator.methodcaller("isin",
    pd.Series([1]))),
    ),
    pytest.param(
        (
    ...
    (pd.DataFrame, frame_data, operator.methodcaller("rename_axis",
    columns="a")),
    # Unary ops
    ...
    (pd.DataFrame, (frame_data,), operator.methodcaller("sample", n=2,
    replace=True)),
    ...
    (pd.Series, ([1, 2],), operator.methodcaller("where", np.array([True,
    False]))),
    (pd.DataFrame, frame_data, operator.methodcaller("where",
    np.array([[True]]))),
    (pd.Series, ([1, 2],), operator.methodcaller("mask", np.array([True,
    False]))),
    (pd.DataFrame, frame_data, operator.methodcaller("mask",
    np.array([[True]]))),
    pytest.param(
        (
            pd.Series,
    ...
    (pd.Series, ([1],), operator.methodcaller("transform", lambda x: x -
    x.min())),
    pytest.param(
        (
            pd.DataFrame,
    ...
    pytest.param(
        (pd.DataFrame, frame_mi_data, operator.methodcaller("apply", lambda x:
    x)),
    ),
    # Cumulative reductions
