...
class TestSorting:
    ...
    def test_int64_overflow(self):
        ...
        tups = list(map(tuple, df[["A", "B", "C", "D", "E", "F", "G",
    "H"]].values))
    ...
    def test_int64_overflow_groupby_large_range(self):
        # GH9096
        values = range(55109)
        data = DataFrame.from_dict({"a": values, "b": values, "c": values,
    "d": values})
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [
                False,
                "last",
                list(range(104, 4, -1)) + list(range(5)) + list(range(105,
    110)),
            ],
            [
                False,
                "first",
                list(range(5)) + list(range(105, 110)) + list(range(104, 4,
    -1)),
            ],
        ],
    )
    ...
    first
        ...
        result = nargsort(
            items, kind="mergesort", ascending=ascending,
...
class TestMerge:
    def test_int64_overflow_outer_merge(self):
        ...
        df1 = DataFrame(np.random.randn(1000, 7), columns=list("ABCDEF") +
    ["G1"])
        df2 = DataFrame(np.random.randn(1000, 7), columns=list("ABCDEF") +
    ["G2"])
    ...
    def test_int64_overflow_one_to_many_none_match(self, how, sort):
        ...
        if sort:
            ...
            tm.assert_frame_equal(
                res[kcols].copy(), res[kcols].sort_values(kcols,
    kind="mergesort")
            )
...
class TestSafeSort:
    ...
    @pytest.mark.parametrize("box", [lambda x: np.array(x, dtype=object),
    list])
    ...
    @pytest.mark.parametrize(
        "arg, exp", [[[1, 3, 2], [1, 2, 3]], [[1, 3, np.nan, 2], [1, 2, 3,
    np.nan]]]
    )
