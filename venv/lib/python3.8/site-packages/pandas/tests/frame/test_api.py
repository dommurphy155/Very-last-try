...
class TestDataFrameMisc:
    ...
    def test_empty(self, float_frame, float_string_frame):
        ...
        # corner case
        df = DataFrame({"A": [1.0, 2.0, 3.0], "B": ["a", "b", "c"]},
    index=np.arange(3))
        del df["A"]
        assert not df.empty
    ...
    def test_inplace_return_self(self):
        ...
        data = DataFrame(
            {"a": ["foo", "bar", "baz", "qux"], "b": [0, 0, 1, 1], "c": [1, 2,
    3, 4]}
        )
    ...
    def test_set_flags(
        ...
        if allows_duplicate_labels is None:
            ...
            assert result.flags.allows_duplicate_labels is
    ...
    def test_constructor_expanddim(self):
        # GH#33628 accessing _constructor_expanddim should not raise
    NotImplementedError
