...
# TODO(ArrayManager) check which of those tests need to be rewritten to test
    the
...
class TestDataFrameBlockInternals:
    ...
    constructor"
        ...
        depr_msg = "either all columns will be cast to that dtype, or a
    TypeError will"
    ...
    def test_consolidate_datetime64(self):
        ...
        tm.assert_index_equal(pd.DatetimeIndex(df.starting),
    ser_starting.index)
    ...
    def test_add_column_with_pandas_array(self):
        ...
        df["c"] = pd.arrays.PandasArray(np.array([1, 2, None, 3],
    dtype=object))
        df2 = DataFrame(
            {
                "a": [1, 2, 3, 4],
                "b": ["a", "b", "c", "d"],
                "c": pd.arrays.PandasArray(np.array([1, 2, None, 3],
    dtype=object)),
            }
        )
