...
class TestRename:
    ...
    def test_rename_multiindex(self):
        ...
        columns = MultiIndex.from_tuples(tuples_columns, names=["fizz",
    "buzz"])
    ...
    @td.skip_array_manager_not_yet_implemented  # TODO(ArrayManager) setitem
    copy/view
    ...
    def test_rename_axis_style_raises(self):
        ...
        over_spec_msg = "Cannot specify both 'axis' and any of 'index' or
    'columns'"
        ...
        # Too many targets
        over_spec_msg = "Cannot specify both 'mapper' and any of 'index' or
    'columns'"
        with pytest.raises(TypeError, match=over_spec_msg):
    ...
    def test_rename_with_duplicate_columns(self):
        ...
        result = k.rename(columns={"TClose_x": "TClose", "TClose_y":
    "QT_Close"})
        str(result)
        result.dtypes
    ...
    def test_rename_boolean_index(self):
        df = DataFrame(np.arange(15).reshape(3, 5), columns=[False, True, 2,
    3, 4])
