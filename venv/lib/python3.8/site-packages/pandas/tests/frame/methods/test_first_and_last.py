...
class TestFirst:
    ...
    def test_first_last_raises(self, frame_or_series):
        ...
        with pytest.raises(TypeError, match=msg):  # index is not a
    DatetimeIndex
            obj.first("1D")
    ...
    @pytest.mark.parametrize("start, periods", [("2010-03-31", 1),
    ("2010-03-30", 2)])
    def test_first_with_first_day_last_of_month(self, frame_or_series, start,
    periods):
        # GH#29623
    ...
    def test_first_with_first_day_end_of_frq_n_greater_one(self,
    frame_or_series):
        # GH#29623
        x = frame_or_series([1] * 100, index=bdate_range("2010-03-31",
    periods=100))
        result = x.first("2M")
        expected = frame_or_series(
