...
class TestDataFrameMissingData:
    def test_dropEmptyRows(self, float_frame):
        ...
        return_value = inplace_frame2.dropna(how="all", subset=["foo"],
    inplace=True)
        tm.assert_series_equal(smaller_frame["foo"], expected)
    ...
    def test_subset_is_nparray(self):
        # GH 41021
        df = DataFrame({"A": [1, 2, np.NaN], "B": list("abc"), "C": [4,
    np.NaN, 5]})
    ...
    def test_how_thresh_param_incompatible(self):
        ...
        msg = "You cannot set both the how and thresh arguments at the same
    time"
