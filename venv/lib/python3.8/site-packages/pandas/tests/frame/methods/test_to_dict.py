...
class TestDataFrameToDict:
    ...
    def test_to_dict_not_unique_warning(self):
        # GH#16927: When converting to a dict, if a column has a non-unique
    name
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("split", lambda d, col, idx:
    d["data"][idx][d["columns"].index(col)]),
    ...
    def test_to_dict_scalar_constructor_orient_dtype(self, data,
    expected_dtype):
        # GH22620 & GH21256
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            MultiIndex.from_tuples([("a", "b"), ("a", "c")], names=["n1",
    "n2"]),
        ],
    )
    @pytest.mark.parametrize(
    ...
    def test_to_dict_orient_tight(self, index, columns):
        ...
        roundtrip = DataFrame.from_dict(df.to_dict(orient="tight"),
    orient="tight")
