...
class TestBusinessHour(Base):
    ...
    def setup_method(self):
        ...
        self.offset8 = BusinessHour(start=["09:00", "13:00"], end=["12:00",
    "17:00"])
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ["09:00", "11:00"],
                ["12:00", "20:00"],
                r"invalid starting and ending time\(s\): opening hours should
    not "
    ...
    def test_repr(self):
        ...
        assert repr(self.offset8) == "<BusinessHour:
    BH=09:00-12:00,13:00-17:00>"
        assert repr(self.offset9) == "<3 * BusinessHours:
    BH=09:00-13:00,22:00-03:00>"
        assert repr(self.offset10) == "<-1 * BusinessHour:
    BH=13:00-17:00,23:00-02:00>"
    ...
    apply_cases = [
        (
            BusinessHour(),
            {
                ...
                datetime(2014, 7, 1, 16, 30, 15): datetime(2014, 7, 2, 9, 30,
    15),
    ...
    30),
        ...
        (
            BusinessHour(-1),
            {
                ...
                datetime(2014, 7, 1, 16, 30, 15): datetime(2014, 7, 1, 15, 30,
    15),
                datetime(2014, 7, 1, 9, 30, 15): datetime(2014, 6, 30, 16, 30,
    15),
    ...
    30),
        ...
        (
            BusinessHour(start="13:00", end="16:00"),
            {
                ...
                datetime(2014, 7, 1, 15, 30, 15): datetime(2014, 7, 2, 13, 30,
    15),
        ...
        (
            BusinessHour(n=2, start="13:00", end="16:00"),
            {
                ...
                datetime(2014, 7, 4, 14, 30, 30): datetime(2014, 7, 7, 13, 30,
    30),
            },
        ),
        (
            BusinessHour(n=-1, start="13:00", end="16:00"),
            {
                ...
                datetime(2014, 7, 2, 13, 30, 15): datetime(2014, 7, 1, 15, 30,
    15),
        ...
        (
            BusinessHour(n=-3, start="10:00", end="16:00"),
            {
                ...
                datetime(2014, 7, 4, 12, 30, 30): datetime(2014, 7, 3, 15, 30,
    30),
            },
        ),
        (
            BusinessHour(start="19:00", end="05:00"),
            {
                ...
                datetime(2014, 7, 5, 4, 30, 30): datetime(2014, 7, 7, 19, 30,
    30),
            },
        ),
        (
            BusinessHour(n=-1, start="19:00", end="05:00"),
            {
                ...
                datetime(2014, 7, 7, 19, 30, 30): datetime(2014, 7, 5, 4, 30,
    30),
            },
        ),
        (
            BusinessHour(n=4, start="00:00", end="23:00"),
            {
                ...
                datetime(2014, 7, 4, 22, 30, 30): datetime(2014, 7, 7, 3, 30,
    30),
                datetime(2014, 7, 4, 22, 30, 20): datetime(2014, 7, 7, 3, 30,
    20),
            },
        ),
        (
            BusinessHour(n=-4, start="00:00", end="23:00"),
            {
                ...
                datetime(2014, 7, 7, 3, 30, 30): datetime(2014, 7, 4, 22, 30,
    30),
                datetime(2014, 7, 7, 3, 30, 20): datetime(2014, 7, 4, 22, 30,
    20),
            },
        ),
        (
            BusinessHour(start=["09:00", "14:00"], end=["12:00", "18:00"]),
            {
                ...
                datetime(2014, 7, 1, 16, 30, 15): datetime(2014, 7, 1, 17, 30,
    15),
                ...
                datetime(2014, 7, 4, 17, 30, 30): datetime(2014, 7, 7, 9, 30,
    30),
            },
        ),
        (
    ...
    "18:00"]),
            {
                ...
                datetime(2014, 7, 4, 16, 30, 30): datetime(2014, 7, 7, 11, 30,
    30),
            },
        ),
        (
    ...
    "18:00"]),
            {
                ...
                datetime(2014, 7, 7, 9, 30, 30): datetime(2014, 7, 4, 14, 30,
    30),
            },
        ),
        (
    ...
    "05:00"]),
            {
                ...
                datetime(2014, 7, 7, 19, 30, 30): datetime(2014, 7, 7, 4, 30,
    30),
            },
        ),
    ]
    ...
    30),
        ...
        (
            ...
            BusinessHour(n=-25, start=["09:00", "14:00"], end=["12:00",
    "19:00"]),
            {
                datetime(2014, 7, 1, 11): datetime(2014, 6, 26, 10),
    ...
    opening_time_cases = [
        ...
        (
            [
                ...
                BusinessHour(n=3, start=["11:15", "15:00"], end=["12:00",
    "20:00"]),
                BusinessHour(start=["11:15", "15:00"], end=["13:00", "17:00"]),
                BusinessHour(n=2, start=["11:15", "15:00"], end=["12:00",
    "03:00"]),
                BusinessHour(n=3, start=["11:15", "15:00"], end=["13:00",
    "16:00"]),
            ],
            {
                datetime(2014, 7, 1, 11): (
        ...
        (
            [
                BusinessHour(n=-1, start=["17:00", "08:00"], end=["05:00",
    "10:00"]),
                BusinessHour(n=-2, start=["08:00", "17:00"], end=["10:00",
    "03:00"]),
            ],
            {
                datetime(2014, 7, 1, 11): (
