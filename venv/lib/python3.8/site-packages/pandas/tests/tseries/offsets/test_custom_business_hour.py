...
class TestCustomBusinessHour(Base):
    ...
    normalize_cases = [
        ...
        (
            CustomBusinessHour(
                1, normalize=True, start="17:00", end="04:00",
    holidays=holidays
            ),
            {
                datetime(2014, 7, 1, 8): datetime(2014, 7, 1),
    ...
    def test_is_on_offset(self):
        tests = [
            (
                CustomBusinessHour(start="10:00", end="15:00",
    ...
    apply_cases = [
        (
            CustomBusinessHour(holidays=holidays),
            {
                ...
                datetime(2014, 7, 1, 16, 30, 15): datetime(2014, 7, 3, 9, 30,
    15),
...
def test_custom_businesshour_weekmask_and_holidays(weekmask, expected_time,
    mult):
    # GH 23542
    holidays = ["2018-11-09"]
