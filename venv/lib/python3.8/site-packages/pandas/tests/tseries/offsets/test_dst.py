...
class TestDST:
    ...
    timezone_utc_offsets = {
        ...
        "dateutil/US/Pacific": {"utc_offset_daylight": -7,
    ...
    def test_springforward_plural(self):
        ...
        for tz, utc_offsets in self.timezone_utc_offsets.items():
            ...
            self._test_all_offsets(
                n=3,
                tstart=self._make_timestamp(self.ts_pre_springfwd, hrs_pre,
    tz),
    ...
    [
        pytest.param(
            ...
            marks=pytest.mark.xfail(
                pytz_version < Version("2020.5") or pytz_version ==
    Version("2022.2"),
...
def test_nontick_offset_with_ambiguous_time_error(original_dt, target_dt,
    ...
    msg = f"Cannot infer dst time from {target_dt}, try using the 'ambiguous'
    argument"
