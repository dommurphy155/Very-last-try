...
class TestDatetime64ArrayLikeComparisons:
    ...
    def test_dt64arr_cmp_mixed_invalid(self, tz_naive_fixture):
        ...
        msg = "Invalid comparison between|Cannot compare type|not supported
    between"
...
class TestDatetime64SeriesComparison:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [Period("2011-01", freq="M"), NaT, Period("2011-03",
    freq="M")],
    ...
    @pytest.mark.parametrize("val", [datetime(2000, 1, 4), datetime(2000, 1,
    5)])
...
class TestDatetimeIndexComparisons:
    ...
    def test_dti_cmp_nat(self, dtype, box_with_array):
        ...
        left = DatetimeIndex([Timestamp("2011-01-01"), NaT,
    ...
    def test_comparison_tzawareness_compat(self, comparison_op,
    box_with_array):
        # GH#18162
        op = comparison_op
        box = box_with_array
    ...
    def test_comparison_tzawareness_compat_scalars(self, comparison_op,
    box_with_array):
        # GH#18162
        op = comparison_op
        ...
        assert np.all(dr > ts)
        msg = r"Invalid comparison between dtype=datetime64\[ns.*\] and
    Timestamp"
        if op not in [operator.eq, operator.ne]:
            with pytest.raises(TypeError, match=msg):
                op(dr, ts_tz)
...
class TestDatetime64Arithmetic:
    ...
    def test_dt64_array_sub_dt64_array_with_different_timezone(self,
    box_with_array):
        t1 = date_range("20130101", periods=3).tz_localize("US/Eastern")
        t1 = tm.box_expected(t1, box_with_array)
    ...
    def test_dt64arr_sub_dt64object_array(self, box_with_array,
    tz_naive_fixture):
    ...
    #  a freq.
    @pytest.mark.parametrize("freq", ["H", "D", "W", "M", "MS", "Q", "B",
    None])
    ...
    def test_dt64arr_addsub_intlike(
        ...
        assert_invalid_addsub_type(obj,
    pd.core.indexes.api.NumericIndex(other), msg)
    ...
    def test_dt64arr_addsub_time_objects_raises(self, box_with_array,
    tz_naive_fixture):
        # https://github.com/pandas-dev/pandas/issues/10329
...
class TestDatetime64DateOffsetArithmetic:
    ...
    @pytest.mark.parametrize(
        "cls_name", ["Day", "Hour", "Minute", "Second", "Milli", "Micro",
    "Nano"]
    )
    ...
    def test_dti_add_tick_tzaware(self, tz_aware_fixture, box_with_array):
        ...
        for scalar in [pd.offsets.Hour(5), np.timedelta64(5, "h"),
    timedelta(hours=5)]:
            offset = dates + scalar
            ...
            msg = "|".join(
                ["bad operand type for unary -", "cannot subtract
    DatetimeArray"]
            )
            with pytest.raises(TypeError, match=msg):
                scalar - dates
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("FY5253", {"weekday": 0, "startingMonth": 2, "variation":
    "nearest"}),
    ...
    @pytest.mark.parametrize("op", [operator.add, roperator.radd,
    operator.sub])
    ...
    def test_dt64arr_add_sub_offset_array(
        ...
        expected = DatetimeIndex([op(dti[n], other[n]) for n in
    range(len(dti))])
        expected = tm.box_expected(expected, box_with_array)
...
class TestTimestampSeriesArithmetic:
    ...
    @pytest.mark.parametrize(
        ...
        [
            [
                ...
                [Timestamp("20111231"), Timestamp("20120102"),
    Timestamp("20120104")],
                ["__sub__", "__rsub__"],
            ],
            [
    ...
    seconds=3), NaT],
            ...
            [
                ...
                [timedelta(minutes=5, seconds=3), NaT, timedelta(minutes=5,
    seconds=3)],
                ["__add__", "__radd__", "__sub__"],
            ],
        ],
    ...
    def test_dt64_series_add_mixed_tick_DateOffset(self):
        ...
        expected = Series(
            [Timestamp("20130101 9:01:00.005"), Timestamp("20130101
    9:02:00.005")]
        )
        tm.assert_series_equal(result, expected)
        ...
        expected = Series(
            [Timestamp("20130101 9:06:00.005"), Timestamp("20130101
    9:07:00.005")]
        )
        tm.assert_series_equal(result, expected)
...
class TestDatetimeIndexArithmetic:
    ...
    def test_ufunc_coercions(self):
        ...
        delta = np.array(
            [np.timedelta64(1, "D"), np.timedelta64(2, "D"), np.timedelta64(3,
    "D")]
        )
    ...
    def test_dti_add_series(self, tz_naive_fixture, names):
        ...
        expected = Series(index + Timedelta(seconds=5), index=index,
    name=names[2])
    ...
    name=names[1])
        ...
        expected = DatetimeIndex(
            [op(dti[n], other[n]) for n in range(len(dti))], name=names[2],
    freq="infer"
        )
        expected = tm.box_expected(expected, xbox)
        tm.assert_equal(res, expected)
    ...
    def test_dti_addsub_object_arraylike(
        ...
        expected = DatetimeIndex(["2017-01-31", "2017-01-06"],
    tz=tz_naive_fixture)
        expected = tm.box_expected(expected, xbox)
        ...
        expected = DatetimeIndex(["2016-12-31", "2016-12-29"],
    tz=tz_naive_fixture)
        expected = tm.box_expected(expected, xbox)
