...
class TestArithmetic:
    ...
    def test_objarr_add_invalid(self, op, box_with_array):
        ...
        msg = "|".join(
            ["can only concatenate str", "unsupported operand type", "must be
    str"]
        )
    ...
    def test_series_with_dtype_radd_timedelta(self, dtype):
        ...
        ser = Series(
            [pd.Timedelta("1 days"), pd.Timedelta("2 days"), pd.Timedelta("3
    days")],
            dtype=dtype,
        )
        expected = Series(
            [pd.Timedelta("4 days"), pd.Timedelta("5 days"), pd.Timedelta("6
    days")]
        )
    ...
    def test_mixed_timezone_series_ops_object(self):
        ...
        exp = Series([pd.Timedelta("2 days"), pd.Timedelta("4 days")],
    name="xxx")
        ...
        exp = Series([pd.Timedelta("01:30:00"), pd.Timedelta("02:30:00")],
    name="xxx")
