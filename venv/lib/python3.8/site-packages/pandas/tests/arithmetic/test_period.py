...
class TestPeriodArrayLikeComparisons:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            9,
            9.5,
            2000,  # specifically don't consider 2000 to match Period("2000",
    "D")
            False,
            None,
        ],
    ...
    @pytest.mark.parametrize("other_box", [list, np.array, lambda x:
    x.astype(object)])
...
class TestPeriodIndexComparisons:
    ...
    freq=freq)
        ...
        rev_msg = r"Invalid comparison between dtype=period\[A-DEC\] and
    PeriodArray"
        ...
        rev_msg = r"Invalid comparison between dtype=period\[4M\] and
    PeriodArray"
        idx_msg = rev_msg if box_with_array in [tm.to_array, pd.array] else msg
        with pytest.raises(TypeError, match=idx_msg):
            base <= idx
    ...
    def test_pi_cmp_nat_mismatched_freq_raises(self, freq):
        ...
        msg = rf"Invalid comparison between dtype=period\[{freq}\] and
    PeriodArray"
        with pytest.raises(TypeError, match=msg):
            idx1 > diff
    ...
    def test_comp_nat(self, dtype):
        left = PeriodIndex([Period("2011-01-01"), pd.NaT,
    Period("2011-01-03")])
...
class TestPeriodFrameArithmetic:
    def test_ops_frame_period(self):
        ...
        df = pd.DataFrame(
            {
                "A": [Period("2015-01", freq="M"), Period("2015-02",
    freq="M")],
                "B": [Period("2014-01", freq="M"), Period("2014-02",
    freq="M")],
            }
        )
        ...
        df2 = pd.DataFrame(
            {
                "A": [Period("2015-05", freq="M"), Period("2015-06",
    freq="M")],
                "B": [Period("2015-05", freq="M"), Period("2015-06",
    freq="M")],
            }
        )
...
class TestPeriodIndexArithmetic:
    ...
    def test_pi_add_sub_td64_array_non_tick_raises(self):
        ...
        msg = r"Cannot add or subtract timedelta64\[ns\] dtype from
    period\[Q-DEC\]"
        with pytest.raises(TypeError, match=msg):
            rng + tdarr
        with pytest.raises(TypeError, match=msg):
    ...
    def test_parr_add_timedeltalike_minute_gt1(self, three_days,
    box_with_array):
        ...
        expected = PeriodIndex(["2014-05-04", "2014-05-06", "2014-05-08"],
    freq="2D")
        expected = tm.box_expected(expected, box_with_array)
        ...
        # subtraction
        expected = PeriodIndex(["2014-04-28", "2014-04-30", "2014-05-02"],
    freq="2D")
        expected = tm.box_expected(expected, box_with_array)
        result = rng - other
        tm.assert_equal(result, expected)
    ...
    @pytest.mark.parametrize("freqstr", ["5ns", "5us", "5ms", "5s", "5T",
    "5h", "5d"])
    def test_parr_add_timedeltalike_tick_gt1(self, three_days, freqstr,
    box_with_array):
        # GH#23031 adding a time-delta-like offset to a PeriodArray that has
    ...
    def test_pi_add_iadd_timedeltalike_hourly(self, two_hours):
        ...
        expected = period_range("2014-01-01 12:00", "2014-01-05 12:00",
    freq="H")
    ...
    def test_pi_sub_isub_timedeltalike_hourly(self, two_hours):
        other = two_hours
        rng = period_range("2014-01-01 10:00", "2014-01-05 10:00", freq="H")
        expected = period_range("2014-01-01 08:00", "2014-01-05 08:00",
    freq="H")
