...
class TestSeriesFillNA:
    ...
    def test_fillna_consistency(self):
        ...
        with tm.assert_produces_warning(FutureWarning, match="the 'errors'
    keyword"):
            result = ser.where(
    ...
    def test_datetime64_tz_fillna(self, tz):
        ...
        result = ser.fillna(
            {1: Timestamp("2011-01-02 10:00"), 3: Timestamp("2011-01-04
    10:00")}
        )
        expected = Series(
            [
        ...
        # DatetimeTZBlock
        idx = DatetimeIndex(["2011-01-01 10:00", NaT, "2011-01-03 10:00",
    NaT], tz=tz)
        ser = Series(idx)
    ...
    def test_fillna_period(self):
        ...
        exp = Series([Period("2011-01", freq="M"), Period("2012-01",
    freq="M")])
    ...
    def test_fillna_numeric_inplace(self):
        x = Series([np.nan, 1.0, np.nan, 3.0, np.nan], ["z", "a", "b", "c",
    "d"])
        y = x.copy()
...
class TestFillnaPad:
    def test_fillna_bug(self):
        ser = Series([np.nan, 1.0, np.nan, 3.0, np.nan], ["z", "a", "b", "c",
    "d"])
    ...
    dtype=float
        ...
        expected = Series(
            [np.nan, 1.0, 1.0, 3.0, 3.0], ["z", "a", "b", "c", "d"],
    dtype=float
        )
    ...
    def test_datetime64tz_fillna_round_issue(self):
        ...
        data = Series(
            [NaT, NaT, datetime(2016, 12, 12, 22, 24, 6, 100001,
    tzinfo=pytz.utc)]
        )
