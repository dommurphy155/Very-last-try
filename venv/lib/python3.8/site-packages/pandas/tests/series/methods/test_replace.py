...
class TestSeriesReplace:
    ...
    def test_replace_noop_doesnt_downcast(self):
        # GH#44498
        ser = pd.Series([None, None, pd.Timestamp("2021-12-16 17:31")],
    dtype=object)
    ...
    GH#44940
        ...
        result = dr.astype(object).replace([dr[0], dr[1], dr[2]], [1.0, 2,
    "a"])
    ...
    def test_replace_categorical(self, categorical, numeric):
        ...
        if 2 not in expected.cat.categories:
            # i.e. categories should be [1, 2] even if there are no "B"s
    present
            # GH#44940
    ...
    def test_replace_categorical_single(self):
        ...
        assert return_value is None
        assert c[0] == c[1] == first_value  # test replacing with existing
    value
    ...
    def test_replace_only_one_dictlike_arg(self, fixed_now_ts):
        ...
        to_replace = {0: 1, 2: "A"}
        value = "foo"
        msg = "Series.replace cannot use dict-like to_replace and non-None
    value"
        with pytest.raises(ValueError, match=msg):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                IntervalArray([pd.Interval(10.6, 20.8), pd.Interval(2.8,
    3.1)]),
            ),
            (
                pd.PeriodDtype("M"),
