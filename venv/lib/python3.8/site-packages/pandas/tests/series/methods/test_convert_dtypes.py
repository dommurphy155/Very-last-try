...
test_cases = [
    ...
    (pd.period_range("1/1/2011", freq="M", periods=3), None,
    pd.PeriodDtype("M"), {}),
    (
...
class TestSeriesConvertDtypes:
    ...
    def test_convert_dtypes(
        ...
        for spec, dtype in expected_other.items():
            if all(params_dict[key] is val for key, val in zip(spec[::2],
    spec[1::2])):
    ...
    def test_convert_string_dtype(self, nullable_string_dtype):
        # https://github.com/pandas-dev/pandas/issues/31731 -> converting
    columns
