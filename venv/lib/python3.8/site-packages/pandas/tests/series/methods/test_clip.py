...
class TestSeriesClip:
    ...
    nulls_fixture):
        ...
        expected_upper = Series([nulls_fixture, 1.0, 2.0],
    dtype=any_numeric_ea_dtype)
        expected_lower = Series([nulls_fixture, 2.0, 3.0],
    dtype=any_numeric_ea_dtype)
    ...
    def test_clip_with_na_args(self):
        ...
        tm.assert_series_equal(s.clip(upper=np.nan, lower=np.nan), Series([1,
    2, 3]))
    ...
    def test_clip_with_datetimes(self):
        ...
        s = Series([Timestamp("2015-12-01 09:30:00"), Timestamp("2015-12-01
    09:31:00")])
        result = s.clip(upper=t)
        expected = Series(
            [Timestamp("2015-12-01 09:30:00"), Timestamp("2015-12-01
    09:30:30")]
        )
        tm.assert_series_equal(result, expected)
    ...
    def test_clip_pos_args_deprecation(self):
        ...
        ser = Series([1, 2, 3])
        msg = (
            r"In a future version of pandas all arguments of Series.clip
    except "
