...
class TestAstype:
    ...
    tm.rands(1000)]),
            Series([string.digits * 10, tm.rands(63), tm.rands(64), np.nan,
    1.0]),
        ],
    )
    ...
    def test_astype_dt64_to_str(self):
        ...
        expected = Series(["2012-01-01", "2012-01-02", "2012-01-03"],
    dtype=object)
        tm.assert_series_equal(result, expected)
    ...
    def test_astype_ea_to_datetimetzdtype(self, dtype):
        ...
        expected = Series(
            {
                0: Timestamp("1969-12-31 16:00:00.000000004-08:00",
    tz="US/Pacific"),
                1: Timestamp("1969-12-31 16:00:00.000000000-08:00",
    tz="US/Pacific"),
                2: Timestamp("1969-12-31 16:00:00.000000009-08:00",
    tz="US/Pacific"),
            }
        )
...
class TestAstypeCategorical:
    ...
    def test_astype_bool_missing_to_categorical(self):
        ...
        expected = Series(Categorical([True, False, np.nan], categories=[True,
    False]))
        tm.assert_series_equal(result, expected)
