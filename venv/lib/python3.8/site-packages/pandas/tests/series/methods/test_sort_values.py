...
class TestSeriesSortValues:
    def test_sort_values(self, datetime_series):
        ...
        msg = 'For argument "ascending" expected type bool, received type
    NoneType.'
    ...
    def test_sort_values_categorical(self):
        ...
        expected = Series(
            Categorical(["a", "a", "b", "b"], ordered=False), index=[0, 3, 1,
    2]
        )
    ...
    ordered=False
        ...
        s = ["a", "b", "c", "d"]
        df = DataFrame(
            {"unsort": raw_cat1, "sort": raw_cat2, "string": s, "values": [1,
    2, 3, 4]}
        )
        ...
        # GH#7848
        df = DataFrame(
            {"id": [6, 5, 4, 3, 2, 1], "raw_grade": ["a", "b", "b", "a", "a",
    "e"]}
        )
