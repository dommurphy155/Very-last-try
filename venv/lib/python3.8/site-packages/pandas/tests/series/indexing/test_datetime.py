...
def test_fancy_getitem():
    ...
    tm.assert_series_equal(
        s["3/6/2009":"2009-06-05"], s[datetime(2009, 3, 6): datetime(2009, 6,
    5)]
    )
...
def test_getitem_setitem_datetimeindex():
    ...
    msg = r"Invalid comparison between dtype=datetime64\[ns, US/Eastern\] and
    datetime"
...
def test_loc_getitem_over_size_cutoff(monkeypatch):
    ...
    df = DataFrame(np.random.randn(len(dates), 4), index=dates,
    columns=list("ABCD"))
...
def test_getitem_str_second_with_datetimeindex():
    ...
    df = DataFrame(
        ...
        index=date_range("2012-01-02 18:01:00", periods=5, tz="US/Central",
    freq="s"),
    )
