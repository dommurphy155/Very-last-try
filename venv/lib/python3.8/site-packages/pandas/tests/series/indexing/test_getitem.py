...
class TestSeriesGetitemScalars:
    ...
    def test_getitem_float_keys_tuple_values(self):
        ...
        # unique Index
        ser = Series([(1, 1), (2, 2), (3, 3)], index=[0.0, 0.1, 0.2],
    name="foo")
        result = ser[0.0]
        assert result == (1, 1)
        ...
        ser = Series([(1, 1), (2, 2), (3, 3)], index=[0.0, 0.0, 0.2],
    name="foo")
    ...
    def test_getitem_pydatetime_tz(self, tzstr):
        ...
        index = date_range(
            start="2012-12-24 16:00", end="2012-12-24 18:00", freq="H",
    tz=tzstr
        )
...
class TestSeriesGetitemListLike:
    ...
    def test_getitem_no_matches(self, box):
        ...
        msg = r"None of \[Index\(\['C'\], dtype='object'\)\] are in the
    \[index\]"
        with pytest.raises(KeyError, match=msg):
            ser[key]
    ...
    def test_getitem_intlist_intindex_periodvalues(self):
        ...
        result = ser[[2, 4]]
        exp = Series(
            [pd.Period("2000-01-03", freq="D"), pd.Period("2000-01-05",
    freq="D")],
            index=[2, 4],
            dtype="Period[D]",
        )
