...
class TestSeriesLogicalOps:
    @pytest.mark.parametrize("bool_op", [operator.and_, operator.or_,
    operator.xor])
    ...
    def test_scalar_na_logical_ops_corners_aligns(self):
        ...
        expected = DataFrame(False, index=range(9), columns=["A"] +
    list(range(9)))
    ...
    @pytest.mark.filterwarnings("ignore:passing object-dtype
    arraylike:FutureWarning")
    ...
    def test_logical_ops_df_compat(self):
        ...
        # True | np.nan => True
        exp_or1 = Series([True, True, True, False], index=list("ABCD"),
    name="x")
        tm.assert_series_equal(s1 | s2, exp_or1)
        # np.nan | True => np.nan, filled with False
        exp_or = Series([True, True, False, False], index=list("ABCD"),
    name="x")
        ...
        exp = DataFrame({"x": [True, True, np.nan, np.nan]},
    index=list("ABCD"))
        tm.assert_frame_equal(s1.to_frame() | s2.to_frame(),
    exp_or1.to_frame())
    ...
    name="x")
        ...
        tm.assert_frame_equal(s3.to_frame() | s4.to_frame(),
    exp_or1.to_frame())
