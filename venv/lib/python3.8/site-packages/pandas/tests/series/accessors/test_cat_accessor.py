...
class TestCatAccessor:
    ...
    rename_categories"):
        ...
        ser = Series(Categorical(["a", "b", "b", "a"], categories=["a", "b",
    "c"]))
        ...
        expected = Series(
            Categorical(["A", "B", "C", "A"], categories=["A", "B", "C"],
    ordered=True)
        )
    ...
    def test_set_categories_setitem(self):
        ...
        df = DataFrame({"Survived": [1, 0, 1], "Sex": [0, 1, 1]},
    dtype="category")
    ...
    rename_categories"):
        ...
        df["Sex"] = Categorical(df["Sex"], categories=["female", "male"],
    ordered=False)
