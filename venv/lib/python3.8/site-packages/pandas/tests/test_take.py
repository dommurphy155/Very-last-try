...
class TestTake:
    ...
    def test_2d_datetime64(self):
        ...
        arr = np.random.randint(11_045_376, 11_360_736, (5, 3)) *
    100_000_000_000
        ...
        result = algos.take_nd(arr, indexer, axis=0, fill_value=datetime(2007,
    1, 1))
        expected = arr.take(indexer, axis=0)
        ...
        result = algos.take_nd(arr, indexer, axis=1, fill_value=datetime(2007,
    1, 1))
        expected = arr.take(indexer, axis=1)
        expected[:, [2, 4]] = datetime(2007, 1, 1)
        tm.assert_almost_equal(result, expected)
