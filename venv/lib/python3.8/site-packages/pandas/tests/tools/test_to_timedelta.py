...
class TestTimedeltas:
    ...
    def test_to_timedelta_invalid_errors_ignore(self):
        ...
        tm.assert_index_equal(invalid_data, to_timedelta(invalid_data,
    errors="ignore"))
    ...
    def test_unambiguous_timedelta_values(self, val, warning):
        # GH36666 Deprecate use of strings denoting units with 'M', 'Y', 'm'
    or 'y'
        # in pd.to_timedelta
    ...
    def test_to_timedelta_nullable_int64_dtype(self, expected_val, result_val):
        ...
        result = to_timedelta(Series([1, result_val], dtype="Int64"),
    unit="days")
