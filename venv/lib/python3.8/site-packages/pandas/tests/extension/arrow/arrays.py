...
from pandas.core.arrays.arrow import ArrowExtensionArray as
    _ArrowExtensionArray
...
class ArrowExtensionArray(_ArrowExtensionArray):
    ...
    def _logical_method(self, other, op):
        ...
        return ArrowBoolArray(
            pa.chunked_array([pa.array(result,
    mask=pd.isna(self._data.to_pandas()))])
        )
    ...
    def _concat_same_type(cls, to_concat):
        chunks = list(itertools.chain.from_iterable(x._data.chunks for x in
    to_concat))
