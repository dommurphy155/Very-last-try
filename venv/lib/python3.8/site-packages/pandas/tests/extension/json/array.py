...
class JSONArray(ExtensionArray):
    ...
    "
            ...
            if is_bool_dtype(item.dtype):
                return self._from_sequence([x for x, m in zip(self, item) if
    m])
            # integer
    ...
    def take(self, indexer, allow_fill=False, fill_value=None):
        ...
        if allow_fill:
            ...
            try:
                output = [
                    self.data[loc] if loc != -1 else fill_value for loc in
    indexer
                ]
    ...
    def astype(self, dtype, copy=True):
        ...
        if isinstance(dtype, type(self.dtype)) and dtype == self.dtype:
            ...
            return dtype.construct_array_type()._from_sequence(value,
    copy=False)
    ...
    def unique(self):
        ...
        # a 2-dim object.
        return type(self)([dict(x) for x in {tuple(d.items()) for d in
    self.data}])
