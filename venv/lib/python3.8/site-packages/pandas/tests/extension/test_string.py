...
class TestMethods(base.BaseMethodsTests):
    ...
    def test_argsort_missing(self, data_missing_for_sorting):
        with tm.maybe_produces_warning(
            PerformanceWarning,
            pa_version_under7p0
            and getattr(data_missing_for_sorting.dtype, "storage", "") ==
    "pyarrow",
            check_stacklevel=False,
        ):
    ...
    def test_argmin_argmax(
        ...
        if pa_version_under6p0 and data_missing_for_sorting.dtype.storage ==
    "pyarrow":
    ...
    def test_value_counts(self, all_data, dropna, request):
        ...
        with tm.maybe_produces_warning(
            ...
            result =
    pd.Series(all_data).value_counts(dropna=dropna).sort_index()
        with tm.maybe_produces_warning(
            PerformanceWarning,
            pa_version_under7p0
    ...
    "pyarrow",
            ...
            super().test_nargsort(data_missing_for_sorting, na_position,
    expected)
...
class TestComparisonOps(base.BaseComparisonOpsTests):
    def _compare_other(self, ser, data, op, other):
        ...
        expected = getattr(ser.astype(object),
...
class TestGroupBy(base.BaseGroupbyTests):
    ...
    def test_groupby_extension_agg(self, as_index, data_for_grouping):
        df = pd.DataFrame({"A": [1, 1, 2, 2, 3, 3, 1, 4], "B":
    data_for_grouping})
        with tm.maybe_produces_warning(
            PerformanceWarning,
            pa_version_under7p0
