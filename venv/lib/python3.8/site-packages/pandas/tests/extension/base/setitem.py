...
class BaseSetitemTests(BaseExtensionTests):
    ...
    def full_indexer(self, request):
        """
        Fixture for an indexer to pass to obj.loc to get/set the full length
    of the
        object.
    ...
    box_in_series):
        ...
        # TODO(xfail) this raises KeyError about labels not found (it tries
    label-based)
        # for list of labels with Series
        if box_in_series:
            arr = pd.Series(data, index=[tm.rands(4) for _ in
    range(len(data))])
    ...
    def test_setitem_frame_2d_values(self, data):
        ...
        has_can_hold_element = isinstance(
            data.dtype, (PandasDtype, PeriodDtype, IntervalDtype,
    DatetimeTZDtype)
        )
    ...
    https://github.com/pandas-dev/pandas/pull/44514#discussion_r754002410
        using_array_manager = isinstance(df._mgr,
    pd.core.internals.ArrayManager)
