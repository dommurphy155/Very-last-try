...
class Dim2CompatTests(BaseExtensionTests):
    # Note: these are ONLY for ExtensionArray subclasses that support 2D
    arrays.
    ...
    def test_transpose(self, data):
        ...
        shape = arr2d.shape
        assert shape[0] != shape[-1]  # otherwise the rest of the test is
    useless
    ...
    @pytest.mark.parametrize("method", ["mean", "median", "var", "std", "sum",
    "prod"])
