...
class TestJoinInt64Index:
    ...
    def test_join_inner(self):
        ...
        # monotonic
        res, lidx, ridx = index.join(other_mono, how="inner",
    ...
    def test_join_left(self):
        ...
        # monotonic
        res, lidx, ridx = index.join(other_mono, how="left",
    return_indexers=True)
    ...
    dtype=np.intp)
        ...
        # monotonic
        res, lidx, ridx = index.join(other_mono, how="outer",
    return_indexers=True)
...
class TestJoinUInt64Index:
    ...
    def test_join_inner(self, index_large):
        other = UInt64Index(2**63 + np.array([7, 12, 25, 1, 2, 10],
    dtype="uint64"))
        ...
        # not monotonic
        res, lidx, ridx = index_large.join(other, how="inner",
    return_indexers=True)
    ...
    dtype="uint64"))
        ...
        # not monotonic
        res, lidx, ridx = index_large.join(other, how="left",
    return_indexers=True)
        eres = index_large
    ...
    return_indexers=True)
        ...
        eres = UInt64Index(2**63 + np.array([1, 1, 2, 5, 7, 9],
    dtype="uint64"))
        eridx = np.array([0, 1, 2, 3, -1, -1], dtype=np.intp)
        elidx = np.array([0, 0, 1, 2, 3, 4], dtype=np.intp)
    ...
    dtype="uint64"))
        ...
        # not monotonic
        res, lidx, ridx = index_large.join(other, how="right",
    return_indexers=True)
        eres = other
    ...
    dtype="uint64"))
        ...
        # not monotonic
        # guarantee of sortedness
        res, lidx, ridx = index_large.join(other, how="outer",
    return_indexers=True)
