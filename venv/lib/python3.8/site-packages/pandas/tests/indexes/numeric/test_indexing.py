...
class TestGetLoc:
    ...
    @pytest.mark.parametrize("vals", [[1], [1.0], [Timestamp("2019-12-31")],
    ["test"]])
...
class TestGetIndexer:
    ...
    @pytest.mark.parametrize("method", ["get_indexer",
...
class TestWhere:
    ...
    def
    test_where_infers_type_instead_of_trying_to_convert_string_to_float(self):
        # GH 32413
...
class TestGetSliceBounds:
    ...
    def test_get_slice_bounds_within(self, kind, side, expected):
        index = Index(range(6))
        with tm.assert_produces_warning(FutureWarning, match="'kind'
    argument"):
