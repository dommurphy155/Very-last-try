...
class TestDatetimeIndex:
    ...
    def test_astype_str_tz_and_name(self):
        ...
        dti = date_range("2012-01-01", periods=3, name="test_name",
    tz="US/Eastern")
        result = dti.astype(str)
        expected = Index(
            [
    ...
    def test_astype_str_freq_and_name(self):
        ...
        result = dti.astype(str)
        expected = Index(
            ["2011-01-01 00:00:00", "2011-01-01 01:00:00", "2011-01-01
    02:00:00"],
            name="test_name",
            dtype=object,
        )
    ...
    def test_astype_str_freq_and_tz(self):
        ...
        dti = date_range(
            "3/6/2012 00:00", periods=2, freq="H", tz="Europe/London",
    name="test_name"
        )
        result = dti.astype(str)
        expected = Index(
    ...
    def test_astype_object_with_nat(self):
        idx = DatetimeIndex(
            [datetime(2013, 1, 1), datetime(2013, 1, 2), NaT, datetime(2013,
    1, 4)],
            name="idx",
        )
        expected_list = [
