...
class TestDatetimeIndexShift:
    ...
    "2013-01-06"],
        ...
        result = drange.shift(-1)
        expected = DatetimeIndex(
            ["2012-12-31", "2013-01-01", "2013-01-02", "2013-01-03",
    "2013-01-04"],
            freq="D",
        )
        tm.assert_index_equal(result, expected)
    ...
    def test_dti_shift_no_freq(self):
        ...
        with pytest.raises(NullFrequencyError, match="Cannot shift with no
    freq"):
            dti.shift(2)
    ...
    def test_dti_shift_across_dst(self):
        # GH 8616
        idx = date_range("2013-11-03", tz="America/Chicago", periods=7,
    freq="H")
