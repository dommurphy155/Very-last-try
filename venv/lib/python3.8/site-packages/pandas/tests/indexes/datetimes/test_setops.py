...
class TestDatetimeIndexSetOps:
    ...
    def test_intersection(self, tz, sort):
        ...
        # non-monotonic
        base = DatetimeIndex(
            ["2011-01-05", "2011-01-04", "2011-01-02", "2011-01-03"], tz=tz,
    name="idx"
        )

        rng2 = DatetimeIndex(
            ["2011-01-04", "2011-01-02", "2011-02-02", "2011-02-03"], tz=tz,
    name="idx"
        )
        expected2 = DatetimeIndex(["2011-01-04", "2011-01-02"], tz=tz,
    name="idx")
        ...
        expected3 = DatetimeIndex(["2011-01-04", "2011-01-02"], tz=tz,
    name=None)
    ...
    def test_intersection_empty(self, tz_aware_fixture, freq):
        ...
        # no overlap GH#33604
        check_freq = freq != "T"  # We don't preserve freq on non-anchored
    offsets
