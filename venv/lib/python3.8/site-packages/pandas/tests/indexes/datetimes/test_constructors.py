...
class TestDatetimeIndex:
    ...
    @pytest.mark.parametrize(
        "kwargs",
        [{"tz": "dtype.tz"}, {"dtype": "dtype"}, {"dtype": "dtype", "tz":
    "dtype.tz"}],
    )
    ...
    def test_construction_with_alt_tz_localize(self, kwargs, tz_aware_fixture):
        ...
        with pytest.raises(ValueError, match=msg):
            DatetimeIndex(i.tz_localize(None).asi8, dtype=i.dtype,
    tz="US/Pacific")

    def test_construction_index_with_mixed_timezones(self):
        # gh-11488: no tz results in DatetimeIndex
        result = Index([Timestamp("2011-01-01"), Timestamp("2011-01-02")],
    name="idx")
        exp = DatetimeIndex(
    ...
    def test_construction_index_with_mixed_timezones_with_NaT(self):
        ...
        exp = DatetimeIndex(
            [Timestamp("2011-01-01 10:00"), pd.NaT, Timestamp("2011-08-01
    10:00")],
            tz="US/Eastern",
            name="idx",
        )
    ...
    def test_construction_with_ndarray(self):
        # GH 5152
        dates = [datetime(2013, 10, 7), datetime(2013, 10, 8), datetime(2013,
    10, 9)]
    ...
    def test_constructor_datetime64_tzformat(self, freq):
        ...
        expected_i8 = date_range(
            "2013-01-01T00:00:00", "2016-01-01T23:59:59", freq=freq,
    tz="America/Lima"
        )
    ...
    tz="America/Lima"
        ...
        idx = date_range("2013/1/1 0:00:00+9:00", "2016/1/1 23:59:59+09:00",
    freq=freq)
        expected = date_range(
            "2013-01-01T00:00:00",
            "2016-01-01T23:59:59",
    ...
    def test_constructor_dtype(self):
        ...
        expected = DatetimeIndex(["2013-01-01",
    "2013-01-02"]).tz_localize("US/Eastern")
        tm.assert_index_equal(idx, expected)
    ...
    @pytest.mark.parametrize("box", [np.array, partial(np.array,
    dtype=object), list])
    @pytest.mark.parametrize(
        "tz, dtype",
        [("US/Pacific", "datetime64[ns, US/Pacific]"), (None,
    "datetime64[ns]")],
    )
    ...
    def
    test_index_constructor_with_numpy_object_array_and_timestamp_tz_with_nan(self):
        # GH 27011
        result = Index(np.array([Timestamp("2019", tz="UTC"), np.nan],
    dtype=object))
...
class TestTimeSeries:
    ...
    def test_index_cast_datetime64_other_units(self):
        ...
        assert (idx.values == astype_overflowsafe(arr,
    dtype=np.dtype("M8[ns]"))).all()
    ...
    dtype="O")
        ...
        arr = to_datetime(["1/1/2005", "1/2/2005", "Jan 3, 2005",
    "2005-01-04"])
...
def test_timestamp_constructor_retain_fold(tz, fold):
    ...
    ts = Timestamp(year=2019, month=10, day=27, hour=1, minute=30, tz=tz,
    fold=fold)
    result = ts.fold
    expected = fold
    assert result == expected
...
def test_timestamp_constructor_adjust_value_for_fold(tz, ts_input, fold,
    value_out):
    # Test for #25057
