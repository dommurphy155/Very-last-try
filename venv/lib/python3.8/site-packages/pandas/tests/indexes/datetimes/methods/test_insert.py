...
class TestInsert:
    @pytest.mark.parametrize("null", [None, np.nan, np.datetime64("NaT"), NaT,
    NA])
    ...
    @pytest.mark.parametrize(
        "item", [0, np.int64(0), np.float64(0), np.array(0),
    np.timedelta64(456)]
    )
    def test_insert_mismatched_types_raises(self, tz_aware_fixture, item):
        ...
        if isinstance(item, np.ndarray):
            ...
            expected = Index([dti[0], item] + list(dti[1:]), dtype=object,
    name=9)
