...
class TestDatetimeIndexRendering:
    ...
    tz="US/Eastern"
        ...
        idxs.append(
            DatetimeIndex(["2011-01-01 09:00", "2011-01-01 10:00", pd.NaT],
    tz="UTC")
        )
    ...
    def test_dti_representation_to_series(self):
        ...
        idx4 = DatetimeIndex(["2011-01-01", "2011-01-02", "2011-01-03"],
    freq="D")
        idx5 = DatetimeIndex(
            ["2011-01-01 09:00", "2011-01-01 10:00", "2011-01-01 11:00"],
            freq="H",
    ...
    freq="D")
        ...
        for idx, expected in zip(
            [idx1, idx2, idx3, idx4, idx5, idx6], [exp1, exp2, exp3, exp4,
    exp5, exp6]
        ):
            result = idx._summary()
            assert result == expected
...
class TestFormat:
    def test_format_with_name_time_info(self):
        ...
        dates = pd.date_range("2011-01-01 04:00:00", periods=10,
    name="something")
