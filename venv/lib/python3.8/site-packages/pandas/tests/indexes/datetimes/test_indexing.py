...
class TestWhere:
    def test_where_doesnt_retain_freq(self):
        ...
        expected = DatetimeIndex([dti[0], dti[1], dti[0]], freq=None,
    name="idx")
...
class TestTake:
    def test_take_nan_first_datetime(self):
        index = DatetimeIndex([pd.NaT, Timestamp("20130101"),
    Timestamp("20130102")])
    ...
    def test_take_fill_value(self):
        # GH#12631
        idx = DatetimeIndex(["2011-01-01", "2011-02-01", "2011-03-01"],
    name="xxx")
    ...
    name="xxx")
        ...
        expected = DatetimeIndex(["2011-02-01", "2011-01-01", "NaT"],
    name="xxx")
        tm.assert_index_equal(result, expected)
...
class TestGetLoc:
    ...
    def test_get_loc_method_exact_match(self, method):
        ...
        if method is not None:
            assert idx.get_loc(idx[1], method, tolerance=pd.Timedelta("0
    days")) == 1
    ...
    def test_get_loc(self):
        ...
        assert idx.get_loc("2000-01-01T12", method="nearest", tolerance="1
    day") == 1
        assert (
            idx.get_loc("2000-01-01T12", method="nearest",
    tolerance=pd.Timedelta("1D"))
            == 1
        )
        assert (
            idx.get_loc(
                "2000-01-01T12", method="nearest", tolerance=np.timedelta64(1,
    "D")
            )
            == 1
        )
...
class TestGetIndexer:
    ...
    def test_get_indexer(self):
        ...
        target = idx[0] + pd.to_timedelta(["-1 hour", "12 hours", "1 day 1
    hour"])
    ...
    dtype=np.intp)
        ...
        tm.assert_numpy_array_equal(
            idx.get_indexer(target, "nearest", tolerance=pd.Timedelta("1
    hour")),
    ...
    def test_get_indexer_mixed_dtypes(self, target):
        ...
        values = DatetimeIndex([Timestamp("2020-01-01"),
    ...
    @pytest.mark.filterwarnings("ignore:Comparison of
    Timestamp.*:FutureWarning")
