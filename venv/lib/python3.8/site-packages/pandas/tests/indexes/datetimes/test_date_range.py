...
class TestDateRanges:
    ...
    def test_date_range_negative_freq(self):
        ...
        exp = DatetimeIndex(["2011-12-31", "2009-12-31", "2007-12-31"],
    freq="-2A")
        tm.assert_index_equal(rng, exp)
        assert rng.freq == "-2A"

        rng = date_range("2011-01-31", freq="-2M", periods=3)
        exp = DatetimeIndex(["2011-01-31", "2010-11-30", "2010-09-30"],
    freq="-2M")
        tm.assert_index_equal(rng, exp)
        assert rng.freq == "-2M"
    ...
    def test_date_range_convenience_periods(self):
        ...
        expected = DatetimeIndex(
            ["2018-04-24 00:00:00", "2018-04-25 12:00:00", "2018-04-27
    00:00:00"],
            freq=None,
        )
    ...
    def test_date_range_businesshour(self):
        ...
        idx = DatetimeIndex(["2014-07-04 16:00", "2014-07-07 09:00"],
    freq="BH")
    ...
    def test_compat_replace(self):
        ...
        result = date_range(Timestamp("1960-04-01 00:00:00"), periods=76,
    freq="QS-JAN")
    ...
    def test_construct_over_dst(self):
        ...
        result = date_range(start="2010-11-7", periods=3, freq="H",
    tz="US/Pacific")
        tm.assert_index_equal(result, expected)
    ...
    tz_aware_fixture):
        # GH 23270
        tz = tz_aware_fixture
        result = date_range(start="2011-06-01", end="2011-01-01", freq="-1MS",
    tz=tz)
        expected = date_range(end="2011-06-01", start="2011-01-01",
    freq="1MS", tz=tz)[::-1
        ]
        tm.assert_index_equal(result, expected)
...
class TestGenRangeGeneration:
    ...
    def test_2(self):
        ...
        expected = [datetime(2008, 1, 1), datetime(2008, 1, 2), datetime(2008,
    1, 3)]
        assert rng == expected
...
class TestCustomDateRange:
    ...
    def test_cdaterange_weekmask(self):
        ...
        with pytest.raises(ValueError, match=msg):
            bdate_range("2013-05-01", periods=3, weekmask="Sun Mon Tue Wed
    Thu")
    ...
    def test_all_custom_freq(self, freq):
        # should not raise
        bdate_range(
            START, END, freq=freq, weekmask="Mon Wed Fri",
    holidays=["2009-03-14"]
        )
    ...
    def test_range_with_timezone_and_custombusinessday(self, start, period,
    expected):
        # GH49441
