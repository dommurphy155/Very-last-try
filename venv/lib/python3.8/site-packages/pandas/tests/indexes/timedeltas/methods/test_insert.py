...
class TestTimedeltaIndexInsert:
    def test_insert(self):
        ...
        expected = Index(
            [Timedelta("4day"), "inserted", Timedelta("1day"),
    Timedelta("2day")],
            name="idx",
        )
        ...
        expected_3 = TimedeltaIndex(
            ["1day 00:00:01", "1day 00:00:02", "1day 00:00:03", "1day
    00:00:04"],
            name="idx",
            freq="s",
        )
        ...
        expected_1_nofreq = TimedeltaIndex(
            ["1day 00:00:01", "1day 00:00:01", "1day 00:00:02", "1day
    00:00:03"],
            name="idx",
            freq=None,
        )
