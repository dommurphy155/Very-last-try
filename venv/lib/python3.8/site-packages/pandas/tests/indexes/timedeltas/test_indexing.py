...
class TestGetItem:
    ...
    name="idx")
            ...
            expected = TimedeltaIndex(
                ["5 day", "4 day", "3 day", "2 day", "1 day"], freq="-1D",
    name="idx"
            )
            tm.assert_index_equal(result, expected)
            assert result.freq == expected.freq
...
class TestGetLoc:
    ...
    def test_get_loc(self):
        ...
        assert idx.get_loc(idx[1], "pad", tolerance=np.timedelta64(0, "s")) ==
    1
        assert idx.get_loc(idx[1], "pad", tolerance=timedelta(0)) == 1
...
class TestWhere:
    def test_where_doesnt_retain_freq(self):
        ...
        expected = TimedeltaIndex([tdi[0], tdi[1], tdi[0]], freq=None,
    name="idx")
    ...
    def test_where_invalid_dtypes(self, fixed_now_ts):
        ...
        expected = Index([NaT.value, NaT.value] + tail, dtype=object,
    name="idx")
