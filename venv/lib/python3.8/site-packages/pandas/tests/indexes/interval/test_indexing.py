...
class TestGetLoc:
    ...
    def test_get_loc_interval(self, closed, side):
        ...
        for bound in [[0, 1], [1, 2], [2, 3], [3, 4], [0, 2], [2.5, 3], [-1,
    4]]:
            # if get_loc is supplied an interval, it should only search
            # for exact matches, not overlaps or covers, else KeyError.
            msg = re.escape(f"Interval({bound[0]}, {bound[1]},
    closed='{side}')")
            if closed == side:
                if bound == [0, 1]:
    ...
    @pytest.mark.parametrize("other_closed", ["left", "right", "both",
    "neither"])
    ...
    other_closed):
        ...
        if interval == index[0]:
            ...
            with pytest.raises(
                KeyError,
                match=re.escape(f"Interval({left}, {right},
    closed='{other_closed}')"),
            ):
    ...
    @pytest.mark.parametrize(
        "arrays",
        [
            (date_range("20180101", periods=4), date_range("20180103",
    periods=4)),
            (
                date_range("20180101", periods=4, tz="US/Eastern"),
    ...
    def test_get_loc_non_scalar_errors(self, key):
        # GH 31117
        idx = IntervalIndex.from_tuples([(1, 3), (2, 4), (3, 5), (7, 10), (3,
    10)])
    ...
    def test_get_indexer_with_nans(self):
        ...
        for key in [NaT, np.timedelta64("NaT", "ns"), np.datetime64("NaT",
    "ns")]:
...
class TestGetIndexer:
    ...
    def test_get_indexer_interval_index(self, box):
        ...
        idx = box(interval_range(Timestamp("2022-07-01"), freq="3D",
    periods=3))
