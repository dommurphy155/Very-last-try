...
class TestCategoricalIndex(Base):
    ...
    def simple_index(self) -> CategoricalIndex:
        return self._index_cls(list("aabbca"), categories=list("cab"),
    ordered=False)
    ...
    def create_index(self, *, categories=None, ordered=False):
        if categories is None:
            categories = list("cab")
        return CategoricalIndex(list("aabbca"), categories=categories,
    ordered=ordered)
    ...
    def test_pickle_compat_construction(self):
        ...
        with tm.assert_produces_warning(FutureWarning, match="without passing
    data"):
            self._index_cls()
    ...
    def test_frame_repr(self):
        df = pd.DataFrame({"A": [1, 2, 3]}, index=CategoricalIndex(["a", "b",
    "c"]))
        result = repr(df)
        expected = "   A\na  1\nb  2\nc  3"
...
class TestCategoricalIndex2:
    ...
    def test_disallow_addsub_ops(self, func, op_name):
        ...
        msg = "|".join(
            [
                f"cannot perform {op_name} with this index type:
    CategoricalIndex",
    ...
    categories=list("ab")),
        ...
        tm.assert_index_equal(
            result,
            CategoricalIndex(list("aabbca"), categories=list("cabdef"),
    ordered=True),
        )
