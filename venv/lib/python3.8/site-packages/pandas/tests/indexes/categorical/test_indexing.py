...
class TestTake:
    def test_take_fill_value(self):
        ...
        expected = CategoricalIndex([2, 1, np.nan], categories=[1, 2, 3],
    name="xxx")
        tm.assert_index_equal(result, expected)
        tm.assert_categorical_equal(result.values, expected.values)
...
class TestGetIndexer:
    ...
    def test_get_indexer_array(self):
        arr = np.array(
            [Timestamp("1999-12-31 00:00:00"), Timestamp("2000-12-31
    00:00:00")],
            dtype=object,
        )
        cats = [Timestamp("1999-12-31 00:00:00"), Timestamp("2000-12-31
    00:00:00")]
        ci = CategoricalIndex(cats, categories=cats, ordered=False,
    dtype="category")
    ...
    def test_get_indexer_same_categories_same_order(self):
        ...
        result = ci.get_indexer(CategoricalIndex(["b", "b"], categories=["a",
    "b"]))
    ...
    def test_get_indexer_same_categories_different_order(self):
        ...
        result = ci.get_indexer(CategoricalIndex(["b", "b"], categories=["b",
    "a"]))
        expected = np.array([1, 1], dtype="intp")
        tm.assert_numpy_array_equal(result, expected)
...
class TestWhere:
    def test_where(self, listlike_box):
        ...
        i = CategoricalIndex(list("aabbca"), categories=list("cab"),
    ordered=False)
        cond = [True] * len(i)
        expected = i
