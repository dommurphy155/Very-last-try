...
class TestTimestampProperties:
    def test_freq_deprecation(self):
        ...
        for per in ["month", "quarter", "year"]:
            for side in ["start", "end"]:
                ...
                # is_(month|quarter|year)_(start|end) does _not_ issue a
    warning
    ...
    @pytest.mark.parametrize("end", ["is_month_end", "is_year_end",
    "is_quarter_end"])
    @pytest.mark.parametrize("tz", [None, "US/Eastern"])
    ...
    @pytest.mark.parametrize(
        "data",
        [Timestamp("2017-08-28 23:00:00"), Timestamp("2017-08-28 23:00:00",
    tz="EST")],
    )
    ...
    def test_woy_boundary(self):
        ...
        result = np.array(
            [
                ...
                for args in [(2000, 1, 1), (2000, 1, 2), (2005, 1, 1), (2005,
    1, 2)]
            ]
        )
...
class TestTimestamp:
    ...
    def test_asm8(self):
        ...
        for n in ns:
            assert (
                Timestamp(n).asm8.view("i8") == np.datetime64(n,
    "ns").view("i8") == n
            )

        assert Timestamp("nat").asm8.view("i8") == np.datetime64("nat",
    "ns").view("i8")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [(946688461000000000 + 500000) / 1000000, {"unit": "ms", "us":
    500}],
            [(946688461000000000 + 500000) / 1000, {"unit": "us", "us": 500}],
            [(946688461000000000 + 500000000) / 1000000, {"unit": "ms", "us":
    500000}],
            ...
            [946688461000000000 / 1000000.0 + 0.005, {"unit": "ms", "us": 5,
    "ns": 5}],
            [946688461000000000 / 1000000000.0 + 0.5, {"unit": "s", "us":
    500000}],
...
class TestTimestampConversion:
    ...
    def test_to_pydatetime_fold(self):
        ...
        ts = Timestamp(year=2013, month=11, day=3, hour=1, minute=0, fold=1,
    tz=tzstr)
        dt = ts.to_pydatetime()
        assert dt.fold == 1
    ...
    def test_to_datetime_bijective(self):
        ...
        assert Timestamp(pydt_min + tdus).value / 1000 == Timestamp.min.value
    / 1000
...
class TestNonNano:
    ...
    def test_sub_timedeltalike_mismatched_reso(self, ts_tz):
        ...
        msg = "Addition between Timestamp and Timedelta with mismatched
    resolutions"
        with pytest.raises(ValueError, match=msg):
...
class TestAsUnit:
    ...
    NpyDatetimeUnit.NPY_FR_us.value, None)
    ...
    def test_as_unit_non_nano(self):
        ...
        assert ts.month == 1
        assert ts.day == 2
        assert ts.hour == ts.minute == ts.second == ts.microsecond ==
    ts.nanosecond == 0
