...
class TestTimestampConstructors:
    ...
    def test_constructor(self):
        ...
        assert calendar.timegm(base_dt.timetuple()) * 1_000_000_000 ==
    base_expected
    ...
    base_expected
        ...
        tests = [
            ...
            ("2014-07-01 12:00:00+02:00", base_expected + 3600 *
    1_000_000_000),
        ...
        expected = "Timestamp('2013-11-01 00:00:00-0500',
    tz='America/Chicago')"
    ...
    @pytest.mark.parametrize("kwd", ["nanosecond", "microsecond", "second",
    "minute"])
    ...
    def test_constructor_keyword(self):
        # GH 10758
        msg = "function missing required argument 'day'|Required argument
    'day'"
        with pytest.raises(TypeError, match=msg):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # error: Argument 9 to "Timestamp" has incompatible type
    "_UTCclass";
            # expected "Optional[int]"
            Timestamp(2000, 1, 2, 3, 4, 5, 6, 1, pytz.UTC),  # type:
    ignore[arg-type]
        ],
    )
    ...
    def test_construct_timestamp_near_dst(self, offset):
        # GH 20854
        expected = Timestamp(f"2016-10-30 03:00:00{offset}",
    tz="Europe/Helsinki")
    ...
    def test_construct_timestamp_preserve_original_frequency(self):
        # GH 22311
        with tm.assert_produces_warning(FutureWarning, match="The 'freq'
    argument"):
...
@pytest.mark.parametrize("kwargs", [{}, {"year": 2020}, {"year": 2020,
    "month": 1}])
def test_constructor_missing_keyword(kwargs):
    # GH 31200

    # The exact error message of datetime() depends on its version
    msg1 = r"function missing required argument '(year|month|day)' \(pos
    [123]\)"
