...
class TestTimedeltaAdditionSubtraction:
    ...
    def test_td_add_sub_int_ndarray(self):
        ...
        msg = "|".join(
            [
                ...
                # This message goes on to say "Please do not rely on this
    error;
    ...
    def test_td_sub_timedeltalike_object_dtype_array(self):
        # GH#21980
        arr = np.array([Timestamp("20130101 9:01"), Timestamp("20121230
    9:02")])
        exp = np.array([Timestamp("20121231 9:01"), Timestamp("20121229
    9:02")])
    ...
    def test_td_rsub_mixed_most_timedeltalike_object_dtype_array(self):
        ...
        now = Timestamp("2021-11-09 09:54:00")
        arr = np.array([now, Timedelta("1D"), np.timedelta64(2, "h")])
        msg = r"unsupported operand type\(s\) for \-: 'Timedelta' and
    'Timestamp'"
        with pytest.raises(TypeError, match=msg):
            Timedelta("1D") - arr
    ...
    def test_td_add_timedeltalike_object_dtype_array(self, op):
        ...
        arr = np.array([Timestamp("20130101 9:01"), Timestamp("20121230
    9:02")])
        exp = np.array([Timestamp("20130102 9:01"), Timestamp("20121231
    9:02")])
...
class TestTimedeltaMultiplicationDivision:
    ...
    def test_td_mul_nat(self, op, td_nat):
        ...
        msg = "|".join(
            [
                rf"unsupported operand type\(s\) for \*: '{typs}' and
    '{typs}'",
    ...
    def test_td_rdiv_na_scalar(self):
        ...
        msg = r"unsupported operand type\(s\) for /: 'numpy.datetime64' and
    'Timedelta'"
        with pytest.raises(TypeError, match=msg):
    ...
    def test_td_rfloordiv_invalid_scalar(self):
        ...
        msg = (
            r"unsupported operand type\(s\) for //: 'numpy.datetime64' and
    'Timedelta'"
        )
        with pytest.raises(TypeError, match=msg):
            dt64 // td
