...
@pytest.mark.parametrize(
    ...
    None),
        ...
        ("mean", [0, 1, 2, np.nan, 4], [np.nan, 0.5, 1.5, np.nan, np.nan],
    False, None),
        ...
        ("var", [0, 1, 2, np.nan, 4], [np.nan, 0.5, 0.5, np.nan, np.nan],
    False, None),
...
def test_series_dtypes(
    ...
    if dtypes in ("m8[ns]", "M8[ns]", "datetime64[ns, UTC]") and method !=
    "count":
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "sum",
            {0: Series([np.nan, 2, 6, 10, 14]), 1: Series([np.nan, 4, 8, 12,
    16])},
            None,
        ),
        (
