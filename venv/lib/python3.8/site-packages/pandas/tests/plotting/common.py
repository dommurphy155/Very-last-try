...
class TestPlotBase:
    ...
    def _check_visible(self, collections, visible=True):
        ...
        if not isinstance(collections, Collection) and not
    is_list_like(collections):
...
def _check_plot_works(f, filterwarnings="always", default_axes=False,
    **kwargs):
    """
    ...
    default_axes: bool, optional
        If False (default):
            ...
            - Mind special corner case for bootstrap_plot (see
    `_gen_two_subplots`)
        If True:
