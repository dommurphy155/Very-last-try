...
class TestMultiIndexSlicers:
    def test_per_axis_per_level_getitem(self):
        ...
        expected = df.loc[
            [
                ...
                if (a == "A1" or a == "A2" or a == "A3") and (c == "C1" or c
    == "C3")
            ]
        ]
        ...
        df = DataFrame(
            np.arange(16, dtype="int64").reshape(4, 4), index=index,
    columns=columns
        )
    ...
    def test_multiindex_slicers_non_unique(self):
        ...
        expected = (
            DataFrame({"A": ["foo", "foo"], "B": ["a", "a"], "C": [1, 1], "D":
    [1, 3]})
            .set_index(["A", "B", "C"])
            .sort_index()
        )
    ...
    datetime.timedelta(days=i)
        ...
        freq = [1, 2]
        index = MultiIndex.from_product([dates, freq], names=["date",
    "frequency"])
        ...
        result = df.loc[
            (
                slice(
                    Timestamp("2012-01-01 12:12:12"), Timestamp("2012-01-03
    12:12:12")
                ),
                slice(1, 1),
            ),
    ...
    12:12:12")
        ...
        result = df.loc[
            (idx["2012-01-01 12:12:12":"2012-01-03 12:12:12"], 1), idx["A",
    "B"]
        ]
        tm.assert_frame_equal(result, expected)
    ...
    def test_loc_axis_single_level_multi_col_indexing_multiindex_col_df(self):
        ...
        df = DataFrame(
            ...
            columns=MultiIndex.from_product([["a1", "a2", "a3"], ["b1", "b2",
    "b3"]]),
        )
    ...
    def test_multiindex_label_slicing_with_negative_step(self):
        ser = Series(
            np.arange(20), MultiIndex.from_product([list("abcde"),
    np.arange(4)])
        )
        SLC = pd.IndexSlice
    ...
    def test_multiindex_slice_first_level(self):
        ...
        expected = DataFrame(list(range(30, 71)), columns=["Test"],
    index=range(30, 71))
        tm.assert_frame_equal(result, expected)
