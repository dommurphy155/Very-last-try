...
class TestEmptyFrameSetitemExpansion:
    ...
    def test_loc_setitem_zerolen_series_columns_align(self):
        ...
        exp = DataFrame([[np.nan, 1]], columns=["A", "B"], index=[0],
    dtype="float64")
    ...
    def test_partial_set_empty_frame_no_index(self):
        # no index to start
        expected = DataFrame({0: Series(1, index=range(4))}, columns=["A",
    "B", 0])
    ...
    def test_partial_set_empty_frame_row(self):
        ...
        expected = DataFrame(columns=["A", "B", "New"], index=Index([],
    dtype="int64"))
...
class TestPartialSetting:
    ...
    def test_setitem_with_expansion_numeric_into_datetimeindex(self, key):
        ...
        ex_index = Index(list(orig.index) + [key], dtype=object,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                ["4D", "8D", "12D"],
                [pd.Timedelta("4 day"), pd.Timedelta("8 day"),
    pd.Timedelta("12 day")],
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (pd.timedelta_range(start="1 day", periods=20), ["3 day", "30
    day"]),
        ],
    )
