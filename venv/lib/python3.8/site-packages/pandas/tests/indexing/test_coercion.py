...
def check_comprehensiveness(request):
    ...
    def has_test(combo):
        ...
        return any(
            klass in x.name and dtype in x.name and method in x.name for x in
    cls_funcs
        )
        ...
        if exp_dtype is IndexError:
            ...
            with pytest.raises(exp_dtype, match=msg):
                ...
                with tm.assert_produces_warning(FutureWarning, match=depr_msg):
                    temp[5] = 5
            mark = pytest.mark.xfail(reason="TODO_GH12747 The result must be
    float")
...
class TestInsertIndexCoercion(CoercionBase):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (pd.Timestamp("2012-01-01", tz="US/Eastern"), "datetime64[ns,
    US/Eastern]"),
        ],
    ...
    tz=fill_val.tz
        ...
        exp = pd.DatetimeIndex(
            ["2011-01-01", fill_val.date(), "2011-01-02", "2011-01-03",
    "2011-01-04"],
            tz=fill_val.tz,
        )
        ...
        if fill_val.tz:
            ...
            # mismatched tz --> cast to object (could reasonably cast to
    common tz)
    ...
    coerced_dtype)
            ...
            # TODO: ATM inserting '2012-01-01 00:00:00' when we have
    obj.freq=="M"
...
class TestWhereCoercion(CoercionBase):
    ...
    def test_where_datetime64(self, index_or_series, fill_val, exp_dtype):
        ...
        obj = klass(pd.date_range("2011-01-01", periods=4,
    ...
    @pytest.mark.parametrize(
        "value", [pd.Timedelta(days=9), timedelta(days=9), np.timedelta64(9,
    "D")]
    )
...
class TestFillnaSeriesCoercion(CoercionBase):
    ...
    def test_fillna_datetime64tz(self, index_or_series, fill_val, fill_dtype):
        ...
        warn = None
        if getattr(fill_val, "tz", None) is not None and fill_val.tz !=
    obj[0].tz:
            warn = FutureWarning
    ...
    def test_fillna_series_period(self, index_or_series, fill_val):
        ...
        pi = pd.period_range("2016-01-01", periods=4, freq="D").insert(1,
    pd.NaT)
...
class TestReplaceSeriesCoercion(CoercionBase):
    ...
    @pytest.mark.parametrize(
        "to_key",
        ["timedelta64[ns]", "bool", "object", "complex128", "float64",
    "int64"],
        indirect=True,
    )
    @pytest.mark.parametrize(
    ...
    @pytest.mark.parametrize(
        "to_key",
        ["datetime64[ns]", "datetime64[ns, UTC]", "datetime64[ns,
    US/Eastern]"],
        indirect=True,
    )
    @pytest.mark.parametrize(
