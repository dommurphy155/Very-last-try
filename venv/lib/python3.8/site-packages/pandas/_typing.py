...
# Series is passed into a function, a Series is always returned and if a
    DataFrame is
...
CompressionOptions = Optional[
    Union[Literal["infer", "gzip", "bz2", "zip", "xz", "zstd", "tar"],
    CompressionDict]
]
...
QuantileInterpolation = Literal["linear", "lower", "higher", "midpoint",
    "nearest"]
