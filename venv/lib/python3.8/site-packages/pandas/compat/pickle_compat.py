    ...
    try:
        ...
        if msg in str(err):
            try:
                ...
                pass
        elif args and isinstance(args[0], type) and issubclass(args[0],
    BaseOffset):
...
class _LoadSparseSeries:
    ...
    # error: Incompatible return type for "__new__" (returns "Series", but
    must return
...
class _LoadSparseFrame:
    ...
    # https://github.com/python/mypy/issues/1020
    # error: Incompatible return type for "__new__" (returns "DataFrame", but
    must
...
_class_locations_map = {
    ("pandas.core.sparse.array", "SparseArray"): ("pandas.core.arrays",
    "SparseArray"),
    # 15477
    ("pandas.core.base", "FrozenNDArray"): ("numpy", "ndarray"),
    ("pandas.core.indexes.frozen", "FrozenNDArray"): ("numpy", "ndarray"),
    ("pandas.core.base", "FrozenList"): ("pandas.core.indexes.frozen",
    "FrozenList"),
    # 10890
    ...
    ("pandas._libs.period", "Period"): ("pandas._libs.tslibs.period",
    "Period"),
    ...
    ("pandas.indexes.base", "_new_Index"): ("pandas.core.indexes.base",
    "_new_Index"),
    ...
    ("pandas.indexes.range", "RangeIndex"): ("pandas.core.indexes.range",
    "RangeIndex"),
    ("pandas.indexes.multi", "MultiIndex"): ("pandas.core.indexes.multi",
    "MultiIndex"),
    ...
    # 19269, arrays moving
    ("pandas.core.categorical", "Categorical"): ("pandas.core.arrays",
    "Categorical"),
