...
def validate_argmin_with_skipna(skipna: bool | ndarray | None, args, kwargs)
    -> bool:
    """
...
def validate_argmax_with_skipna(skipna: bool | ndarray | None, args, kwargs)
    -> bool:
    """
...
validate_argsort_kind = CompatValidator(
    ARGSORT_DEFAULTS_KIND, fname="argsort", max_fname_arg_count=0,
    method="both"
)


def validate_argsort_with_ascending(ascending: bool | int | None, args,
    kwargs) -> bool:
    """
...
def validate_take_with_convert(convert: ndarray | bool | None, args, kwargs)
    -> bool:
    """
    If this function is called via the 'numpy' library, the third parameter in
...
def validate_minmax_axis(axis: int | None, ndim: int = 1) -> None:
    ...
    if axis >= ndim or (axis < 0 and ndim + axis < 0):
        raise ValueError(f"`axis` must be fewer than the number of dimensions
    ({ndim})")
