...
class HTMLFormatter:
    ...
    def write_th(
        self, s: Any, header: bool = False, indent: int = 0, tags: str | None
    = None
    ) -> None:
        """
    ...
    def _write_cell(
        self, s: Any, kind: str = "td", indent: int = 0, tags: str | None =
    None
    ) -> None:
        if tags is not None:
    ...
    def _write_regular_rows(
        ...
        for i in range(nrows):
            ...
            self.write_tr(
                row, indent, self.indent_delta, tags=None,
    nindex_levels=self.row_levels
            )
    ...
    "..."
            ...
            for i in range(len(frame)):
                ...
                idx_values = list(
                    zip(*frame.index.format(sparsify=False, adjoin=False,
    names=False))
                )
                row = []
