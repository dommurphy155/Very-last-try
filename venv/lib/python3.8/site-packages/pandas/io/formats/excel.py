...
class CSSToExcelConverter:
    ...
    def build_xlstyle(self, props: Mapping[str, str]) -> dict[str, dict[str,
    str]]:
        out = {
    ...
    def build_alignment(self, props: Mapping[str, str]) -> dict[str, bool |
    str | None]:
    ...
    def _border_style(self, style: str | None, width: str | None, color: str |
    None):
    ...
    def build_fill(self, props: Mapping[str, str]):
        ...
        if fill_color not in (None, "transparent", "none"):
            return {"fgColor": self.color_to_excel(fill_color), "patternType":
    "solid"}

    def build_number_format(self, props: Mapping[str, str]) -> dict[str, str |
    None]:
...
class ExcelFormatter:
    ...
    def _format_header(self) -> Iterable[ExcelCell]:
        ...
        if self.df.index.names:
            ...
            if reduce(lambda x, y: x and y, map(lambda x: x != "", row)):
                gen2 = (
                    ExcelCell(self.rowcounter, colindex, val,
    self.header_style)
    ...
    longer
        ...
        if num_rows > self.max_rows or num_cols > self.max_cols:
            raise ValueError(
                f"This sheet is too large! Your sheet size is: {num_rows},
    {num_cols} "
        ...
        if isinstance(writer, ExcelWriter):
            ...
            # error: Cannot instantiate abstract class 'ExcelWriter' with
    abstract
