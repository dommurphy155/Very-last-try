...
https://support.sas.com/content/dam/SAS/support/en/technical-papers/record-layo
    ut-of-a-sas-version-5-or-6-data-set-in-sas-transport-xport-format.pdf
"""
...
_correct_header1 = (
    ...
    RECORD!!!!!!!000000000000000001600000000"
)
_correct_header2 = (
...
class XportReader(ReaderBase, abc.Iterator):
    ...
    https://documentation.sas.com/doc/en/pgmsascdc/9.4_3.5/movefile/p1bm6aqp3fw4uin1hucwh718f6kp.htm
                raise ValueError(
                    "Header record indicates a CPORT file, which is not
    readable."
                )
    ...
    def read(self, nrows: int | None = None) -> pd.DataFrame:
        ...
        for j, x in enumerate(self.columns):
            ...
            if ntype == "numeric":
                vec = _handle_truncated_float_vec(vec,
    self.fields[j]["field_length"])
        ...
        if self._index is None:
            df.index = pd.Index(range(self._lines_read, self._lines_read +
    read_lines))
        else:
