...
def get_default_engine(ext: str, mode: Literal["reader", "writer"] = "reader")
    -> str:
    """
...
def maybe_convert_usecols(
    ...
    if is_integer(usecols):
        raise ValueError(
            ...
            "Please pass in a list of int from 0 to `usecols` inclusive
    instead."
        )
...
def combine_kwargs(engine_kwargs: dict[str, Any] | None, kwargs: dict) -> dict:
    ...
    Use of kwargs is deprecated, this function is solely for use in 1.3 and
    should
    be removed in 1.4/2.0. Also _base.ExcelWriter.__new__ ensures either
    engine_kwargs
