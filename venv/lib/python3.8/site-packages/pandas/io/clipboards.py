...
def read_clipboard(sep: str = r"\s+", **kwargs):  # pragma: no cover
    ...
    **kwargs
    ...
    if encoding is not None and encoding.lower().replace("-", "") != "utf8":
        raise NotImplementedError("reading from clipboard only supports utf-8
    encoding")
    ...
    if len(sep) > 1 and kwargs.get("engine") is None:
        ...
        warnings.warn(
            "read_clipboard with regex separator does not work properly with c
    engine.",
...
def to_clipboard(
    ...
    if excel:
        try:
            ...
            warnings.warn(
                "to_clipboard in excel mode requires a single character
    separator.",
                stacklevel=find_stack_level(),
            )
