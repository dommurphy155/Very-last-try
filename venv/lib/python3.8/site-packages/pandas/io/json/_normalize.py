...
def nested_to_record(
    ...
    --------
    >>> nested_to_record(
    ...     dict(flat1=1, dict1=dict(c=1, d=2), nested=dict(e=dict(c=1, d=2),
    d=2))
    ... )
    {\
'flat1': 1, \
...
def _normalise_json_ordered(data: dict[str, Any], separator: str) -> dict[str,
    Any]:
    """
...
'nested.d': 2\
    ...
    separator=sep)
        ...
        normalised_json_list = [_simple_json_normalize(row, sep=sep) for row
    in ds]
...
def _json_normalize(
    ...
    def _pull_field(
        ...
        try:
            ...
            if extract_record:
                raise KeyError(
                    f"Key {e} not found. If specifying a record_path, all
    elements of "
    ...
    def _pull_records(js: dict[str, Any], spec: list | str) -> list:
        ...
        # GH 31507 GH 30145, GH 26284 if result is not list, raise TypeError
    if not
...
json_normalize = deprecate(
    "pandas.io.json.json_normalize", _json_normalize, "1.0.0",
