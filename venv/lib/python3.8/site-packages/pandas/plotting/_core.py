...
**kwargs
    All other plotting keyword arguments to be passed to:func:`matplotlib.pyplot.boxplot`.
...
_bar_or_line_doc = """
        ...
        color: str, array-like, or dict, optional
            ...
            - A sequence of color strings referred to by name, RGB or RGBA
                ...
                instance ['green','yellow'] each column's %(kind)s will be
    filled in
                green or yellow, alternatively. If there is only a single
    column to
                be plotted, then only the first color from the color list will
    be
                used.

            - A dict of the form {column name: color}, so that each column
    will be
                colored accordingly. For example, if your columns are called
    `a` and
                `b`, then passing {'a': 'green', 'b': 'red'} will color
    %(kind)ss for
...
def boxplot_frame_groupby(
    ...
    **kwargs
    ...
    Examples
    --------
    You can create boxplots for grouped data and show them as separate
    subplots:
    ...
    .. plot:::context: close-figs
        ...
        >>> grouped.boxplot(rot=45, fontsize=12, figsize=(8,10))  # doctest:
    +SKIP
    ...
    .. plot:::context: close-figs
        ...
        >>> grouped.boxplot(subplots=False, rot=45, fontsize=12)  # doctest:
    +SKIP
    """
    plot_backend = _get_plot_backend(backend)
...
class PlotAccessor(PandasObject):
    ...
    **kwargs
    ...
    def _get_call_args(backend_name, data, args, kwargs):
        ...
        if args and isinstance(data, ABCSeries):
            ...
            keyword_args = ", ".join(
                [f"{name}={repr(value)}" for (name, _), value in zip(arg_def,
    args)]
            )
            msg = (
    ...
    **kwargs)
    ...
    @Appender(
        ...
        ``subplots=True``. In this case, a:class:`numpy.ndarray` of:class:`matplotlib.axes.Axes` are returned.
        ...
        .. plot:::context: close-figs
            ...
            >>> axes = df.plot.bar(
            ...     rot=0, subplots=True, color={"speed": "red", "lifespan":
    "green"}
            ... )
            >>> axes[1].legend(loc=2)  # doctest: +SKIP
    ...
    def box(self, by=None, **kwargs) -> PlotAccessor:
        ...
        **kwargs
            Additional keywords are documented in:meth:`DataFrame.plot`.
        ...
        You can also generate groupings if you specify the `by` parameter
    (which
    ...
    def scatter(self, x, y, s=None, c=None, **kwargs) -> PlotAccessor:
        ...
        s: str, scalar or array-like, optional
            ...
            - A string with the name of the column to be used for marker's
    size.
...
def _load_backend(backend: str) -> types.ModuleType:
    ...
    if found_backend:
        if hasattr(module, "plot"):
            # Validate that the interface is implemented when the option is
    set,
...
def _get_plot_backend(backend: str | None = None):
    ...
    either comes from the keyword argument `backend`, or, if not specified,
    from
