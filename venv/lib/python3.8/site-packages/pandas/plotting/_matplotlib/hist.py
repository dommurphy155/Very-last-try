...
class HistPlot(LinePlot):
    ...
    def _args_adjust(self):
        ...
        if is_integer(self.bins):
            if self.by is not None:
                ...
                self.bins = [self._calculate_bins(group) for key, group in
    grouped]
            else:
    ...
    def _make_plot(self):
        ...
        for i, (label, y) in enumerate(self._iter_data(data=data)):
            ...
            # the bins is multi-dimension array now and each plot need only
    1-d and
    ...
    array,
            # and each sub-array (10,) will be called in each iteration. If
    users only
...
def _grouped_plot(
    ...
    **kwargs,
    ...
    fig, axes = create_subplots(
        naxes=naxes, figsize=figsize, sharex=sharex, sharey=sharey, ax=ax,
    layout=layout
    )
...
def _grouped_hist(
    ...
    **kwargs,
    ...
    set_ticks_props(
        axes, xlabelsize=xlabelsize, xrot=xrot, ylabelsize=ylabelsize,
    yrot=yrot
    )
...
def hist_series(
    ...
    **kwds,
    ...
    is None")
        ...
        fig = kwds.pop(
            "figure", plt.gcf() if plt.get_fignums() else
...
def hist_frame(
    ...
    **kwds,
    ...
    if naxes == 0:
        raise ValueError(
            "hist method requires numerical or datetime columns, nothing to
    plot."
        )
