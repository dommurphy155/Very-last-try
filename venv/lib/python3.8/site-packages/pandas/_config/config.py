...
def _set_option(*args, **kwargs) -> None:
    ...
    if kwargs:
        ...
        raise TypeError(f'_set_option() got an unexpected keyword argument
    "{kwarg}"')
...
class option_context(ContextDecorator):
    ...
    def __enter__(self) -> None:
        self.undo = [(pat, _get_option(pat, silent=True)) for pat, val in
    self.ops]
...
def deprecate_option(
    ...
    if key in _deprecated_options:
        raise OptionError(f"Option '{key}' has already been defined as
    deprecated.")
