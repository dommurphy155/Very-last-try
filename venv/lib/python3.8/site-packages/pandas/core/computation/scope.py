...
class Scope:
    ...
    def __init__(
        self, level: int, global_dict=None, local_dict=None, resolvers=(),
    target=None
    ) -> None:
        self.level = level + 1
    ...
    def __repr__(self) -> str:
        ...
        return f"{type(self).__name__}(scope={scope_keys},
    resolvers={res_keys})"
