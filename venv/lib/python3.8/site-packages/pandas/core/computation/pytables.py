...
class PyTablesScope(_scope.Scope):
    ...
    def __init__(
        ...
        super().__init__(level + 1, global_dict=global_dict,
...
class BinOp(ops.BinOp):
    ...
    def prune(self, klass):
        def pr(left, right):
            ...
            return k(
                self.op, left, right, queryables=self.queryables,
    ...
    def convert_value(self, v) -> TermValue:
        ...
        if kind == "datetime64" or kind == "datetime":
            ...
            raise TypeError(f"Cannot compare {v} of type {type(v)} to {kind}
    column")
...
class FilterBinOp(BinOp):
    ...
    def __repr__(self) -> str:
        ...
        return pprint_thing(f"[Filter: [{self.filter[0]}] ->
    [{self.filter[1]}]")
    ...
    def evaluate(self):
        ...
        if self.op in ["==", "!="]:
            ...
            raise TypeError(
                f"passing a filterable condition to a non-table indexer
    [{self}]"
            )
...
class JointConditionBinOp(ConditionBinOp):
    def evaluate(self):
        self.condition = f"({self.lhs.condition} {self.op}
    {self.rhs.condition})"
        return self
