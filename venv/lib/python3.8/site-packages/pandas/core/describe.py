...
Method NDFrame.describe() delegates actual execution to function
    describe_ndframe().
"""
...
def describe_ndframe(
    *,
    ...
    percentiles: list-like of numbers, optional
        The percentiles to include in the output. All should fall between 0
    and 1.
...
def describe_numeric_1d(series: Series, percentiles: Sequence[float]) ->
    Series:
...
def describe_timestamp_1d(data: Series, percentiles: Sequence[float]) ->
    Series:
