...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def _get_axis_number(cls, axis: Axis) -> int:
        try:
            ...
            raise ValueError(f"No axis named {axis} for object type
    {cls.__name__}")
    ...
    def _get_cleaned_column_resolvers(self) -> dict[Hashable, Series]:
        ...
        return {
            clean_column_name(k): v for k, v in self.items() if not
    isinstance(k, int)
        }
    ...
    def set_axis(
        ...
        *,
        ...
        Indexes for%(extended_summary_sub)s row labels can be changed by
    assigning
        ...
        if inplace is not lib.no_default:
            warnings.warn(
                f"{type(self).__name__}.set_axis 'inplace' keyword is
    deprecated "
        ...
        if inplace:
            if copy is True:
                raise ValueError("Cannot specify both inplace=True and
    copy=True")
            copy = False
    ...
    @final
    def _set_axis_nocheck(self, labels, axis: Axis, inplace: bool_t, copy:
    bool_t):
        if inplace:
    ...
    def swapaxes(
        ...
        new_axes = (self._get_axis(mapping.get(k, k)) for k in
    ...
    def droplevel(self: NDFrameT, level: IndexLabel, axis: Axis = 0) ->
    NDFrameT:
        """
    ...
    def squeeze(self, axis=None):
        ...
        axis: {0 or 'index', 1 or 'columns', None}, default None
            ...
            squeezed. For `Series` this parameter is unused and defaults to
    `None`.
        ...
        1
        """
        axis = range(self._AXIS_LEN) if axis is None else
    ...
    def _rename(
        ...
        *,
        ...
        if index is not None or columns is not None:
            if axis is not None:
                raise TypeError(
                    "Cannot specify both 'axis' and any of 'index' or
    'columns'"
                )
            elif mapper is not None:
                raise TypeError(
                    "Cannot specify both 'mapper' and any of 'index' or
    'columns'"
                )
        else:
        ...
        for axis_no, replacements in enumerate((index, columns)):
            ...
            if not callable(replacements):
                if ax._is_multi and level is not None:
                    indexer =
    ax.get_level_values(level).get_indexer_for(replacements)
                else:
    ...
    def rename_axis(
        ...
        **kwargs,
        ...
        index, columns: scalar, list-like, dict-like or function, optional
            ...
            and/or ``columns``.
        axis: {0 or 'index', 1 or 'columns'}, default 0
            The axis to rename. For `Series` this parameter is unused and
    defaults to 0.
        copy: bool, default True
        ...
        **MultiIndex**
        ...
        if mapper is not lib.no_default:
            ...
            if non_mapper:
                ...
                raise ValueError("Use `.rename` to alter labels with a
    mapper.")
        else:
    ...
    def _indexed_same(self, other) -> bool_t:
        return all(
            self._get_axis(a).equals(other._get_axis(a)) for a in
    self._AXIS_ORDERS
        )
    ...
    def bool(self) -> bool_t:
        ...
        This must be a boolean scalar value, either True or False. It will
    raise a
        ValueError if the Series or DataFrame does not have exactly 1 element,
    or that
    ...
    boolean.
        numpy.bool_: NumPy boolean data type, used by pandas for boolean
    values.

        Examples
        --------
        The method will only work for single element objects with a boolean
    value:
    ...
    @final
    def _is_label_or_level_reference(self, key: Level, axis: int = 0) ->
    bool_t:
        """
    ...
    @final
    def _check_label_or_level_ambiguity(self, key: Level, axis: int = 0) ->
    None:
        """
    ...
    @final
    def _get_label_or_level_values(self, key: Level, axis: int = 0) ->
    ArrayLike:
        """
    ...
    "Union[
            # ExtensionArray, ndarray[Any, Any]]", variable has type
    "ndarray[Any,
            # Any]")
            values = (
                self.axes[axis]
    ...
    MultiIndex):
            ...
            raise ValueError(
                f"The {label_axis_name} label '{key}' is not
    unique.{multi_message}"
            )
    ...
    def _drop_labels_or_levels(self, keys, axis: int = 0):
        ...
        invalid_keys = [
            k for k in keys if not self._is_label_or_level_reference(k,
    axis=axis)
        ]
    ...
    def empty(self) -> bool_t:
        ...
        True if Series/DataFrame is entirely empty (no items), meaning any of
    the
        ...
        Notes
        -----
        If Series/DataFrame contains only NaNs, it is still not considered
    empty. See
        the example below.
    ...
    def __array_wrap__(
        ...
        context: tuple of (func, tuple, int)
            This parameter is returned by ufuncs as a 3-element tuple: (name
    of the
            ufunc, arguments of the ufunc, domain of the ufunc), but is not
    set by
            other numpy functions.q

        Notes
        -----
        Series implements __array_ufunc_ so this not called for ufunc on
    Series.
        """
        # Note: at time of dask 2022.01.0, this is still used by dask
        warnings.warn(
            "The __array_wrap__ method of DataFrame and Series will be removed
    in "
            "a future version",
            DeprecationWarning,
            stacklevel=find_stack_level(),
        ...
        return self._constructor(res, **d).__finalize__(self,
    ...
    def __setstate__(self, state) -> None:
        if isinstance(state, BlockManager):
            ...
            if typ is not None:
                ...
                raise NotImplementedError("Pre-0.12 pickles are no longer
    supported")
        elif len(state) == 2:
            raise NotImplementedError("Pre-0.12 pickles are no longer
    supported")
    ...
    def to_excel(
        ...
        To write a single {klass} to an Excel .xlsx file it is only necessary
    to
    ...
    -> value}}]
                ...
                - 'table': dict like {{'schema': {{schema}}, 'data':
    {{data}}}}
    ...
    def to_hdf(
        ...
        data_columns: list of columns or True, optional
            ...
            of the object are indexed. See:ref:`Query via data columns<io.hdf5-query-data-columns>`. for
            more information.
    ...
    SQLAlchemy
        ...
        None or int
            ...
            attribute of ``sqlite3.Cursor`` or SQLAlchemy connectable which
    may not
            reflect the exact number of written rows as stipulated in the
            `sqlite3
    <https://docs.python.org/3/library/sqlite3.html#sqlite3.Cursor.rowcount>`__ or
            `SQLAlchemy
    <https://docs.sqlalchemy.org/en/14/core/connections.html#sqlalchemy.engine.BaseCursorResult.rowcount>`__.
    ...
    "
            "The arguments signature may therefore change. It is recommended
    instead "
        ...
        if multicolumn_format is None:
            multicolumn_format =
    config.get_option("display.latex.multicolumn_format")
        if multirow is None:
    ...
    @deprecate_kwarg(old_arg_name="line_terminator",
    new_arg_name="lineterminator")
    def to_csv(
        self,
        path_or_buf: FilePath | WriteBuffer[bytes] | WriteBuffer[str] | None =
    None,
        ...
        path_or_buf: str, path object, file-like object, or None, default None
            String, path object (implementing os.PathLike[str]), or file-like
            object implementing a write() function. If None, the result is
            returned as a string. If a non-binary file object is passed, it
    should
            be opened with `newline=''`, disabling universal newlines. If a
    binary
        ...
        float_format: str, Callable, default None
            Format string for floating point numbers. If a Callable is given,
    it takes
        ...
        {compression_options}
            ...
            .. versionchanged:: 1.1.0
               ...
               supported for compression modes 'gzip', 'bz2', 'zstd', and
    'zip'.
    ...
    i.e.).
        ...
        >>> filepath.parent.mkdir(parents=True, exist_ok=True)  # doctest:
    +SKIP
    ...
    def take(
        self: NDFrameT, indices, axis=0, is_copy: bool_t | None = None,
    **kwargs
    ) -> NDFrameT:
        """
        ...
        **kwargs
        ...
        if is_copy is not None:
            warnings.warn(
                "is_copy is deprecated and will be removed in a future
    version. "
                "'take' always returns a copy, so there is no need to specify
    this.",
                FutureWarning,
                stacklevel=find_stack_level(),
            )
    ...
    def _take(
        ...
        """
        Internal version of the `take` allowing specification of additional
    args.
    ...
    def xs(
        ...
        if isinstance(key, list):
            warnings.warn(
                "Passing lists as key for xs is deprecated and will be removed
    in a "
    ...
    def _check_setitem_copy(self, t="setting", force=False):
        ...
        if self._is_copy is not None and not isinstance(self._is_copy, str):
            r = self._is_copy()
            if not gc.get_referents(r) or (r is not None and r.shape ==
    self.shape):
                self._is_copy = None
                return
    ...
    'index'/'columns'")
            ...
            raise ValueError(
                "Need to specify at least one of 'labels', 'index' or
    'columns'"
            )
    ...
    def _drop_axis(
        ...
        # Case for non-unique axis
            ...
            is_tuple_labels = is_nested_list_like(labels) or
    ...
    np.random.Generator, optional
            If int, array-like, or BitGenerator, seed for random number
    generator.
    ...
    np.random.RandomState()
        ...
        axis: {0 or ‘index’, 1 or ‘columns’, None}, default None
            ...
            for given data type. For `Series` this parameter is unused and
    defaults to `None`.
        ignore_index: bool, default False
    ...
    def _get_numeric_data(self: NDFrameT) -> NDFrameT:
        return
    self._constructor(self._mgr.get_numeric_data()).__finalize__(self)
    ...
    def dtypes(self):
        ...
        with mixed types are stored with the ``object`` dtype. See:ref:`the User Guide <basics.dtypes>` for more.
        ...
        return self._constructor_sliced(data, index=self._info_axis,
    dtype=np.object_)

    def astype(
        self: NDFrameT, dtype, copy: bool_t = True, errors: IgnoreRaise =
    "raise"
    ) -> NDFrameT:
        """
    ...
    def copy(self: NDFrameT, deep: bool_t | None = True) -> NDFrameT:
        ...
        Since pandas is not thread safe, see the:ref:`gotchas <gotchas.thread-safety>` when copying in a threading
        environment.
    ...
    def infer_objects(self: NDFrameT) -> NDFrameT:
        ...
        return self._constructor(
            self._mgr.convert(datetime=True, numeric=False, timedelta=True,
    copy=True)
    ...
    ``pd.NA``.
        ...
        infer_objects: bool, default True
            Whether object dtypes should be converted to the best possible
    types.
    ...
    types.
            If `convert_integer` is also True, preference will be give to
    integer
        ...
        Notes
        -----
        By default, ``convert_dtypes`` will attempt to convert a Series (or
    each
    ...
    inference
        rules as during normal Series/DataFrame construction.  Then, if
    possible,
        convert to ``StringDtype``, ``BooleanDtype`` or an appropriate integer
        or floating extension type, otherwise leave as ``object``.

        If the dtype is integer, convert to an appropriate integer extension
    type.
        ...
        In the future, as new dtypes are added that support ``pd.NA``, the
    results
                    ...
                    if not inplace:
                        ...
                        if isinstance(res_k, ABCSeries):
                            ...
                            if isinstance(locs, slice):
                                ...
                                isinstance(locs, np.ndarray) and
    locs.dtype.kind == "b"
                            ):
                                locs = locs.nonzero()[0]
                            elif not (
    ...
    bases
                                raise NotImplementedError(
                                    "Unexpected get_loc result, please report
    a bug at "
    ...
    def ffill(
        ...
        """
        return self.fillna(
            method="ffill", axis=axis, inplace=inplace, limit=limit,
    downcast=downcast
        )
    ...
    def bfill(
        ...
        """
        return self.fillna(
            method="bfill", axis=axis, inplace=inplace, limit=limit,
    downcast=downcast
        )
    ...
    lib.no_default,
        ...
        if not is_bool(regex) and to_replace is not None:
            raise ValueError("'to_replace' must be 'None' if 'regex' is not a
    bool")
        ...
        if value is lib.no_default or method is not lib.no_default:
            ...
            if is_dict_like(to_replace):
                if is_dict_like(value):  # {'A': NA} -> {'A': 0}
                    ...
                    #  `in foo` is needed for when we have a Series and not
    dict
                    mapping = {
                ...
                # {'A': NA} -> 0
                    ...
                    mapping = {
                        col: (to_rep, value) for col, to_rep in
    to_replace.items()
                    }
                    return self._replace_columnwise(mapping, inplace, regex)
                else:
    ...
    Series")
                ...
                if not (
                    ...
                    raise TypeError(
                        f"'regex' must be a string or a compiled regular
    expression "
    ...
    "
                ...
                if is_dict_like(value):  # NA -> {'A': 0, 'B': -1}
                    ...
                    mapping = {col: (to_replace, val) for col, val in
    value.items()}
                    return self._replace_columnwise(mapping, inplace, regex)
    ...
    'forward'.
                * If 'method' is 'backfill' or 'bfill', 'limit_direction' must
    be
                  'backwards'.

            If 'limit' is not specified:
                * If 'method' is 'backfill' or 'bfill', the default is
    'backward'
                * else the default is 'forward'

            .. versionchanged:: 1.1.0
                raises ValueError if `limit_direction` is 'forward' or 'both'
    and
                    method is 'backfill' or 'bfill'.
                raises ValueError if `limit_direction` is 'backward' or 'both'
    and
    ...
    <https://docs.scipy.org/doc/scipy/reference/interpolate.html#univariate-interpolation>`__.
        ...
        if isinstance(obj.index, MultiIndex) and method != "linear":
            raise ValueError(
                "Only `method=linear` interpolation is supported on
    MultiIndexes."
            )
        ...
        if limit_direction is None:
            ...
            if method in ("pad", "ffill") and limit_direction != "forward":
                raise ValueError(
                    f"`limit_direction` must be 'forward' for method
    `{method}`"
                )
            if method in ("backfill", "bfill") and limit_direction !=
    "backward":
                raise ValueError(
                    f"`limit_direction` must be 'backward' for method
    `{method}`"
                )
    ...
    def asof(self, where, subset=None):
        ...
        if nulls.all():
            if is_series:
                ...
                self = cast("DataFrame", self)
                return self._constructor(np.nan, index=where,
    ...
    def _clip_with_one_bound(self, threshold, method, axis, inplace):
        ...
        if (not isinstance(threshold, ABCSeries)) and is_list_like(threshold):
            if isinstance(self, ABCSeries):
                ...
                threshold = align_method_FRAME(self, threshold, axis,
    flex=None)[1]
    ...
    def asfreq(
        ...
        If the index of this {klass} is a:class:`~pandas.PeriodIndex`, the
    new index
        is the result of transforming the original index with:meth:`PeriodIndex.asfreq <pandas.PeriodIndex.asfreq>` (so the
    original index
        will map one-to-one to the new index).

        Otherwise, the new index will be equivalent to ``pd.date_range(start,
    end,
        freq=freq)`` where ``start`` and ``end`` are, respectively, the first
    and
        last entries in the original index (see:func:`pandas.date_range`). The
        values corresponding to any timesteps in the new index which were not
    present
        in the original index will be null (``NaN``), unless a method for
    filling
        such unknowns is provided (see the ``method`` parameter below).

        The:meth:`resample` method is more appropriate if an operation on
    each group of
        timesteps (such as an aggregate) is necessary to represent the data at
    the new
        frequency.
    ...
    @final
    def at_time(self: NDFrameT, time, asof: bool_t = False, axis=None) ->
    NDFrameT:
        """
    ...
    def between_time(
        ...
        -------
        Series or DataFrame
            Data from the original object filtered to the specified dates
    range.
    ...
    `PeriodIndex`,
        or `TimedeltaIndex`), or the caller must pass the label of a
    datetime-like
    ...
    parameter
        ...
        loffset: timedelta, default None
            ...
            .. deprecated:: 1.1.0
                You should add the loffset to the `df.index` after the
    resample.
                See below.
        ...
        origin: Timestamp or str, default 'start_day'
            The timestamp on which to adjust the grouping. The timezone of
    origin
            ...
            - 'start_day': `origin` is the first day at midnight of the
    timeseries
        ...
        Returns
        -------
        pandas.core.Resampler:class:`~pandas.core.Resampler` object.
    ...
    ceiling
        midnight of the largest Timestamp as the end of the bins and drop the
    bins
        not containing data:
    ...
    month.
        ...
        if not isinstance(offset, Tick) and offset.is_on_offset(self.index[0]):
            # GH#29623 if first value is end of period, remove offset with n =
    1
    ...
    def last(self: NDFrameT, offset) -> NDFrameT:
        ...
        offset: str, DateOffset, dateutil.relativedelta
            The offset length of the data that will be selected. For instance,
            '3D' will display all the rows having their index within the last
    3 days.
    ...
    ties):
        ...
        * pct_rank: when setting ``pct = True``, the ranking is expressed as
        ...
        if numeric_only is None:
            # GH#45036
            warnings.warn(
                f"'numeric_only=None' in {type(self).__name__}.rank is
    deprecated "
        ...
        if numeric_only is None:
            try:
                ...
                if not warned:
                    ...
                    # GH#45036
                    warnings.warn(
                        f"Dropping of nuisance columns in
    ...
    TypeError. "
        ...
        if numeric_only:
            if self.ndim == 1 and not is_numeric_dtype(self.dtype):
                # GH#47500
                warnings.warn(
                    f"Calling Series.rank with numeric_only={numeric_only} and
    dtype "
                    f"{self.dtype} is deprecated and will raise a TypeError in
    a "
    ...
    def compare(
        ...
        if type(self) is not type(other):
            ...
            raise TypeError(
                f"can only compare '{cls_self}' (not '{cls_other}') with
    '{cls_self}'"
            )
        ...
        indices = (
            np.arange(diff.shape[axis]).reshape([2, diff.shape[axis] //
    2]).T.flatten()
        )
    ...
    **self._construct_axes_dict()
    ...
    def _align_series(
        ...
        if is_series and axis == 1:
            raise ValueError("cannot align series to a series other than axis
    0")
        ...
        if not axis:
            ...
            if is_series:
                ...
                left = self._constructor(
                    self._mgr.reindex_indexer(join_index, lidx, axis=1,
    copy=copy)
                )
        ...
        if isinstance(other, (np.ndarray, ExtensionArray)):
            ...
            if other.shape != self.shape:
                if self.ndim != 1:
                    ...
                    #  other length 1, which we treat as scalar (GH#2745,
    GH#4192)
    ...
    def where(
        ...
        For further details and examples see the ``{name}`` documentation in:ref:`indexing <indexing.where_mask>`.
    ...
    def shift(
        ...
        axis: {{0 or 'index', 1 or 'columns', None}}, default None
            Shift direction. For `Series` this parameter is unused and
    defaults to 0.
    ...
    @final
    def tshift(self: NDFrameT, periods: int = 1, freq=None, axis: Axis = 0) ->
    NDFrameT:
        """
        ...
        def _tz_convert(ax, tz):
            if not hasattr(ax, "tz_convert"):
                if len(ax) > 0:
                    ...
                    raise TypeError(
                        f"{ax_name} is not a valid DatetimeIndex or
    PeriodIndex"
                    )
                else:
    ...
    def describe(
        ...
        datetime_is_numeric: bool, default False
            Whether to treat datetime dtypes as numeric. This affects
    statistics
    ...
    def _logical_func(
        ...
        **kwargs,
        ...
        if level is not None:
            warnings.warn(
                "Using the level keyword in DataFrame and Series aggregations
    is "
                "deprecated and will be removed in a future version. Use
    groupby "
                "instead. df.any(level=1) should use
    df.groupby(level=1).any()",
                FutureWarning,
                stacklevel=find_stack_level(),
            )
    ...
    DataFrame._reduce
            res = self._logical_func(
                name, func, axis=0, bool_only=bool_only, skipna=skipna,
    **kwargs
            )
    ...
    def cummax(self, axis: Axis | None = None, skipna: bool_t = True, *args,
    **kwargs):
        return self._accum_func(
            "cummax", np.maximum.accumulate, axis, skipna, *args, **kwargs
        )

    def cummin(self, axis: Axis | None = None, skipna: bool_t = True, *args,
    **kwargs):
        return self._accum_func(
            "cummin", np.minimum.accumulate, axis, skipna, *args, **kwargs
        )

    def cumsum(self, axis: Axis | None = None, skipna: bool_t = True, *args,
    **kwargs):
        return self._accum_func("cumsum", np.cumsum, axis, skipna, *args,
    **kwargs)

    def cumprod(self, axis: Axis | None = None, skipna: bool_t = True, *args,
    **kwargs):
    ...
    **kwargs)
    ...
    is "
                "deprecated and will be removed in a future version. Use
    groupby "
                "instead. df.var(level=1) should use
    df.groupby(level=1).var().",
                FutureWarning,
                stacklevel=find_stack_level(),
            )
        ...
        return self._reduce(
            func, name, axis=axis, numeric_only=numeric_only, skipna=skipna,
    ddof=ddof
        )
    ...
    def sem(
        ...
        **kwargs,
        ...
        return self._stat_function_ddof(
            "sem", nanops.nansem, axis, skipna, level, ddof, numeric_only,
    **kwargs
        )
    ...
    def var(
        ...
        **kwargs,
        ...
        return self._stat_function_ddof(
            "var", nanops.nanvar, axis, skipna, level, ddof, numeric_only,
    **kwargs
        )
    ...
    def std(
        ...
        **kwargs,
        ...
        return self._stat_function_ddof(
            "std", nanops.nanstd, axis, skipna, level, ddof, numeric_only,
    **kwargs
        )
    ...
    def _stat_function(
        ...
        **kwargs,
        ...
        if axis is None and level is None and self.ndim > 1:
            ...
            # GH#21597
            warnings.warn(
                f"In a future version, DataFrame.{name}(axis=None) will return
    a "
                f"scalar {name} over the entire DataFrame. To retain the old "
                f"behavior, use 'frame.{name}(axis=0)' or just
    'frame.{name}()'",
                FutureWarning,
                stacklevel=find_stack_level(),
            )
    ...
    def median(
        ...
        **kwargs,
        ...
        return self._stat_function(
            "median", nanops.nanmedian, axis, skipna, level, numeric_only,
    **kwargs
        )
    ...
    is "
                "deprecated and will be removed in a future version. Use
    groupby "
                "instead. df.sum(level=1) should use
    ...
    def sum(
        ...
        **kwargs,
        ...
        return self._min_count_stat_function(
            "sum", nanops.nansum, axis, skipna, level, numeric_only,
    min_count, **kwargs
        )
    ...
    df.mean()).abs().mean()`."
        ...
        if not is_bool(skipna):
            warnings.warn(
                "Passing None for skipna is deprecated and will raise in a
    future"
                "version. Pass True instead. Only boolean values will be
    allowed "
                "in the future.",
                FutureWarning,
                stacklevel=find_stack_level(),
    ...
    is "
                "deprecated and will be removed in a future version. Use
    groupby "
                "instead. df.mad(level=1) should use
    df.groupby(level=1).mad()",
                FutureWarning,
                stacklevel=find_stack_level(),
            )
    ...
    **kwargs):
        ...
        # error: Argument 1 to "doc" has incompatible type "Optional[str]";
    expected
        ...
        def sem(
            ...
            **kwargs,
            ...
            return NDFrame.sem(self, axis, skipna, level, ddof, numeric_only,
    **kwargs)
    ...
    by "
        ...
        def var(
            ...
            **kwargs,
            ...
            return NDFrame.var(self, axis, skipna, level, ddof, numeric_only,
    **kwargs)
        ...
        def std(
            ...
            **kwargs,
            ...
            return NDFrame.std(self, axis, skipna, level, ddof, numeric_only,
    **kwargs)
    ...
    **kwargs)
        ...
        @doc(
            _num_doc,
            desc="Return the maximum of the values over the requested
    axis.\n\n"
    ...
    **kwargs)
        ...
        @doc(
            _num_doc,
            desc="Return the minimum of the values over the requested
    axis.\n\n"
    ...
    **kwargs)
    ...
    def expanding(
        ...
        if center is not None:
            warnings.warn(
                "The `center` argument on `expanding` will be removed in the
    future.",
                FutureWarning,
                stacklevel=find_stack_level(),
            )
    ...
    def __iadd__(self: NDFrameT, other) -> NDFrameT:
        ...
        return self._inplace_method(other, type(self).__add__)  # type:
    ignore[operator]

    def __isub__(self: NDFrameT, other) -> NDFrameT:
        # error: Unsupported left operand type for - ("Type[NDFrame]")
        return self._inplace_method(other, type(self).__sub__)  # type:
    ignore[operator]

    def __imul__(self: NDFrameT, other) -> NDFrameT:
        # error: Unsupported left operand type for * ("Type[NDFrame]")
        return self._inplace_method(other, type(self).__mul__)  # type:
    ignore[operator]
    ...
    def __imod__(self: NDFrameT, other) -> NDFrameT:
        # error: Unsupported left operand type for % ("Type[NDFrame]")
        return self._inplace_method(other, type(self).__mod__)  # type:
    ignore[operator]

    def __ipow__(self: NDFrameT, other) -> NDFrameT:
        # error: Unsupported left operand type for ** ("Type[NDFrame]")
        return self._inplace_method(other, type(self).__pow__)  # type:
    ignore[operator]

    def __iand__(self: NDFrameT, other) -> NDFrameT:
        # error: Unsupported left operand type for & ("Type[NDFrame]")
        return self._inplace_method(other, type(self).__and__)  # type:
    ignore[operator]

    def __ior__(self: NDFrameT, other) -> NDFrameT:
        # error: Unsupported left operand type for | ("Type[NDFrame]")
        return self._inplace_method(other, type(self).__or__)  # type:
    ignore[operator]

    def __ixor__(self: NDFrameT, other) -> NDFrameT:
        # error: Unsupported left operand type for ^ ("Type[NDFrame]")
        return self._inplace_method(other, type(self).__xor__)  # type:
    ignore[operator]
    ...
    def first_valid_index(self) -> Hashable | None:
        """
        Return index for {position} non-NA value or None, if no non-NA value
    is found.
...
def _doc_params(cls):
    ...
    axis_descr = (
        f"{{{', '.join([f'{a} ({i})' for i, a in
    enumerate(cls._AXIS_ORDERS)])}}}"
    )
...
numeric_only: bool, default None
    ...
    .. deprecated:: 1.5.0
        Specifying ``numeric_only=None`` is deprecated. The default value will
    be
...
_sum_examples = _shared_docs["stat_func_example"].format(
    stat_func="sum", verb="Sum", default_output=14, level_output_0=6,
    level_output_1=8
)
...
_max_examples: str = _shared_docs["stat_func_example"].format(
    stat_func="max", verb="Max", default_output=8, level_output_0=4,
    level_output_1=8
)

_min_examples: str = _shared_docs["stat_func_example"].format(
    stat_func="min", verb="Min", default_output=0, level_output_0=2,
    level_output_1=0
)
