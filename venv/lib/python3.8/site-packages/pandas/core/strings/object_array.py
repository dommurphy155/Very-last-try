...
class ObjectStringArrayMixin(BaseStringArrayMethods):
    ...
    def _str_map(
        self, f, na_value=None, dtype: NpDtype | None = None, convert: bool =
    True
    ):
        """
    ...
    def _str_removeprefix(self, prefix: str) -> Series:
        # outstanding question on whether to use native methods for users on
    Python 3.9+
        #
    ...
    def _str_extract(self, pat: str, flags: int = 0, expand: bool = True):
        ...
        def f(x):
            ...
            m = regex.search(x)
            if m:
                return [na_value if item is None else item for item in
    m.groups()]
            else:
                return empty_row
