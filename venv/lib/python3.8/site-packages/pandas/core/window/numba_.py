...
def generate_numba_apply_func(
    ...
    """
    Generate a numba jitted apply function specified by values from
    engine_kwargs.
            ...
            for j in range(1, len(window)):
                ...
                if not np.isnan(weighted):
                    ...
                    if is_observation or not ignore_na:
                        if normalize:
                            # note that len(deltas) = len(vals) - 1 and
    deltas[i]
...
def generate_numba_ewm_table_func(
    ...
    """
    Generate a numba jitted ewm mean or sum function applied table wise
    specified
