...
window_apply_parameters = dedent(
    ...
    engine: str, default None
        ...
        * ``'numba'``: Runs rolling apply through JIT compiled code from
    numba.
    ...
    or
          ``False``. The default ``engine_kwargs`` for the ``'numba'`` engine
    is
          ``{{'nopython': True, 'nogil': False, 'parallel': False}}`` and will
    be
...
numba_notes = (
    ...
    "extended documentation and performance considerations for the Numba
    engine.\n\n"
)
