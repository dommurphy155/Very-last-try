...
class Series(base.IndexOpsMixin, NDFrame):
    ...
    the
        index is not None, the resulting Series is reindexed with the index
    values.
    ...
    Notes
    -----
    Please reference the:ref:`User Guide <basics.series>` for more
    information.
    ...
    instead "
                    "of 'float64' in a future version. Specify a dtype
    explicitly "
    ...
    def _init_dict(
        ...
        if data:
            # GH:34717, issue was using zip to extract key and values from
    data.
            # using generators in effects the performance.
            # Below is the new way of extracting the keys and values

            keys = tuple(data.keys())
            values = list(data.values())  # Generating list of values- faster
    way
    ...
    has
            # incompatible type "Tuple[Any, ...]"; expected
    "Union[ExtensionArray,
            # ndarray, Index, None]"
            values,
    ...
    def name(self) -> Hashable:
        ...
        label (hashable object)
            The name of the Series, also the column name if part of a
    DataFrame.
    ...
    def values(self):
        ...
        .. warning::
           ...
           We recommend using:attr:`Series.array` or:meth:`Series.to_numpy`, depending on whether you need
    ...
    def _values(self):
        """
        Return the internal repr of this data (defined by
    Block.interval_values).
        ...
        ``.values`` while it returns an ExtensionArray for ``._values`` in
    those
        cases).
    ...
    frozensets
                ...
                if isinstance(key, tuple) and isinstance(self.index,
    MultiIndex):
    ...
    "
                        "with a Float64Index is deprecated. In a future
    version, "
    ...
    MultiIndex):
            ...
            if com.is_bool_indexer(key):
                ...
                # otherwise with listlike other we interpret series[mask] =
    other
    ...
    def _maybe_update_cacher(
        self, clear: bool = False, verify_is_copy: bool = True, inplace: bool
    = False
    ) -> None:
        """
...
"""
    ...
    ser.groupby(level=1).count().",
            ...
            if not isinstance(self.index, MultiIndex):
                raise ValueError("Series.count level is only valid with a
    MultiIndex")
        ...
        out = np.bincount(obs, minlength=len(lev) or None)  # type:
    ignore[arg-type]
    ...
    def unique(self) -> ArrayLike:
        ...
        extension-array backed Series, a new:class:`~api.extensions.ExtensionArray` of that type with just
    ...
    @overload
    def drop_duplicates(
        self, keep: Literal["first", "last", False] = ..., *, inplace:
    Literal[True]
    ) -> None:
        ...
    ...
    def quantile(
        ...
        numpy.percentile: Returns the q-th percentile(s) of the array
    elements.
    ...
    numeric_only=False)
        ...
        if is_list_like(q):
            ...
            return self._constructor(result, index=Float64Index(q),
    name=self.name)
        else:
            # scalar
    ...
    will be
        ...
        method: {'pearson', 'kendall', 'spearman'} or callable
            ...
            - callable: Callable with input two 1d ndarrays and returning a
    float.
    ...
    <https://en.wikipedia.org/wiki/Spearman%27s_rank_correlation_coefficient>`_
        ...
        if method in ["pearson", "spearman", "kendall"] or callable(method):
            return nanops.nancorr(
                this.values, other.values, method=method,
    ...
    def append(
        self, to_append, ignore_index: bool = False, verify_integrity: bool =
    False
    ) -> Series:
        """
    ...
    DataFrame"
            raise TypeError(msg)
        return concat(
            to_concat, ignore_index=ignore_index,
    ...
    def _binop(self, other: Series, func, level=None, fill_value=None):
        ...
        fill_value: float or object
            ...
            location, the result will be NA regardless of the passed fill
    value.
        level: int or level name, default None
    ...
    def _construct_result(
        ...
        # Set the result's name after __finalize__ is called because
    __finalize__
...
""",
    ...
    def argsort(
        ...
        axis: {0 or 'index'}
            Unused. Parameter needed for compatibility with DataFrame.
        kind: {'mergesort', 'quicksort', 'heapsort', 'stable'}, default
    'quicksort'
    ...
    def swaplevel(self, i: Level = -2, j: Level = -1, copy: bool = True) ->
    Series:
        """
    ...
    will
        result in a np.nan for that row. In addition, the ordering of elements
    in
    ...
    kwargs
        ...
        op = SeriesApply(self, func, convert_dtype=False, args=args,
    kwargs=kwargs)
        result = op.agg()
        return result
    ...
    def _reindex_indexer(
        self, new_index: Index | None, indexer: npt.NDArray[np.intp] | None,
    copy: bool
    ) -> Series:
    ...
    def rename(
        ...
        *,
        ...
        inplace: bool, default False
            Whether to return a new Series. If True the value of copy is
    ignored.
        level: int or level name, default None
            In case of MultiIndex, only rename labels in the specified level.
        errors: {'ignore', 'raise'}, default 'ignore'
            If 'raise', raise `KeyError` when a `dict-like mapper` or
            `index` contains labels that are not present in the index being
    transformed.
    ...
    def reindex(self, *args, **kwargs) -> Series:
        if len(args) > 1:
            raise TypeError("Only one positional argument ('index') is
    allowed")
        if args:
            (index,) = args
            if "index" in kwargs:
    ...
    @doc(NDFrame.shift, klass=_shared_doc_kwargs["klass"])  # type:
    ignore[has-type]
    def shift(
        self, periods: int = 1, freq=None, axis: Axis = 0, fill_value:
    Hashable = None
    ) -> Series:
        return super().shift(
    ...
    "Literal['both',
        ...
        if inclusive is True or inclusive is False:  # type:
    ...
    def _convert_dtypes(
        ...
        if convert_string or convert_integer or convert_boolean or
    convert_floating:
    ...
    # error: Return type "Series" of "isna" incompatible with return type
    "ndarray
    # [Any, dtype[bool_]]" in supertype "IndexOpsMixin"
    @doc(NDFrame.isna, klass=_shared_doc_kwargs["klass"])  # type:
    ignore[has-type]
    ...
    @doc(NDFrame.notna, klass=_shared_doc_kwargs["klass"])  # type:
    ignore[has-type]
    ...
    @overload
    def dropna(
        self, *, axis: Axis = ..., inplace: Literal[False] = ..., how: str |
    None = ...
    ) -> Series:
        ...
