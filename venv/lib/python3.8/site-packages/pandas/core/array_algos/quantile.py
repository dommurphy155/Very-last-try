...
def quantile_with_mask(
    ...
    mask: np.ndarray[bool]
        mask = isna(values)
        For ExtensionArray, this is computed before calling
    _value_for_factorize
    fill_value: Scalar
    ...
    if values.ndim == 1:
        ...
        res_values = quantile_with_mask(values, mask, fill_value, qs,
    interpolation)
        return res_values[0]
...
def _nanpercentile_1d(
    ...
    return np.percentile(
        ...
        **{np_percentile_argname: interpolation},  # type:
