...
def to_timedelta(
    ...
    arg: str, timedelta, list-like or Series
        ...
        .. deprecated:: 1.2
            ...
            unambiguous timedelta values and will be removed in a future
    version
    ...
    Notes
    -----
    If the precision is higher than nanoseconds, the precision of the duration
    is
    ...
    if errors not in ("ignore", "raise", "coerce"):
        raise ValueError("errors must be one of 'ignore', 'raise', or
    'coerce'.")
    ...
    "object",
        ...
        # Tuple[Any, ...], Union[Union[ExtensionArray, ndarray[Any, Any]],
    Index,
        # Series]]")  [assignment]
        ...
        raise TypeError(
            "arg must be a string, timedelta, list, tuple, 1-d array, or
    Series"
        )

    if isinstance(arg, str) and unit is not None:
        raise ValueError("unit must not be specified if the input is/contains
    a str")
...
def _convert_listlike(arg, unit=None, errors="raise", name=None):
    ...
    try:
        td64arr = sequence_to_td64ns(arg, unit=unit, errors=errors,
    copy=False)[0]
    except ValueError:
        if errors == "ignore":
            return arg
