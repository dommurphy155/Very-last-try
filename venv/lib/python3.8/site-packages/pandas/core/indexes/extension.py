...
def _inherit_from_data(
    ...
    if isinstance(attr, property) or type(attr).__name__ ==
    "getset_descriptor":
    ...
    "Callable[[Any,
        ...
        def method(self, *args, **kwargs):  # type: ignore[misc]
            if "inplace" in kwargs:
                raise ValueError(f"cannot use inplace with
    {type(self).__name__}")
...
def inherit_names(
    ...
    """
    Class decorator to pin attributes from an ExtensionArray to a Index
    subclass.
