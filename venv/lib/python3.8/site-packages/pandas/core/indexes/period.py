...
class PeriodIndex(DatetimeIndexOpsMixin):
    ...
    @cache_readonly
    # Signature of "_resolution_obj" incompatible with supertype
    ...
    def __new__(
        ...
        **fields,
        ...
        if not set(fields).issubset(valid_field_set):
            ...
            raise TypeError(f"__new__() got an unexpected keyword argument
    {argument}")
    ...
    def asof_locs(self, where: Index, mask: npt.NDArray[np.bool_]) ->
    np.ndarray:
        """
        ...
        if isinstance(where, DatetimeIndex):
            ...
            raise TypeError("asof_locs `where` must be DatetimeIndex or
    PeriodIndex")
    ...
    def get_loc(self, key, method=None, tolerance=None):
        ...
        if is_valid_na_for_dtype(key, self.dtype):
            ...
            if reso == self._resolution_obj:
                ...
                # Recursing instead of falling through matters for the
    exception
    ...
    def _parsed_string_to_bounds(self, reso: Resolution, parsed: datetime):
        ...
        return (iv.asfreq(self.freq, how="start"), iv.asfreq(self.freq,
    how="end"))
...
def period_range(
    ...
    if freq is None and (not isinstance(start, Period) and not isinstance(end,
    Period)):
        freq = "D"
