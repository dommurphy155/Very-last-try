...
class RangeIndex(NumericIndex):
    ...
    def from_range(
        ...
        if not isinstance(data, range):
            raise TypeError(
                f"{cls.__name__}(...) must be called with object coercible to
    a "
    ...
    # error: Return type "Type[Int64Index]" of "_constructor" incompatible
    with return
    ...
    def _minmax(self, meth: str):
        ...
        if no_steps == -1:
            return np.nan
        elif (meth == "min" and self.step > 0) or (meth == "max" and self.step
    < 0):
            return self.start
    ...
    def _intersection(self, other: Index, sort=False):
        ...
        tmp_start = first.start + (second.start - first.start) * first.step //
    gcd * s
    ...
    def _union(self, other: Index, sort):
        ...
        if isinstance(other, RangeIndex):
            if sort is None or (
                sort is False and self.step > 0 and
    self._range_in_self(other._range)
            ):
                ...
                if step_o == step_s:
                    ...
                    if (
                        ...
                        return type(self)(start_r, end_r + step_s / 2, step_s
    / 2)
    ...
    def symmetric_difference(self, other, result_name: Hashable = None,
    sort=None):
    ...
    def _concat(self, indexes: list[Index], name: Hashable) -> Index:
        ...
        for obj in non_empty_indexes:
            ...
            if non_consecutive:
                result = Int64Index(np.concatenate([x._values for x in
    rng_indexes]))
                return result.rename(name)
    ...
    def __floordiv__(self, other):
        ...
        if is_integer(other) and other != 0:
            if len(self) == 0 or self.start % other == 0 and self.step % other
    == 0:
