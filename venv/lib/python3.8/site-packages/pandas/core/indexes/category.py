...
class CategoricalIndex(NDArrayBackedExtensionIndex):
    ...
    ...     ["a", "b", "c", "a", "b", "c"], ordered=True, categories=["c",
    "b", "a"]
    ... )
    >>> ci
    CategoricalIndex(['a', 'b', 'c', 'a', 'b', 'c'],
    ...
    def __new__(
        ...
        data = Categorical(
            data, categories=categories, ordered=ordered, dtype=dtype,
    copy=copy
        )
    ...
    def _is_dtype_compat(self, other) -> Categorical:
        ...
        *this is an internal non-public method*
        ...
        if is_categorical_dtype(other):
            ...
            raise TypeError("MultiIndex is not dtype-compatible with
    CategoricalIndex")
        else:
            values = other
    ...
    def astype(self, dtype: Dtype, copy: bool = True) -> Index:
        ...
        # the super method always returns Int64Index, UInt64Index and
    Float64Index
        # but if the categories are a NumericIndex with dtype float32, we want
    to
        ...
        if categories._is_backward_compat_public_numeric_index:
            ...
            try:
                ...
                return categories._constructor(new_values, name=self.name,
    copy=False)
    ...
    "
        ...
        if is_categorical_dtype(target):
            ...
            # e.g. test_reindex_with_categoricalindex,
    ...
    def map(self, mapper):
        ...
        categories. If the mapping correspondence is one-to-one the result is a:class:`~pandas.CategoricalIndex` which has the same order property as
