...
@inherit_names(
    ["__neg__", "__pos__", "__abs__", "total_seconds", "round", "floor",
    "ceil"]
...
class TimedeltaIndex(DatetimeTimedeltaMixin):
    ...
    def __new__(
        ...
        if unit in {"Y", "y", "M"}:
            raise ValueError(
                "Units 'M', 'Y', and 'y' are no longer supported, as they do
    not "
        ...
        if isinstance(data, TimedeltaIndex) and freq is lib.no_default and
    name is None:
            if copy:
                return data.copy()
            else:
    ...
    def _is_comparable_dtype(self, dtype: DtypeObj) -> bool:
        ...
        """
        return is_timedelta64_dtype(dtype)  # aka
    self._data._is_recognized_dtype
