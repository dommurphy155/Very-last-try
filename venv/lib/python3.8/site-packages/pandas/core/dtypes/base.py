...
class ExtensionDtype:
    ...
    **If you have a parametrized dtype you should set the ``_metadata``
    ...
    def __hash__(self) -> int:
        ...
        return object_hash(tuple(getattr(self, attr) for attr in
    self._metadata))
    ...
    def construct_from_string(
        ...
        # error: Non-overlapping equality check (left operand type: "str",
    right
...
class Registry:
    ...
    *:meth:`pandas.Series.astype`
    ...
    def find(
        ...
        Parameters
        ----------
        dtype: ExtensionDtype class or instance or str or numpy dtype or
    python type
