...
def create_pandas_abc_type(name, attr, comp):
    ...
    dct = {"__instancecheck__": _instancecheck, "__subclasscheck__":
    _subclasscheck}
...
ABCCategoricalIndex = cast(
    ...
    create_pandas_abc_type("ABCCategoricalIndex", "_typ",
    ("categoricalindex",)),
)
...
ABCDataFrame = cast(
    "Type[DataFrame]", create_pandas_abc_type("ABCDataFrame", "_typ",
    ("dataframe",))
)
...
ABCExtensionArray = cast(
    ...
    _typ="extension"
        {"extension", "categorical", "periodarray", "datetimearray",
    "timedeltaarray"},
    ),
)
ABCPandasArray = cast(
