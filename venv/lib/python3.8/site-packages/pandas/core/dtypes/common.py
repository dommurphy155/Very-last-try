...
def is_string_dtype(arr_or_dtype) -> bool:
    ...
    def is_excluded_dtype(dtype) -> bool:
        """
        These have kind = "O" but aren't string dtypes so need to be
    explicitly excluded
        """
        return isinstance(dtype, (PeriodDtype, IntervalDtype,
    CategoricalDtype))
...
def is_integer_dtype(arr_or_dtype) -> bool:
    ...
    False
    """
    return _is_dtype_type(arr_or_dtype,
    classes_and_not_datetimelike(np.integer))
...
def is_signed_integer_dtype(arr_or_dtype) -> bool:
    ...
    """
    return _is_dtype_type(arr_or_dtype,
    classes_and_not_datetimelike(np.signedinteger))
...
def is_datetime64_ns_dtype(arr_or_dtype) -> bool:
    ...
    False
    >>> is_datetime64_ns_dtype(np.array([], dtype="datetime64[ps]"))  # wrong
    unit
    False
