...
if TYPE_CHECKING:
    ...
    from pandas.core.interchange.dataframe_protocol import DataFrame as
    DataFrameXchg
...
class DataFrame(NDFrame, OpsMixin):
    ...
    objects. If
        data is a dict, column order follows insertion-order. If a dict
    contains Series
    ...
    typ=manager)
            ...
            if data.dtype.names:
                ...
                mgr = dict_to_mgr(
                    # error: Item "ndarray" of "Union[ndarray, Series, Index]"
    has no
                    # attribute "name"
            ...
            if len(data) > 0:
                ...
                if not isinstance(data, np.ndarray) and treat_as_nested(data):
                    ...
                    arrays, columns, index = nested_data_to_arrays(
                        # error: Argument 3 to "nested_data_to_arrays" has
    incompatible
    ...
    def _values(  # type: ignore[override]
        ...
        if isinstance(mgr, ArrayManager):
            if len(mgr.arrays) == 1 and not
    is_1d_only_ea_dtype(mgr.arrays[0].dtype):
                # error: Item "ExtensionArray" of "Union[ndarray,
    ExtensionArray]"
        ...
        arr = cast("np.ndarray | DatetimeArray | TimedeltaArray |
    PeriodArray", arr)
        return arr.T
    ...
    def _repr_fits_horizontal_(self, ignore_width: bool = False) -> bool:
        ...
        # dims
        if ignore_width or width is None or not
    ...
    @Substitution(
        ...
        col_space="The minimum width of each column. If a list of ints is
    given "
        "every integers corresponds with one column. If a dict is given, the
    key "
    ...
    def to_string(
        ...
        max_colwidth: int, optional
            Max width to truncate each column in characters. By default, no
    limit.
    ...
    DataFrame.
        ...
        See Also
        --------
        io.formats.style.Styler: Helps style a DataFrame or Series according
    to the
    ...
    def iterrows(self) -> Iterable[tuple[Hashable, Series]]:
        ...
        See Also
        --------
        DataFrame.itertuples: Iterate over DataFrame rows as namedtuples of
    the values.
    ...
    def dot(self, other: AnyArrayLike | DataFrame) -> DataFrame | Series:
        ...
        if isinstance(other, (Series, DataFrame)):
            ...
            if len(common) > len(self.columns) or len(common) >
    len(other.index):
            ...
            if lvals.shape[1] != rvals.shape[0]:
                raise ValueError(
                    f"Dot product shape mismatch, {lvals.shape} vs
    {rvals.shape}"
                )
    ...
    @overload
    def __matmul__(self, other: AnyArrayLike | DataFrame) -> DataFrame |
    Series:
        ...
    ...
    type
            ...
            if columns is not None:
                raise ValueError(f"cannot use columns parameter with
    orient='{orient}'")
        else:  # pragma: no cover
            raise ValueError(
    ...
    @overload
    def to_dict(self, orient: Literal["records"], into: type[dict] = ...) ->
    list[dict]:
        ...
    ...
    [None]}
        ...
        if not self.columns.is_unique:
            warnings.warn(
                "DataFrame columns are not unique, some columns will be
    omitted.",
                UserWarning,
                stacklevel=find_stack_level(),
            )
        ...
        # variable has type "Literal['dict', 'list', 'series', 'split',
    'tight',
        # 'records', 'index']")
        ...
        if orient.startswith(("d", "l", "s", "r", "i")) and orient not in {
            ...
            warnings.warn(
                ...
                "options: ('dict', list, 'series', 'split', 'records',
    'index') "
        ...
        if orient == "dict":
            ...
            return into_c(
                (k, list(map(maybe_box_native, v.tolist()))) for k, v in
    self.items()
            )
            ...
            return [
                into_c((k, maybe_box_native(v)) for k, v in row.items()) for
    row in rows
            ]

        elif orient == "index":
            if not self.index.is_unique:
                raise ValueError("DataFrame index must be unique for
    orient='index'.")
            return into_c(
    ...
    <https://developers.googleblog.com/2022/02/making-oauth-flows-safer.html?m=1#disallowed-oob>`_.
        ...
        credentials: google.auth.credentials.Credentials, optional
            ...
            override default credentials, such as to use Compute Engine:class:`google.auth.compute_engine.Credentials` or Service
    ...
    def from_records(
        ...
        def maybe_reorder(
            ...
            """
            If our desired 'columns' do not match the data's pre-existing
    'arr_columns',
            we re-order our arrays.  This is like a pre-emptive (cheap)
    reindex.
            """
            if len(arrays):
                length = len(arrays[0])
    ...
    length)
        ...
        if index is not None:
            if isinstance(index, str) or not hasattr(index, "__iter__"):
                ...
                try:
                    index_data = [arrays[arr_columns.get_loc(field)] for field
    in index]
    ...
    self.columns)]
            ...
            arrays = [np.asarray(self.iloc[:, i]) for i in
    range(len(self.columns))]
        ...
        for i, v in enumerate(arrays):
            ...
            if dtype_mapping is None:
                ...
                msg = f"Invalid dtype {dtype_mapping} specified for {element}
    {name}"
    ...
    value
        ...
        if version not in (114, 117, 118, 119, None):
            raise ValueError("Only formats 114, 117, 118 and 119 are
    supported.")
        if version == 114:
    ...
    @deprecate_kwarg(old_arg_name="fname", new_arg_name="path")
    def to_feather(self, path: FilePath | WriteBuffer[bytes], **kwargs) ->
    None:
        """
        ...
        path: str, path object, file-like object
            String, path object (implementing ``os.PathLike[str]``), or
    file-like
            object implementing a binary ``write()`` function. If a string or
    a path,
    ...
    dataset.
        **kwargs:
        ...
        <https://arrow.apache.org/docs/python/feather.html>`_. Requires a
    default
        index. For saving the DataFrame with your custom index use a method
    that
    ...
    def to_parquet(
        ...
        **kwargs,
        ...
        backends, and have the option of compression. See:ref:`the user guide <io.parquet>` for more details.
        ...
        path: str, path object, file-like object, or None, default None
            String, path object (implementing ``os.PathLike[str]``), or
    file-like
            object implementing a binary ``write()`` function. If None, the
    result is
    ...
    io.BytesIO
        object, as long as you don't use partition_cols, which creates
    multiple files.
    ...
    def to_orc(
        ...
        *,
        ...
        ------
        NotImplementedError
            Dtype of one or more columns is category, unsigned integers,
    interval,
            period or sparse.
        ValueError
        ...
        * Before using this function you should read the:ref:`user guide about
          ORC <io.orc>` and:ref:`install optional dependencies
    <install.warn_orc>`.
    ...
    <https://arrow.apache.org/docs/python/>`_
        ...
        * Currently timezones in datetime columns are not preserved when a
        ...
        If you want to get a buffer to the orc content you can write it to
    io.BytesIO
        >>> import io
    ...
    None,
        ...
        Parameters
        ----------
        path_or_buffer: str, path object, file-like object, or None, default
    None
            String, path object (implementing ``os.PathLike[str]``), or
    file-like
    ...
    def info(
        ...
        if null_counts is not None:
            if show_counts is not None:
                raise ValueError("null_counts used with show_counts. Use
    show_counts.")
            warnings.warn(
    ...
    def memory_usage(self, index: bool = True, deep: bool = False) -> Series:
        ...
        result = self._constructor_sliced(
            [c.memory_usage(index=False, deep=deep) for col, c in
    self.items()],
            index=self.columns,
            dtype=np.intp,
        )
    ...
    def transpose(self, *args, copy: bool = False) -> DataFrame:
        ...
        and vice-versa. The property:attr:`.T` is an accessor to the method:meth:`transpose`.
    ...
    columns=self.index)
            ...
            self._is_homogeneous_type and dtypes and
    is_extension_array_dtype(dtypes[0])
        ):
    ...
    transpose.
            ...
            new_values = [arr_type._from_sequence(row, dtype=dtype) for row in
    values]
            ...
            result = self._constructor(new_arr, index=self.columns,
    columns=self.index)
    ...
    def _ixs(self, i: int, axis: int = 0) -> Series:
        ...
        if axis == 0:
            ...
            copy = isinstance(new_mgr.array, np.ndarray) and
    new_mgr.array.base is None
            result = self._constructor_sliced(new_mgr,
    name=self.index[i]).__finalize__(
                self
            )
    ...
    def _iter_column_arrays(self) -> Iterator[ArrayLike]:
        ...
        This returns the values as stored in the Block (ndarray or
    ExtensionArray).
    ...
    def _get_value(self, index, col, takeable: bool = False) -> Scalar:
        ...
        if not isinstance(self.index, MultiIndex):
            # CategoricalIndex: Trying to use the engine fastpath may give
    incorrect
    ...
    def _setitem_array(self, key, value):
        ...
        if com.is_bool_indexer(key):
            ...
            if len(key) != len(self.index):
                raise ValueError(
                    f"Item wrong length {len(key)} instead of
    {len(self.index)}!"
                )
            key = check_bool_indexer(self.index, key)
            indexer = key.nonzero()[0]
    ...
    def _set_item_frame_value(self, key, value: DataFrame) -> None:
        ...
        if key in self.columns:
            ...
            if isinstance(self.columns, MultiIndex) and isinstance(
                ...
                if len(cols_droplevel) and not
    cols_droplevel.equals(value.columns):
    ...
    @overload
    def query(self, expr: str, *, inplace: Literal[False] = ..., **kwargs) ->
    DataFrame:
        ...
    ...
    @overload
    def query(self, expr: str, *, inplace: bool = ..., **kwargs) -> DataFrame
    | None:
        ...
    ...
    names
            by surrounding them in backticks. Thus, column names containing
    spaces
            or punctuations (besides underscores) or starting with digits must
    be
            surrounded by backticks. (For example, a column named "Area
    (cm^2)" would
    ...
    spaces.
        ...
        **kwargs
        ...
        Notes
        -----
        The result of the evaluation of this expression is first passed to:attr:`DataFrame.loc` and if that fails because of a
        ...
        (bitwise) operators have the precedence of their boolean cousins,:keyword:`and` and:keyword:`or`. This *is* syntactically valid Python,
        ...
        The:attr:`DataFrame.index` and:attr:`DataFrame.columns` attributes of the:class:`~pandas.DataFrame` instance are placed in the query namespace
    ...
    identifier.
        These characters include all operators in Python, the space character,
    the
        question mark, the exclamation mark, the dollar sign, and the euro
    sign.
    ...
    @overload
    def eval(self, expr: str, *, inplace: Literal[False] = ..., **kwargs) ->
    Any:
        ...
    ...
    nonempty")
        ...
        def check_int_infer_dtype(dtypes):
            ...
            for dtype in dtypes:
                # Numpy maps int to different types (int32, in64) on Windows
    and Linux
                # see https://github.com/numpy/numpy/issues/9464
                if (isinstance(dtype, str) and dtype == "int") or (dtype is
    int):
    ...
    Numpy 1.20
        ...
        if not include.isdisjoint(exclude):
            raise ValueError(f"include and exclude overlap on {(include &
    exclude)}")
    ...
    def lookup(
        self, row_labels: Sequence[IndexLabel], col_labels:
    Sequence[IndexLabel]
    ) -> np.ndarray:
        """
        ...
        .. deprecated:: 1.2.0
            ...
            For further details see:ref:`Looking up values by index/column labels <indexing.lookup>`.
        ...
        if not (self.index.is_unique and self.columns.is_unique):
            # GH#33041
            raise ValueError("DataFrame.lookup requires unique index and
    columns")
    ...
    def _reindex_index(
        ...
        new_index, indexer = self.index.reindex(
            new_index, method=method, level=level, limit=limit,
    tolerance=tolerance
        )
    ...
    def _reindex_columns(
        ...
        new_columns, indexer = self.columns.reindex(
            new_columns, method=method, level=level, limit=limit,
    tolerance=tolerance
        )
        return self._reindex_with_indexers(
    ...
    def _reindex_multi(
        ...
        if row_indexer is not None and col_indexer is not None:
            ...
            new_values = take_2d_multi(self.values, indexer,
    fill_value=fill_value)
    ...
    GH#38434
            ...
            if periods > 0:
                ...
                for col in range(min(ncols, abs(periods))):
                    ...
                    result.insert(
                        len(result.columns), label, filler,
    allow_duplicates=True
            ...
            if len(arrays) > 1 or (
                ...
                and not (
                    lib.is_integer(fill_value) and
    needs_i8_conversion(arrays[0].dtype)
                )
            ):
    ...
    def set_index(
        ...
        for col in keys:
            if isinstance(col, (Index, Series, np.ndarray, list,
    abc.Iterator)):
    ...
    def reset_index(
        ...
        names: int, str or 1-dimensional list, default None
            Using the given string, rename the DataFrame column which contains
    the
            index data. If the DataFrame has a MultiIndex, this has to be a
    list or
    ...
    "allow_duplicates")
        ...
        if not drop:
            ...
            for i, (lev, lab) in reversed(list(enumerate(to_insert))):
                ...
                name = names[i]
                if multi_col:
                    col_name = list(name) if isinstance(name, tuple) else
    [name]
                    if col_fill is None:
                ...
                if lab is not None:
                    ...
                    level_values = algorithms.take(
                        level_values, lab, allow_fill=True,
    ...
    ``inplace=True``.
        ...
        if (how is not no_default) and (thresh is not no_default):
            raise TypeError(
                "You cannot set both the how and thresh arguments at the same
    time."
            )
        ...
        if isinstance(axis, (tuple, list)):
            # GH20987
            raise TypeError("supplying multiple axes to axis is no longer
    supported.")
    ...
    List[bool]]";
        ...
        if is_sequence(ascending) and (
            ...
            raise ValueError(
                f"Length of ascending ({len(ascending)})"  # type:
    ignore[arg-type]
    ...
    def nlargest(self, n: int, columns: IndexLabel, keep: str = "first") ->
    DataFrame:
        """
    ...
    def nsmallest(self, n: int, columns: IndexLabel, keep: str = "first") ->
    DataFrame:
        """
    ...
    @doc(
        ...
        Here, we will swap the levels column-wise, but levels can be swapped
    row-wise
        in a similar manner. Note that column-wise is the default behaviour.
        By not supplying any arguments for i and j, we swap the last and
    second to
        last indices.
        ...
        index with. We can for example swap the first index with the last one
    as
        follows.
    ...
    def swaplevel(self, i: Axis = -2, j: Axis = -1, axis: Axis = 0) ->
    DataFrame:
        result = self.copy()

        axis = self._get_axis_number(axis)

        if not isinstance(result._get_axis(axis), MultiIndex):  # pragma: no
    cover
    ...
    def reorder_levels(self, order: Sequence[Axis], axis: Axis = 0) ->
    DataFrame:
        """
    ...
    levels.
        ...
        """
        axis = self._get_axis_number(axis)
        if not isinstance(self._get_axis(axis), MultiIndex):  # pragma: no
    cover
    ...
    def _cmp_method(self, other, op):
        ...
        self, other = ops.align_method_FRAME(self, other, axis, flex=False,
    level=None)
    ...
    def _arith_method(self, other, op):
        ...
        self, other = ops.align_method_FRAME(self, other, axis, flex=True,
    level=None)
    ...
    def _dispatch_frame_op(self, right, func: Callable, axis: int | None =
    None):
        """
        ...
        if not is_list_like(right):
            ...
            with np.errstate(all="ignore"):
                bm = self._mgr.operate_blockwise(
                    # error: Argument 1 to "operate_blockwise" of
    "ArrayManager" has
                    # incompatible type "Union[ArrayManager, BlockManager]";
    expected
                    # "ArrayManager"
                    # error: Argument 1 to "operate_blockwise" of
    "BlockManager" has
    ...
    expected
            ...
            with np.errstate(all="ignore"):
                arrays = [array_op(left, right) for left in
...
""",
    ...
    def combine(
        ...
        for col in new_columns:
            ...
            if isinstance(new_dtype, np.dtype):
                # if new_dtype is an EA Dtype, then `func` is expected to
    return
                # the correct dtype without any additional casting
                # error: No overload variant of "maybe_downcast_to_dtype"
    matches
    ...
    def combine_first(self, other: DataFrame) -> DataFrame:
        ...
        -------
        DataFrame
            The result of combining the provided DataFrame with the other
    object.
    ...
    def update(
        ...
        if errors not in ["ignore", "raise"]:
            raise ValueError("The parameter errors must be either 'ignore' or
    'raise'")
...
When using ``.apply()``, use ``group_keys`` to include or exclude the group
    keys.
...
"""
    ...
    format.
        ...
        be object. Scalars will be returned unchanged, and empty list-likes
    will
        result in a np.nan for that row. In addition, the ordering of rows in
    the
        ...
        if len(columns) == 1:
            ...
            for c in columns[1:]:
                if not all(counts0 == self[c].apply(mylen)):
                    raise ValueError("columns must have matching element
    counts")
    ...
    def aggregate(self, func=None, axis: Axis = 0, *args, **kwargs):
        ...
        if relabeling:
            # This is to keep the order to columns occurrence unchanged, and
    also
    ...
    def _append(
        ...
        if isinstance(other, (Series, dict)):
            if isinstance(other, dict):
                if not ignore_index:
                    raise TypeError("Can only append a dict if
    ignore_index=True")
                other = Series(other)
    ...
    the order
        ...
        validate: str, optional
            ...
            * "one_to_one" or "1:1": check if join keys are unique in both left
            and right datasets.
            * "one_to_many" or "1:m": check if join keys are unique in left
    dataset.
            * "many_to_one" or "m:1": check if join keys are unique in right
    dataset.
            * "many_to_many" or "m:m": allowed, but does not result in checks.
            .. versionadded:: 1.5.0
    ...
    def _join_compat(
        ...
        if isinstance(other, DataFrame):
            ...
            if on is not None:
                raise ValueError(
                    "Joining multiple DataFrames only supported for joining on
    index"
                )
            ...
            # "Union[DataFrame, Series, Iterable[Union[DataFrame, Series]]]"
    whereas
            # the LHS is an "Iterable[DataFrame]", but in reality both types
    are
            ...
            if can_concat:
                if how == "left":
                    res = concat(
                        frames, axis=1, join="outer", verify_integrity=True,
    sort=sort
                    )
                    return res.reindex(self.index, copy=False)
                else:
                    return concat(
                        frames, axis=1, join=how, verify_integrity=True,
    sort=sort
                    )
    ...
    def round(
        self, decimals: int | dict[IndexLabel, int] | Series = 0, *args,
    **kwargs
    ) -> DataFrame:
        """
    ...
    Series")
        ...
        if len(new_cols) > 0:
            return self._constructor(
                concat(new_cols, axis=1), index=self.index,
    columns=self.columns
    ...
    <https://en.wikipedia.org/wiki/Spearman%27s_rank_correlation_coefficient>`_
        ...
        if numeric_only is lib.no_default and len(data.columns) <
    len(self.columns):
    ...
    future
        ...
        core.window.ewm.ExponentialMovingWindow.cov: Exponential weighted
    sample
            covariance.
    ...
    def corrwith(
        ...
        axis: {0 or 'index', 1 or 'columns'}, default 0
            The axis to use. 0 or 'index' to compute row-wise, 1 or 'columns'
    for
            column-wise.
        drop: bool, default False
    ...
    columns=columns)
        ...
        if numeric_only is lib.no_default and len(this.columns) <
    len(self.columns):
    ...
    def count(self, axis: Axis = 0, level: Level = None, numeric_only: bool =
    False):
        """
    ...
    groupby "
                "instead. df.count(level=1) should use
    df.groupby(level=1).count().",
                FutureWarning,
                stacklevel=find_stack_level(),
            )
            res = self._count_level(level, axis=axis,
    ...
    def _count_level(self, level: Level, axis: int = 0, numeric_only: bool =
    False):
        if numeric_only:
            frame = self._get_numeric_data()
        else:
        ...
        if not isinstance(count_axis, MultiIndex):
            raise TypeError(
                f"Can only count levels on hierarchical
    ...
    axis=axis)
        ...
        if axis == 1:
            result = self._constructor(counts, index=agg_axis,
    columns=level_index)
        else:
    ...
    def _reduce(
        ...
        **kwds,
        ...
        if numeric_only is None and name in ["mean", "median"]:
            ...
            if dtype_is_dt.any():
                warnings.warn(
                    "DataFrame.mean and DataFrame.median with
    numeric_only=None "
    ...
    def _reduce_axis1(self, name: str, func, skipna: bool) -> Series:
        """
        Special case for _reduce to try to avoid a potentially-expensive
    transpose.

        Apply the reduction block-wise along axis=1 and then reduce the
    resulting
        1D arrays.
        """
        if name == "all":
    ...
    def idxmin(
        ...
        res = data._reduce(
            nanops.nanargmin, "argmin", axis=axis, skipna=skipna,
    numeric_only=False
        )
        indices = res._values
        ...
        final_result = data._constructor_sliced(result,
    index=data._get_agg_axis(axis))
    ...
    def idxmax(
        ...
        res = data._reduce(
            nanops.nanargmax, "argmax", axis=axis, skipna=skipna,
    numeric_only=False
        )
        indices = res._values
    ...
    here
            # error: List item 0 has incompatible type "Union[float,
    Union[Union[
            # ExtensionArray, ndarray[Any, Any]], Index, Series],
    Sequence[float]]";
            # expected "float"
        ...
        if method == "single":
            # error: Argument "qs" to "quantile" of "BlockManager" has
    incompatible type
            # "Index"; expected "Float64Index"
            res = data._mgr.quantile(
                qs=q, axis=1, interpolation=interpolation  # type:
    ignore[arg-type]
            )
        elif method == "table":
    ...
    dtype=dtype)
            ...
            q_idx = np.quantile(  # type: ignore[call-overload]
                np.arange(len(data)), q, **{np_percentile_argname:
    interpolation}
            )
            ...
            if len(by) > 1:
                ...
                by = by[0]
                k = data._get_label_or_level_values(by)  # type:
    ignore[arg-type]
                indexer = nargsort(k)
    ...
    def isin(self, values: Series | DataFrame | Sequence | Mapping) ->
    DataFrame:
        """
        ...
        To check if ``values`` is *not* in the DataFrame, use the ``~``
    operator:
        ...
        if isinstance(values, dict):
            ...
            # error: Argument 2 to "isin" has incompatible type
    "Union[Sequence[Any],
    ...
    columns = properties.AxisProperty(axis=0, doc="The column labels of the
    DataFrame.")
    ...
    def _to_dict_of_blocks(self, copy: bool = True):
        ...
        """
        mgr = self._mgr
        # convert to BlockManager if needed -> this way support ArrayManager
    as well
    ...
    def ffill(  # type: ignore[override]
        ...
        return super().ffill(axis=axis, inplace=inplace, limit=limit,
    downcast=downcast)
    ...
    def bfill(  # type: ignore[override]
        ...
        return super().bfill(axis=axis, inplace=inplace, limit=limit,
    downcast=downcast)
