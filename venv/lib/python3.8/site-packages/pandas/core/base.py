...
class IndexOpsMixin(OpsMixin):
    ...
    def item(self):
        ...
        raise ValueError("can only convert an array of size 1 to a Python
    scalar")
    ...
    def array(self) -> ExtensionArray:
        ...
        For all remaining dtypes ``.array`` will be a:class:`arrays.NumpyExtensionArray` wrapping the actual ndarray
    ...
    **kwargs)
    ...
    110.0}})
        ...
        if isinstance(delegate, ExtensionArray):
            ...
            # error: Incompatible return value type (got "Union[int,
    ndarray]", expected
            # "int")
    ...
    def hasnans(self) -> bool:
        ...
        """
        # error: Item "bool" of "Union[bool, ndarray[Any, dtype[bool_]],
    NDFrame]"
    ...
    def _map_values(self, mapper, na_action=None):
        ...
        if is_extension_array_dtype(self.dtype) and hasattr(self._values,
    "map"):
    ...
    def unique(self):
        ...
        if not isinstance(values, np.ndarray):
            ...
            if (
                isinstance(self.dtype, np.dtype) and self.dtype.kind in ["m",
    "M"]
    ...
    def _memory_usage(self, deep: bool = False) -> int:
        ...
        if hasattr(self.array, "memory_usage"):
            ...
            return self.array.memory_usage(deep=deep)  # type:
    ignore[attr-defined]
    ...
    _shared_docs[
        ...
        >>> ser = pd.Series(pd.to_datetime(['3/11/2000', '3/12/2000',
    '3/13/2000']))
        >>> ser
        0   2000-03-11
        1   2000-03-12
