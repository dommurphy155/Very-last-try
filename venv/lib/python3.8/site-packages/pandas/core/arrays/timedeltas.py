...
class TimedeltaArray(dtl.TimelikeOps):
    ...
    def _simple_new(  # type: ignore[override]
        cls, values: np.ndarray, freq: BaseOffset | None = None,
    dtype=TD64NS_DTYPE
    ) -> TimedeltaArray:
    ...
    def _from_sequence_not_strict(
        ...
        assert unit not in ["Y", "y", "M"]  # caller is responsible for
    checking
    ...
    def sum(
        ...
        *,
        ...
        nv.validate_sum(
            (), {"dtype": dtype, "out": out, "keepdims": keepdims, "initial":
    initial}
        )
    ...
    def std(
        ...
        *,
        ...
        result = nanops.nanstd(self._ndarray, axis=axis, skipna=skipna,
    ddof=ddof)
    ...
    def _add_offset(self, other):
        ...
        raise TypeError(
            f"cannot add the type {type(other).__name__} to a
    {type(self).__name__}"
        )
    ...
    def __rtruediv__(self, other):
        ...
        if isinstance(other, self._recognized_scalars):
            ...
            raise TypeError(
                f"Cannot divide {type(other).__name__} by
    {type(self).__name__}"
            )
    ...
    def components(self) -> DataFrame:
        """
        Return a DataFrame of the individual resolution components of the
    Timedeltas.

        The components (days, hours, minutes seconds, milliseconds,
    microseconds,
...
def sequence_to_td64ns(
    ...
    unit: str, optional
        ...
        Must be un-specified if the data contains a str and
    ``errors=="raise"``.
...
def _validate_td64_dtype(dtype) -> DtypeObj:
    ...
    if not is_dtype_equal(dtype, TD64NS_DTYPE):
        raise ValueError(f"dtype {dtype} cannot be converted to
    timedelta64[ns]")
