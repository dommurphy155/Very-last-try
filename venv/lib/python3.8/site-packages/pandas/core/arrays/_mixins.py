...
class NDArrayBackedExtensionArray(NDArrayBacked, ExtensionArray):
    ...
    def view(self, dtype: Dtype | None = None) -> ArrayLike:
        ...
        # error: Argument "dtype" to "view" of "_ArrayOrScalarCommon" has
    incompatible
        # type "Union[ExtensionDtype, dtype[Any]]"; expected
    "Union[dtype[Any], None,
    ...
    def argmin(self, axis: int = 0, skipna: bool = True):  # type:
    ignore[override]
    ...
    def argmax(self, axis: int = 0, skipna: bool = True):  # type:
    ignore[override]
        # override base class by adding axis keyword
        validate_bool_kwarg(skipna, "skipna")
        if not skipna and self._hasna:
    ...
    def searchsorted(
        ...
        # TODO(2.0): use _validate_setitem_value once dt64tz
    mismatched-timezone
    ...
    "ExtensionArray",
        ...
        key = extract_array(key, extract_numpy=True)  # type:
    ignore[assignment]
        key = check_array_indexer(self, key)
        result = self._ndarray[key]
    ...
    @classmethod
    def _empty(
        cls: type_t[NDArrayBackedExtensionArrayT], shape: Shape, dtype:
    ExtensionDtype
    ) -> NDArrayBackedExtensionArrayT:
        """
