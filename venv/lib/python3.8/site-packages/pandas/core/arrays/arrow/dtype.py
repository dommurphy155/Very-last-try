...
class ArrowDtype(StorageExtensionDtype):
    ...
    def construct_from_string(cls, string: str) -> ArrowDtype:
        ...
        if string == "string[pyarrow]":
            ...
            raise TypeError("string[pyarrow] should be constructed by
    StringDtype")
        ...
        try:
            ...
            if has_parameters:
                raise NotImplementedError(
                    ...
                    f"({has_parameters.group()}) in the string is not
    supported. "
                    "Please construct an ArrowDtype object with a
    pyarrow_dtype "
                    "instance with specific parameters."
                ) from err
            raise TypeError(f"'{base_type}' is not a valid pyarrow data
    type.") from err
        return cls(pa_dtype)
