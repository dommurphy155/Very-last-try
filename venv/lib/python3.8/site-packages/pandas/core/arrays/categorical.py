...
def _cat_compare_op(op):
    ...
    def func(self, other):
        ...
        if isinstance(other, Categorical):
            ...
            msg = "Categoricals can only be compared if 'categories' are the
    same."
            if not self._categories_match_up_to_permutation(other):
                raise TypeError(msg)

            if not self.ordered and not
        ...
        if hashable:
            if other in self.categories:
                ...
                if opname not in {"__eq__", "__ge__", "__gt__"}:
                    # GH#29820 performance trick; get_loc will always give
    i>=0,
            ...
            if isinstance(other, ExtensionArray) and
    needs_i8_conversion(other.dtype):
...
class Categorical(NDArrayBackedExtensionArray, PandasObject,
    ...
    @classmethod
    def _from_sequence(cls, scalars, *, dtype: Dtype | None = None,
    copy=False):
    ...
    @overload
    def astype(self, dtype: ExtensionDtype, copy: bool = ...) ->
    ExtensionArray:
        ...
    ...
    def astype(self, dtype: AstypeArg, copy: bool = True) -> ArrayLike:
        ...
        if self.dtype is dtype:
            ...
            try:
                ...
                TypeError,  # downstream error msg for CategoricalIndex is
    misleading
                ValueError,
            ):
    ...
    def _from_inferred_categories(
        ...
        known_categories = (
            isinstance(dtype, CategoricalDtype) and dtype.categories is not
    None
        )
    ...
    def from_codes(
        ...
        if len(codes) and (codes.max() >= len(dtype.categories) or codes.min()
    < -1):
    ...
    def codes(self) -> np.ndarray:
        ...
        There is no setter, use the other categorical methods and the normal
    item
    ...
    def set_ordered(
        ...
        if inplace is not no_default:
            warn(
                ...
                "a future version. setting ordered-ness on categories will
    always "
    ...
    @overload
    def as_ordered(self, *, inplace: NoDefault | Literal[False] = ...) ->
    Categorical:
        ...
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self"])
    def as_ordered(self, inplace: bool | NoDefault = no_default) ->
    Categorical | None:
        """
    ...
    @overload
    def as_unordered(self, *, inplace: NoDefault | Literal[False] = ...) ->
    Categorical:
        ...
    ...
    @overload
    def rename_categories(self, new_categories, *, inplace: Literal[True]) ->
    None:
        ...
    ...
    def rename_categories(
        ...
        if is_dict_like(new_categories):
            new_categories = [new_categories.get(item, item) for item in
    cat.categories]
    ...
    @overload
    def add_categories(self, new_categories, *, inplace: Literal[True]) ->
    None:
        ...
    ...
    def add_categories(
        ...
        if len(already_included) != 0:
            raise ValueError(
                f"new categories must not include old categories:
    {already_included}"
            )
    ...
    removal_set]
        ...
        if len(not_included) != 0:
            raise ValueError(f"removals must all be in old categories:
    {not_included}")
    ...
    def map(self, mapper):
        ...
        try:
            return self.from_codes(
                self._codes.copy(), categories=new_categories,
    ...
    @overload
    def sort_values(
        self, *, inplace: Literal[True], ascending: bool = ..., na_position:
    str = ...
    ) -> None:
        ...
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self"])
    def sort_values(
        self, inplace: bool = False, ascending: bool = True, na_position: str
    = "last"
    ) -> Categorical | None:
        """
    ...
    def _codes(self, value: np.ndarray):
        warn(
            "Setting the codes on a Categorical is deprecated and will raise
    in "
    ...
    def _get_repr(self, length: bool = True, na_rep="NaN", footer: bool =
    True) -> str:
        from pandas.io.formats import format as fmt
    ...
    def mode(self, dropna: bool = True) -> Categorical:
        ...
        """
        warn(
            "Categorical.mode is deprecated and will be removed in a future
    version. "
    ...
    def unique(self):
        ...
        ['b', 'a', 'c']
        Categories (3, object): ['a', 'b', 'c']
        >>> pd.Categorical(list("baab"), categories=list("abc"),
    ordered=True).unique()
        ['b', 'a']
        Categories (3, object): ['a' < 'b' < 'c']
        """
    ...
    def _concat_same_type(
        cls: type[CategoricalT], to_concat: Sequence[CategoricalT], axis: int
    = 0
    ) -> CategoricalT:
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=["self",
    "value"])
    def replace(self, to_replace, value, inplace: bool = False) -> Categorical
    | None:
        """
        ...
        Returns
        -------
        None if inplace is True, otherwise the new Categorical after
    replacement
    ...
    def _replace(self, *, to_replace, value, inplace: bool = False):
        ...
        if is_list_like(to_replace):
            ...
            replace_dict = {replace_value: value for replace_value in
    to_replace}
        else:
    ...
    def _str_map(
        self, f, na_value=np.nan, dtype=np.dtype("object"), convert: bool =
    True
    ):
        ...
        categories = self.categories
        codes = self.codes
        result = PandasArray(categories.to_numpy())._str_map(f, na_value,
    dtype)
...
class CategoricalAccessor(PandasDelegate, PandasObject, NoNewAttributesMixin):
    ...
    def _validate(data):
        if not is_categorical_dtype(data.dtype):
            raise AttributeError("Can only use .cat accessor with a 'category'
    dtype")
...
def _get_codes_for_values(values, categories: Index) -> np.ndarray:
    ...
    If `values` is known to be a Categorical, use recode_for_categories
    instead.
    """
    if values.ndim > 1:
        flat = values.ravel()
...
def factorize_from_iterables(iterables) -> tuple[list[np.ndarray],
    list[Index]]:
    """
