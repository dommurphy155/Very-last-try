...
class BooleanDtype(BaseMaskedDtype):
    ...
    def __from_arrow__(
        ...
        if array.type != pyarrow.bool_():
            raise TypeError(f"Expected array of boolean type, got {array.type}
    instead")
...
class BooleanArray(BaseMaskedArray):
    ...
    To construct an BooleanArray from generic array-like input, use:func:`pandas.array` specifying ``dtype="boolean"`` (see examples
    below).
    ...
    structures")
        ...
        if other_is_scalar and other is not libmissing.NA and not
    lib.is_bool(other):
            raise TypeError(
