...
@delegate_names(
    SparseArray, ["npoints", "density", "fill_value", "sp_values"],
    typ="property"
)
...
class SparseFrameAccessor(BaseAccessor, PandasDelegate):
    ...
    def to_coo(self):
        ...
        for col, (_, ser) in enumerate(self._parent.items()):
            ...
            if sp_arr.fill_value != 0:
                raise ValueError("fill value must be 0 when converting to COO
    matrix")
    ...
    def density(self) -> float:
        ...
        """
        tmp = np.mean([column.array.density for _, column in
    self._parent.items()])
        # error: Expression of type "floating" cannot be assigned to return
    type "float"
