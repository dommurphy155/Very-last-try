...
class PandasArray(
    ...
    https://numpy.org/doc/stable/reference/generated/numpy.lib.mixins.NDArrayOperatorsMixin.html
        ...
        inputs = tuple(x._ndarray if isinstance(x, PandasArray) else x for x
    in inputs)
        if out:
            kwargs["out"] = tuple(
    ...
    def sum(
        self, *, axis: int | None = None, skipna: bool = True, min_count=0,
    **kwargs
    ) -> Scalar:
    ...
    **kwargs
    ...
    def mean(
        ...
        *,
        ...
        nv.validate_mean((), {"dtype": dtype, "out": out, "keepdims":
    keepdims})
    ...
    def median(
        ...
        *,
        ...
        nv.validate_median(
            (), {"out": out, "overwrite_input": overwrite_input, "keepdims":
    keepdims}
        )
    ...
    def var(
        ...
        *,
        ...
        result = nanops.nanvar(self._ndarray, axis=axis, skipna=skipna,
    ddof=ddof)
        return self._wrap_reduction_result(axis, result)
    ...
    def sem(
        ...
        *,
        ...
        result = nanops.nansem(self._ndarray, axis=axis, skipna=skipna,
    ddof=ddof)
        return self._wrap_reduction_result(axis, result)
    ...
    def to_numpy(
        ...
        if (copy or na_value is not lib.no_default) and result is
    self._ndarray:
            result = result.copy()
    ...
    def _cmp_method(self, other, op):
        ...
        if op is divmod or op is ops.rdivmod:
            ...
            if isinstance(a, np.ndarray):
                ...
                return self._wrap_ndarray_result(a),
    self._wrap_ndarray_result(b)
            return a, b
