...
class GroupByIndexingMixin:
    ...
    def _positional_selector(self) -> GroupByPositionalSelector:
        ...
        - A comma separated list of integers and slices, e.g. ``5``, ``2, 4``,
    ``2:4``.

        The output format is the same as:meth:`~GroupBy.head` and:meth:`~GroupBy.tail`, namely
        a subset of the ``DataFrame`` or ``Series`` with the index and order
    preserved.
        ...
        See Also
        --------
        DataFrame.iloc: Purely integer-location based indexing for selection
    by
            position.
        ...
        - If the index specification results in overlaps, the item is not
    duplicated.
        ...
        Examples
        --------
        >>> df = pd.DataFrame([["a", 1], ["a", 2], ["a", 3], ["b", 4], ["b",
    5]],
        ...                   columns=["A", "B"])
    ...
    def _make_mask_from_slice(self, arg: slice) -> bool | np.ndarray:
        ...
        if start is None:
            ...
            offset_array = np.where(limit_array, self._ascending_count,
    offset_array)
...
class GroupByPositionalSelector:
    ...
    def __getitem__(self, arg: PositionalIndexer | tuple) -> DataFrame |
    Series:
        """
        ...
        See Also
        --------
        DataFrame.iloc: Integer-location based indexing for selection by
    position.
        GroupBy.head: Return first n rows of each group.
        GroupBy.tail: Return last n rows of each group.
        GroupBy._positional_selector: Return positional selection for each
    group.
        GroupBy.nth: Take the nth row from each group if n is an int, or a
            subset of rows, if n is a list of ints.
        """
