...
def generate_numba_agg_func(
    ...
    np.ndarray]:
    """
    Generate a numba jitted agg function specified by values from
    engine_kwargs.
...
def generate_numba_transform_func(
    ...
    np.ndarray]:
    """
    Generate a numba jitted transform function specified by values from
    engine_kwargs.
    ...
    def group_transform(
        ...
        *args: Any,
        ...
        for i in numba.prange(num_groups):
            ...
            for j in numba.prange(num_columns):
                group = values[begin[i]: end[i], j]
                result[begin[i]: end[i], j] = numba_func(group, group_index,
    *args)
        return result
