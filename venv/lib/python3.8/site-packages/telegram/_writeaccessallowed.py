...
"""This module contains objects related to the write access allowed service
    message."""
...
class WriteAccessAllowed(TelegramObject):
    ...
    write messages after
    adding the bot to the attachment menu or launching a Web App from a link.

    .. versionadded:: 20.0

    Args:
        web_app_name (:obj:`str`, optional): Name of the Web App which was
    ...
    def __init__(self, web_app_name: str = None, *, api_kwargs: JSONDict =
    None):
