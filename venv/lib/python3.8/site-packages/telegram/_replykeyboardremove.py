...
class ReplyKeyboardRemove(TelegramObject):
    ...
    the current custom
    keyboard and display the default letter-keyboard. By default, custom
    ...
    Examples:
        * Example usage: A user votes in a poll, bot returns confirmation
    message in reply to
    ...
    Attributes:
        remove_keyboard (:obj:`True`): Requests clients to remove the custom
    keyboard.
        selective (:obj:`bool`): Optional. Remove the keyboard for specific
    users only.
            Targets:
