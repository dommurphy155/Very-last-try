...
class User(TelegramObject):
    ...
    .. versionchanged:: 20.0
        ...
        ``{read, write, connect, pool}_timeout`` ``api_kwargs``. Use a named
    argument for those,
    ...
    Args:
        ...
        language_code (:obj:`str`, optional): IETF language tag of the user's
    language.
        can_join_groups (:obj:`str`, optional)::obj:`True`, if the bot can be
    invited to groups.
            Returned only in:attr:`telegram.Bot.get_me` requests.
        can_read_all_group_messages (:obj:`str`, optional)::obj:`True`, if
    privacy mode is
            disabled for the bot. Returned only in:attr:`telegram.Bot.get_me`
    requests.
        supports_inline_queries (:obj:`str`, optional)::obj:`True`, if the
    bot supports inline
            queries. Returned only in:attr:`telegram.Bot.get_me` requests.

        is_premium (:obj:`bool`, optional)::obj:`True`, if this user is a
    Telegram Premium user.

            .. versionadded:: 20.0
        added_to_attachment_menu (:obj:`bool`, optional)::obj:`True`, if this
    user added
    ...
    that:attr:`User.id`
        coincides with the:attr:`Chat.id` of the private chat with the user.
    This has been the
    ...
    def full_name(self) -> str:
        """:obj:`str`: Convenience property. The user's:attr:`first_name`,
    followed by (if
    ...
    def link(self) -> Optional[str]:
        """:obj:`str`: Convenience property. If:attr:`username` is available,
    returns a t.me link
        of the user.
        """
        if self.username:
    ...
    async def get_profile_photos(
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.get_user_profile_photos(update.effective_user.id,
    *args, **kwargs)

        For the documentation of the arguments, please see:meth:`telegram.Bot.get_user_profile_photos`.
    ...
    mode, retained by
        ...
        Args:
            name (:obj:`str`): The name used as a link for the user. Defaults
    to:attr:`full_name`.

        Returns::obj:`str`: The inline mention for the user as markdown (version
    1).
    ...
    to:attr:`full_name`.
        ...
        Returns::obj:`str`: The inline mention for the user as HTML.
    ...
    to:attr:`full_name`.
        ...
        Returns::class:`telegram.InlineKeyboardButton`: InlineButton with url set
    to the user mention
        """
        return InlineKeyboardButton(text=name or self.full_name,
    url=f"tg://user?id={self.id}")
    ...
    "InputMediaVideo"]
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.send_media_group(update.effective_user.id, *args,
    **kwargs)
    ...
    async def send_chat_action(
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.send_chat_action(update.effective_user.id, *args,
    **kwargs)
    ...
    async def send_animation(
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.send_animation(update.effective_user.id, *args,
    **kwargs)
    ...
    async def send_video_note(
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.send_video_note(update.effective_user.id, *args,
    **kwargs)
    ...
    async def send_copy(
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.copy_message(chat_id=update.effective_user.id, *args,
    **kwargs)
    ...
    async def copy_message(
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.copy_message(from_chat_id=update.effective_user.id,
    *args, **kwargs)
    ...
    async def get_menu_button(
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.get_chat_menu_button(chat_id=update.effective_user.id,
    *args, **kwargs)
