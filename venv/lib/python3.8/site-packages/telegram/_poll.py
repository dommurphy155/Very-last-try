...
class PollOption(TelegramObject):
    ...
    def __init__(self, text: str, voter_count: int, *, api_kwargs: JSONDict =
    None):
...
class PollAnswer(TelegramObject):
    ...
    Args:
        ...
        user (:class:`telegram.User`): The user, who changed the answer to the
    poll.
        option_ids (Sequence[:obj:`int`]): 0-based identifiers of answer
    ...
    Attributes:
        ...
        user (:class:`telegram.User`): The user, who changed the answer to the
    poll.
        option_ids (Tuple[:obj:`int`]): Identifiers of answer options, chosen
    by the user.  May be
    ...
    def __init__(
        self, poll_id: str, user: User, option_ids: Sequence[int], *,
...
class Poll(TelegramObject):
    ...
    Examples::any:`Poll Bot <examples.pollbot>`
    ...
    Args:
        ...
        options (Sequence[:class:`~telegram.PollOption`]): List of poll
    options.
        ...
        allows_multiple_answers (:obj:`bool`)::obj:`True`, if the poll allows
    multiple answers.
        correct_option_id (:obj:`int`, optional): A zero based identifier of
    the correct answer
            option. Available only for closed polls in the quiz mode, which
    were sent
    ...
    the:attr:`explanation`. This list is empty if the message does not
    contain explanation
            entities.

            .. versionchanged:: 20.0

               * This attribute is now always a (possibly empty) list and
    never:obj:`None`.
               * |sequenceclassargs|
        open_period (:obj:`int`, optional): Amount of time in seconds the poll
    will be active
            after creation.
        close_date (:obj:`datetime.datetime`, optional): Point in time (Unix
    timestamp) when the
    ...
    Attributes:
        ...
        options (Tuple[:class:`~telegram.PollOption`]): List of poll options.
            ...
            .. versionchanged:: 20.0
                |tupleclassattrs|
        total_voter_count (:obj:`int`): Total number of users that voted in
    the poll.
        is_closed (:obj:`bool`)::obj:`True`, if the poll is closed.
        is_anonymous (:obj:`bool`)::obj:`True`, if the poll is anonymous.
        type (:obj:`str`): Poll type, currently can be:attr:`REGULAR` or:attr:`QUIZ`.
    ...
    chooses an incorrect
            answer or taps on the lamp icon in a quiz-style poll,
            0-:tg-const:`telegram.Poll.MAX_EXPLANATION_LENGTH` characters.
        explanation_entities (Tuple[:class:`telegram.MessageEntity`]): Special
    entities
            like usernames, URLs, bot commands, etc. that appear in the:attr:`explanation`.
            This list is empty if the message does not contain explanation
    entities.
    ...
    will be active
            after creation.
        close_date (:obj:`datetime.datetime`): Optional. Point in time when
    the poll will be
    ...
    def __init__(
        ...
        *,
        ...
        self.explanation_entities: Tuple[MessageEntity, ...] =
    parse_sequence_arg(
            explanation_entities
        )
    ...
    def de_json(cls, data: Optional[JSONDict], bot: "Bot") -> Optional["Poll"]:
        ...
        data["options"] = [PollOption.de_json(option, bot) for option in
    data["options"]]
        data["explanation_entities"] =
    MessageEntity.de_list(data.get("explanation_entities"), bot)
    ...
    def parse_explanation_entities(self, types: List[str] = None) ->
    Dict[MessageEntity, str]:
        """
        Returns a:obj:`dict` that maps:class:`telegram.MessageEntity` to:obj:`str`.
        It contains entities from this polls explanation filtered by their
    ``type`` attribute as
        the key, and the text that each entity belongs to as the value of the:obj:`dict`.

        Note:
            This method should always be used instead of the:attr:`explanation_entities`
            attribute, since it calculates the correct substring from the
    message text based on
            UTF-16 codepoints. See:attr:`parse_explanation_entity` for more
    info.

        Args:
            types (List[:obj:`str`], optional): List of ``MessageEntity``
    types as strings. If the
                    ``type`` attribute of an entity is contained in this list,
    it will be returned.
    ...
    MAX_EXPLANATION_LENGTH: ClassVar[int] =
    constants.PollLimit.MAX_EXPLANATION_LENGTH
    """:const:`telegram.constants.PollLimit.MAX_EXPLANATION_LENGTH`

    .. versionadded:: 20.0
    """
    MAX_EXPLANATION_LINE_FEEDS: ClassVar[int] =
    ...
    .. versionadded:: 20.0
    """
    MIN_QUESTION_LENGTH: ClassVar[int] =
    constants.PollLimit.MIN_QUESTION_LENGTH
    """:const:`telegram.constants.PollLimit.MIN_QUESTION_LENGTH`

    .. versionadded:: 20.0
    """
    MAX_QUESTION_LENGTH: ClassVar[int] =
    constants.PollLimit.MAX_QUESTION_LENGTH
