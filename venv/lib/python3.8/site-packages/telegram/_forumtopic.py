...
class ForumTopic(TelegramObject):
    ...
    __slots__ = ("message_thread_id", "name", "icon_color",
...
class ForumTopicCreated(TelegramObject):
    """
    This object represents the content of a service message about a new forum
    topic created in
    the chat.
...
class ForumTopicEdited(TelegramObject):
    ...
    Objects of this class are comparable in terms of equality. Two objects of
    this class are
    considered equal, if their:attr:`name` and:attr:`icon_custom_emoji_id`
    are equal.
    ...
    Args:
        ...
        icon_custom_emoji_id (:obj:`str`, optional): New identifier of the
    custom emoji shown as
