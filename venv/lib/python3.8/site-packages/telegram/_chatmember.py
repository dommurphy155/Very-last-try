...
class ChatMember(TelegramObject):
    ...
    *:class:`telegram.ChatMemberBanned`
    ...
    Examples::any:`Chat Member Bot <examples.chatmemberbot>`

    .. versionchanged:: 20.0

        * As of Bot API 5.3,:class:`ChatMember` is nothing but the base class
    for the subclasses
          listed above and is no longer returned directly by:meth:`~telegram.Bot.get_chat`.
          Therefore, most of the arguments and attributes were removed and you
    should no longer
    ...
    Args:
        ...
        status (:obj:`str`): The member's status in the chat. Can be:attr:`~telegram.ChatMember.ADMINISTRATOR`,:attr:`~telegram.ChatMember.OWNER`,:attr:`~telegram.ChatMember.BANNED`,:attr:`~telegram.ChatMember.LEFT`,:attr:`~telegram.ChatMember.MEMBER` or:attr:`~telegram.ChatMember.RESTRICTED`.
    ...
    Optional["ChatMember"]:
        ...
        if cls is ChatMember and data.get("status") in _class_mapping:
            return _class_mapping[data.pop("status")].de_json(data=data,
    bot=bot)
...
class ChatMemberAdministrator(ChatMember):
    ...
    .. versionchanged:: 20.0
       ...
       * Argument and attribute ``can_manage_voice_chats`` were renamed to:paramref:`can_manage_video_chats` and:attr:`can_manage_video_chats` in accordance to
         Bot API 6.0.
       * The argument:paramref:`can_manage_topics` was added, which changes
    the position of the
    ...
    supergroups
        ...
        can_promote_members (:obj:`bool`)::obj:`True`, if the administrator
            can add new administrators with a subset of his own privileges or
    demote
    ...
    allowed
            to create, rename, close, and reopen forum topics; supergroups
    only.
...
class ChatMemberRestricted(ChatMember):
    ...
    Args:
        ...
        can_send_media_messages (:obj:`bool`)::obj:`True`, if the user is
    allowed
            to send audios, documents, photos, videos, video notes and voice
    notes.
        ...
        can_send_polls (:obj:`bool`)::obj:`True`, if the user is allowed
            to send polls.
        can_send_other_messages (:obj:`bool`)::obj:`True`, if the user is
    allowed
        ...
        can_manage_topics (:obj:`bool`)::obj:`True`, if the user is allowed
    to create
            forum topics.
