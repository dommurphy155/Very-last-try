...
"""This module contains two objects used for request chats/users service
    messages."""
...
class UserShared(TelegramObject):
    ...
    this class are
    considered equal, if their:attr:`request_id` and:attr:`user_id` are
    equal.
    ...
    Args:
        ...
        user_id (:obj:`int`): Identifier of the shared user. This number may
    be greater than 32
            bits and some programming languages may have difficulty/silent
    defects in interpreting
...
class ChatShared(TelegramObject):
    ...
    Objects of this class are comparable in terms of equality. Two objects of
    this class are
    considered equal, if their:attr:`request_id` and:attr:`chat_id` are
    equal.
    ...
    Args:
        request_id (:obj:`int`): Identifier of the request.
        chat_id (:obj:`int`): Identifier of the shared user. This number may
    be greater than 32
            bits and some programming languages may have difficulty/silent
    defects in interpreting
            it. But it is smaller than 52 bits, so a signed 64-bit integer or
