...
class PreCheckoutQuery(TelegramObject):
    ...
    currency
        ...
        shipping_option_id (:obj:`str`, optional): Identifier of the shipping
    option chosen by the
            user.
        order_info (:class:`telegram.OrderInfo`, optional): Order info
    ...
    async def answer(  # pylint: disable=invalid-name
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.answer_pre_checkout_query(update.pre_checkout_query.id,
    *args, **kwargs)

        For the documentation of the arguments, please see:meth:`telegram.Bot.answer_pre_checkout_query`.
