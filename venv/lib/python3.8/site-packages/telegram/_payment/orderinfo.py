...
class OrderInfo(TelegramObject):
    ...
    this class are
    considered equal, if their:attr:`name`,:attr:`phone_number`,:attr:`email` and:attr:`shipping_address` are equal.

    Args:
        name (:obj:`str`, optional): User name.
        phone_number (:obj:`str`, optional): User's phone number.
        email (:obj:`str`, optional): User email.
        shipping_address (:class:`telegram.ShippingAddress`, optional): User
    shipping address.
    ...
    def __init__(
        ...
        *,
        ...
        self._id_attrs = (self.name, self.phone_number, self.email,
    ...
    ShippingAddress.de_json(data.get("shipping_address"), bot)
