...
class ShippingQuery(TelegramObject):
    ...
    Args:
        ...
        shipping_address (:class:`telegram.ShippingAddress`): User specified
    shipping address.
    ...
    async def answer(  # pylint: disable=invalid-name
        ...
        *,
        ...
        """Shortcut for::
             ...
             await bot.answer_shipping_query(update.shipping_query.id, *args,
    **kwargs)

        For the documentation of the arguments, please see:meth:`telegram.Bot.answer_shipping_query`.
