...
class LabeledPrice(TelegramObject):
    ...
    Args:
        ...
        amount (:obj:`int`): Price of the product in the smallest units of the
    currency (integer,
    ...
    Attributes:
        ...
        amount (:obj:`int`): Price of the product in the smallest units of the
    currency (integer,
            not float/double). For example, for a price of US$ 1.45 ``amount``
    is ``145``.
            See the ``exp`` parameter in
            `currencies.json
    <https://core.telegram.org/bots/payments/currencies.json>`_,
    ...
    def __init__(self, label: str, amount: int, *, api_kwargs: JSONDict =
    None):
