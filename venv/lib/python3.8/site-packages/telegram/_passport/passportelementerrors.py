...
class PassportElementError(TelegramObject):
    ...
    Args:
        ...
        type (:obj:`str`): The section of the user's Telegram Passport which
    has the error.
    ...
    def __init__(self, source: str, type: str, message: str, *, api_kwargs:
    JSONDict = None):
...
class PassportElementErrorDataField(PassportElementError):
    ...
    Objects of this class are comparable in terms of equality. Two objects of
    this class are
    considered equal, if their:attr:`~telegram.PassportElementError.source`,:attr:`type`,:attr:`field_name`,:attr:`data_hash` and:attr:`message` are equal.

    Args:
        type (:obj:`str`): The section of the user's Telegram Passport which
    has the error, one of
...
class PassportElementErrorFile(PassportElementError):
    ...
    Objects of this class are comparable in terms of equality. Two objects of
    this class are
    considered equal, if their:attr:`~telegram.PassportElementError.source`,:attr:`type`,:attr:`file_hash`, and:attr:`message` are equal.

    Args:
        type (:obj:`str`): The section of the user's Telegram Passport which
    has the issue, one of
    ...
    def __init__(self, type: str, file_hash: str, message: str, *, api_kwargs:
    JSONDict = None):
        # Required
        ...
        with self._unfrozen():
            ...
            self._id_attrs = (self.source, self.type, self.file_hash,
    self.message)
...
class PassportElementErrorFiles(PassportElementError):
    ...
    Objects of this class are comparable in terms of equality. Two objects of
    this class are
    considered equal, if their:attr:`~telegram.PassportElementError.source`,:attr:`type`,:attr:`file_hashes`, and:attr:`message` are equal.
...
class PassportElementErrorFrontSide(PassportElementError):
    ...
    ``"internal_passport"``.
        file_hash (:obj:`str`): Base64-encoded hash of the file with the front
    side of the
            document.
        message (:obj:`str`): Error message.
...
class PassportElementErrorReverseSide(PassportElementError):
    ...
    has the issue, one of
        ...
        file_hash (:obj:`str`): Base64-encoded hash of the file with the
    reverse side of the
            document.
        message (:obj:`str`): Error message.
...
class PassportElementErrorTranslationFile(PassportElementError):
    ...
    Args:
        type (:obj:`str`): Type of element of the user's Telegram Passport
    which has the issue,
...
class PassportElementErrorUnspecified(PassportElementError):
    ...
    Objects of this class are comparable in terms of equality. Two objects of
    this class are
    considered equal, if their:attr:`~telegram.PassportElementError.source`,:attr:`type`,:attr:`element_hash`, and:attr:`message` are equal.
    ...
    def __init__(self, type: str, element_hash: str, message: str, *,
    api_kwargs: JSONDict = None):
        # Required
        ...
        with self._unfrozen():
            ...
            self._id_attrs = (self.source, self.type, self.element_hash,
    self.message)
