...
class PassportFile(TelegramObject):
    ...
    def de_json_decrypted(
        cls, data: Optional[JSONDict], bot: "Bot", credentials:
    "FileCredentials"
    ...
    into account
        ...
        Returns::class:`telegram.PassportFile`:
    ...
    def de_list_decrypted(
        cls, data: Optional[List[JSONDict]], bot: "Bot", credentials:
    List["FileCredentials"]
    ) -> Tuple[Optional["PassportFile"], ...]:
        """Variant of:meth:`telegram.TelegramObject.de_list` that also takes
    into account
        passport credentials.
    ...
    async def get_file(
        ...
        *,
        ...
        """
        Wrapper over:meth:`telegram.Bot.get_file`. Will automatically assign
    the correct
        credentials to the returned:class:`telegram.File` if originating from:obj:`telegram.PassportData.decrypted_data`.
