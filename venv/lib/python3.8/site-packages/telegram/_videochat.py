...
class VideoChatStarted(TelegramObject):
    ...
    .. versionadded:: 13.4
    .. versionchanged:: 20.0
        This class was renamed from ``VoiceChatStarted`` in accordance to Bot
    API 6.0.
    """
...
class VideoChatEnded(TelegramObject):
    ...
    Two objects of this class are considered equal, if their:attr:`duration` are equal.

    .. versionadded:: 13.4
    .. versionchanged:: 20.0
        This class was renamed from ``VoiceChatEnded`` in accordance to Bot
    API 6.0.
...
class VideoChatParticipantsInvited(TelegramObject):
    ...
    Objects of this class are comparable in terms of equality.
    Two objects of this class are considered equal, if their:attr:`users` are
    equal.

    .. versionadded:: 13.4
    .. versionchanged:: 20.0
        This class was renamed from ``VoiceChatParticipantsInvited`` in
    ...
    Attributes:
        users (Tuple[:class:`telegram.User`]): New members that were invited
    to the video chat.
...
class VideoChatScheduled(TelegramObject):
    ...
    .. versionchanged:: 20.0
        This class was renamed from ``VoiceChatScheduled`` in accordance to
    Bot API 6.0.

    Args:
        start_date (:obj:`datetime.datetime`): Point in time (Unix timestamp)
    when the video
