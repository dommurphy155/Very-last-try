...
"""This module contains a class that holds the parameters of a request to the
    Bot API."""
import json
...
class RequestData:
    """Instances of this class collect the data needed for one request to the
    Bot API, including
    ...
    Warning:
        How exactly instances of this will are created should be considered an
    implementation
        detail and not part of PTBs public API. Users should exclusively rely
    on the documented
        attributes, properties and methods.

    Attributes:
        contains_files (:obj:`bool`): Whether this object contains files to be
    uploaded via
            ``multipart/form-data``.
    """
    ...
    def __init__(self, parameters: List[RequestParameter] = None):
        ...
        self.contains_files: bool = any(param.input_files for param in
    self._parameters)

    @property
    def parameters(self) -> Dict[str, Union[str, int, List[Any], Dict[Any,
    Any]]]:
        """Gives the parameters as mapping of parameter name to the parameter
    value, which can be
        a single object of type:obj:`int`,:obj:`float`,:obj:`str` or:obj:`bool` or any
        (possibly nested) composition of lists, tuples and dictionaries, where
    each entry, key
    ...
    def json_parameters(self) -> Dict[str, str]:
        """Gives the parameters as mapping of parameter name to the respective
    JSON encoded
        value.

        Tip:
            By default, this property uses the standard library's:func:`json.dumps`.
            To use a custom library for JSON encoding, you can directly encode
    the keys of:attr:`parameters` - note that string valued keys should not be
    JSON encoded.
        """
        return {
    ...
    def url_encoded_parameters(self, encode_kwargs: Dict[str, Any] = None) ->
    str:
        """Encodes the parameters with:func:`urllib.parse.urlencode`.

        Args:
            encode_kwargs (Dict[:obj:`str`, any], optional): Additional
    ...
    def parametrized_url(self, url: str, encode_kwargs: Dict[str, Any] = None)
    -> str:
    ...
    keyword arguments to pass
        ...
        """
        url_parameters =
    self.url_encoded_parameters(encode_kwargs=encode_kwargs)
    ...
    def multipart_data(self) -> UploadFileDict:
        """Gives the files contained in this object as mapping of part name to
    encoded content."""
