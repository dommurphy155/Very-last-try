...
"""This module contains custom typing aliases for internal use within the
    library.
...
from typing import IO, TYPE_CHECKING, Any, Collection, Dict, Optional, Tuple,
    TypeVar, Union
...
"""Valid input for passing files to Telegram. Either a file id as string, a
    file like object,
...
"""Generic type for a variable which can be either `type` or
    `DefaultVaule[type]`."""
ODVInput = Optional[Union["DefaultValue[DVValueType]", DVValueType,
    "DefaultValue[None]"]]
"""Generic type for bot method parameters which can have defaults.
    ``ODVInput[type]`` is the same
