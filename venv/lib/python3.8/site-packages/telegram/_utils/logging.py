...
def get_logger(file_name: str, class_name: str = None) -> logging.Logger:
    ...
    If for example `__name__` is `telegram.ext._updater`, the logger will be
    named
    ...
    If the file name points to a utils module, the logger name will simply be
    `telegram(.ext)`.

    Returns::class:`logging.Logger`: The logger.
    """
