...
__all__ = ("__version__", "__version_info__", "__bot_api_version__",
...
__version_info__ = Version(major=20, minor=3, micro=0, releaselevel="final",
    serial=0)
__version__ = str(__version_info__)

# # SETUP.PY MARKER
# Lines above this line will be `exec`-cuted in setup.py. Make sure that this
    only contains
# std-lib imports!

from telegram import constants  # noqa: E402  # pylint:
