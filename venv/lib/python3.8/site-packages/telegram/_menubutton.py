...
class MenuButton(TelegramObject):
    ...
    *:class:`telegram.MenuButtonDefault`
    ...
    If a menu button other than:class:`telegram.MenuButtonDefault` is set for
    a private chat,
    then it is applied in the chat. Otherwise the default menu button is
    applied. By default, the
    ...
    Optional["MenuButton"]:
        """Converts JSON data to the appropriate:class:`MenuButton` object,
    i.e. takes
...
class MenuButtonWebApp(MenuButton):
    ...
    Args:
        ...
        web_app (:class:`telegram.WebAppInfo`): Description of the Web App
    ...
    def __init__(self, text: str, web_app: WebAppInfo, *, api_kwargs: JSONDict
    = None):
    ...
    Optional["MenuButtonWebApp"]:
        ...
        return super().de_json(data=data, bot=bot)  # type:
    ignore[return-value]
