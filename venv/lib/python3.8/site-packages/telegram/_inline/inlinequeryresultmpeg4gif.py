...
class InlineQueryResultMpeg4Gif(InlineQueryResult):
    ...
    sound). By default, this
    animated MPEG-4 file will be sent by the user with optional caption.
    Alternatively, you can
    use:attr:`input_message_content` to send a message with the specified
    ...
    Args:
        ...
        mpeg4_url (:obj:`str`): A valid URL for the MP4 file. File size must
    not exceed 1MB.
        mpeg4_width (:obj:`int`, optional): Video width.
        mpeg4_height (:obj:`int`, optional): Video height.
        mpeg4_duration (:obj:`int`, optional): Video duration in seconds.
        thumbnail_url (:obj:`str`, optional): URL of the static (JPEG or GIF)
    or animated (MPEG4)
    ...
    It is formally
            ...
            .. versionadded:: 20.2
        thumbnail_mime_type (:obj:`str`, optional): MIME type of the
    thumbnail, must be one of
    ...
    not exceed 1MB.
        ...
        mpeg4_height (:obj:`int`): Optional. Video height.
        mpeg4_duration (:obj:`int`): Optional. Video duration in seconds.
        thumbnail_url (:obj:`str`): URL of the static (JPEG or GIF) or
    animated (MPEG4) thumbnail
            for the result.
    ...
    def __init__(
        ...
        mpeg4_url: str,
        # thumbnail_url is not optional in Telegram API, but we want to
    support thumb_url as well,
        # so thumbnail_url may not be passed.  We will raise ValueError
    manually if neither
    ...
    input_message_content
            self.thumbnail_mime_type: Optional[str] =
    warn_about_deprecated_arg_return_new_arg(
    ...
    def thumb_url(self) -> str:
        """:obj:`str`: URL of the static (JPEG or GIF) or animated (MPEG4)
    thumbnail for the
        result.
    ...
    def thumb_mime_type(self) -> Optional[str]:
        """:obj:`str`: Optional. Optional. MIME type of the thumbnail, must be
    one of
        ``'image/jpeg'``, ``'image/gif'``, or ``'video/mp4'``. Defaults to
    ``'image/jpeg'``.
