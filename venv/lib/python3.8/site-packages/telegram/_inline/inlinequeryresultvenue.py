...
class InlineQueryResultVenue(InlineQueryResult):
    ...
    Note:
      Foursquare details and Google Pace details are mutually exclusive.
    However, this
    ...
    "arts_entertainment/aquarium" or
            "food/icecream".)
        google_place_id (:obj:`str`, optional): Google Places identifier of
    the venue.
        google_place_type (:obj:`str`, optional): Google Places type of the
    venue. (See
            `supported types
