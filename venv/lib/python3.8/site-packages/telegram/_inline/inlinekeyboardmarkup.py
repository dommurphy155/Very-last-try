...
class InlineKeyboardMarkup(TelegramObject):
    ...
    this class are
    considered equal, if their size of:attr:`inline_keyboard` and all the
    buttons are equal.

    .. figure::
    https://core.telegram.org/file/464001863/110f3/I47qTXAD9Z4.120010/e0\
        ea04f66357b640ec:align: center
    ...
    Args:
        inline_keyboard
    (Sequence[Sequence[:class:`telegram.InlineKeyboardButton`]]): Sequence of
    ...
    Attributes:
        inline_keyboard
    (Tuple[Tuple[:class:`telegram.InlineKeyboardButton`]]): Tuple of
    ...
    def __init__(
        ...
        *,
        ...
        if not check_keyboard_type(inline_keyboard):
            raise ValueError(
                "The parameter `inline_keyboard` should be a sequence of
    sequences of "
                "InlineKeyboardButtons"
            )
        # Required
        self.inline_keyboard: Tuple[Tuple[InlineKeyboardButton, ...], ...] =
    tuple(
    ...
    @classmethod
    def from_button(cls, button: InlineKeyboardButton, **kwargs: object) ->
    "InlineKeyboardMarkup":
        """Shortcut for::
        ...
        Args:
            button (:class:`telegram.InlineKeyboardButton`): The button to use
    in the markup
    ...
    def from_row(
        ...
        Return an InlineKeyboardMarkup from a single row of
    InlineKeyboardButtons

        Args:
            button_row (Sequence[:class:`telegram.InlineKeyboardButton`]): The
    button to use
                in the markup
    ...
    def from_column(
        ...
        """Shortcut for::
            ...
            InlineKeyboardMarkup([[button] for button in button_column],
    **kwargs)

        Return an InlineKeyboardMarkup from a single column of
    InlineKeyboardButtons

        Args:
            button_column (Sequence[:class:`telegram.InlineKeyboardButton`]):
    The button to use
                in the markup
