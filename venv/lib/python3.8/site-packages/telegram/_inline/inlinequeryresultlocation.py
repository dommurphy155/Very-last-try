...
class InlineQueryResultLocation(InlineQueryResult):
    ...
    the user.
    Alternatively, you can use:attr:`input_message_content` to send a message
    with the specified
    ...
    uncertainty for the location,
            measured in meters; 0-:tg-const:`telegram.InlineQueryResultLocation.HORIZONTAL_ACCURACY`.
        live_period (:obj:`int`, optional): Period in seconds for which the
    location will be
            updated, should be between:tg-const:`telegram.InlineQueryResultLocation.MIN_LIVE_PERIOD` and:tg-const:`telegram.InlineQueryResultLocation.MAX_LIVE_PERIOD`.
        heading (:obj:`int`, optional): For live locations, a direction in
    which the user is
            moving, in degrees. Must be between:tg-const:`telegram.InlineQueryResultLocation.MIN_HEADING` and:tg-const:`telegram.InlineQueryResultLocation.MAX_HEADING` if
    specified.
        proximity_alert_radius (:obj:`int`, optional): For live locations, a
    maximum distance
    ...
    optional): Content of the
        ...
        thumbnail_url (:obj:`str`, optional): Url of the thumbnail for the
    result.
    ...
    def __init__(
        ...
        *,
        ...
        # Required
        super().__init__(constants.InlineQueryResultType.LOCATION, id,
    ...
    warn_about_deprecated_arg_return_new_arg(
            ...
            self.thumbnail_width: Optional[int] =
    warn_about_deprecated_arg_return_new_arg(
            ...
            self.thumbnail_height: Optional[int] =
    warn_about_deprecated_arg_return_new_arg(
    ...
    HORIZONTAL_ACCURACY: ClassVar[int] =
    constants.LocationLimit.HORIZONTAL_ACCURACY
