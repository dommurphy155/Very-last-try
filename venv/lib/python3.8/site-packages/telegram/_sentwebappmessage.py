...
"""This module contains an object that represents a Telegram Sent Web App
    Message."""
...
class SentWebAppMessage(TelegramObject):
    ...
    inline message. Available
            only if there is an:attr:`inline keyboard
    <telegram.InlineKeyboardMarkup>` attached to
            the message.
    ...
    def __init__(self, inline_message_id: str = None, *, api_kwargs: JSONDict
    = None):
