...
def _lstrip_str(in_s: str, lstr: str) -> str:
    ...
    Returns::obj:`str`: The stripped string.
...
class Forbidden(TelegramError):
    """Raised when the bot has not enough rights to perform the requested
    action.
...
class InvalidToken(TelegramError):
    ...
    Args:
        message (:obj:`str`, optional): Any additional information about the
    exception.
...
class ChatMigrated(TelegramError):
    """
    Raised when the requested group chat migrated to supergroup and has a new
    chat id.
    ...
    def __init__(self, new_chat_id: int):
        super().__init__(f"Group migrated to supergroup. New chat id:
    {new_chat_id}")
...
class RetryAfter(TelegramError):
    ...
    .. versionchanged:: 20.0:attr:`retry_after` is now an integer to comply with the Bot API.

    Args:
        retry_after (:obj:`int`): Time in seconds, after which the bot can
    retry the request.
    ...
    def __reduce__(self) -> Tuple[type, Tuple[float]]:  # type:
    ignore[override]
...
class PassportDecryptionError(TelegramError):
    ...
    .. versionchanged:: 20.0
        This class was previously named ``TelegramDecryptionError`` and was
    available via
