...
class AsyncHTTP11Connection(AsyncConnectionInterface):
    ...
    async def _receive_event(
        ...
        while True:
            with map_exceptions({h11.RemoteProtocolError:
    RemoteProtocolError}):
    ...
    like:
                ...
                if data == b"" and self._h11_state.their_state ==
    h11.SEND_RESPONSE:
    ...
    # The AsyncConnectionInterface methods provide information about the state
    of
